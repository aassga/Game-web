...
var tncode = {
    ...
    _send_result:function(){
        ...
        var checkUrl = tncode.location+"/frontend/v1/checkTCode?tnCode="+Math.round(tncode._mark_offset)+"&userName="+userN+""
        var re = new _ajax();
        re.request('post',checkUrl,haddle);
    ...
    refresh:function(){
        ...
        var userN = document.getElementById('userName').value
        var getCodeUrl = tncode.location+"/frontend/v1/getTCode?userName="+userN+"&t="+Math.random();
        // var re = new _ajax();
        // re.request('post',getCodeUrl,{
        //     success:(val)=>{
        //         img_url = val
        //     }
        // });
