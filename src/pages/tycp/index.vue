...
import comModal from "../public/home/caipiaoModal";
...
export default {
  ...
  data() {
    return {
      popups: "",
      lotHeadDatas: {
        logoUrl: "/static/tycp/img/home/logo.png",
        downLoadurl: "/static/tycp/html/download/index.html"
      },
      nameSta:"tycp",
      poptype:"500w",
      showtype: {
        ...
        textColor: "#CF3A36" //弹窗按钮颜色
      },
      dialogPar:{
        borderTop:"3px solid #8F212B",
        headBg:'#680915',
        bandBorder:'1px solid #5A0812',
        active:'#C1172E',
        titleColor:'#B10F24',
        ulBg:'#FCFCFC',
        ulBg2:'#fff',
        headColor:'#fff',
        borderLeft:'3px solid #BC4D57',
        activeName:'redActive',
        hoverName:"hoverName4"
      },
      attPar:{
          btnColor:'#E44B48',
          closeImg: "close_1", //弹窗关闭图片
          coverImgUrl:"../../../../static/tycp/img/tc.png",
      },
    };
  },
  methods: {},
