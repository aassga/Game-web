    ...
    <div class="w-header">
            ...
            <div class="container">
                ...
                <h3>
                    <router-link to="/home" class="router-link-exact-active curr">
                        <img src="../../../../static/tycp/img/home/logo1.png">
                    </router-link>
                </h3>
        ...
        <div class="asideNav">
            <span @click="changeTarget('1')">
                <img src="/static/tycp/img/home/bag.png">
                <span>红包</span>
            </span>
            <!-- <span @click="changeTarget('2')">
                <img src="/static/tycp/img/home/secrit.png">
                <span>密聊</span>
            </span> -->
            <span @click="changeTarget('2')">
                <img src="/static/tycp/img/home/help.png">
                <span>长龙</span>
            </span>
            <span @click="changeTarget('5')">
                <img src="/static/tycp/img/home/yh.png">
                <span>活动</span>
            </span>
            <span @click="changeTarget('4')">
                <img src="/static/tycp/img/home/app.png">
                <span>APP</span>
            </span>
            <span @click="changeTarget('3')">
                <img src="/static/tycp/img/home/server.png">
                <span>客服</span>
            </span>
        </div>
            ...
            switch (num) {
                case '1':
                    //  this.$router.push({ path: "/home/qipai" });
                     window.open('/static/tycp/html/active/czjhb/index.html')
                    break;
                case '2':
                ...
                case '3':
                    ...
                    break;
                case '4':
                    window.open("/static/tycp/html/download/index.html")
                    break;
                 case '5':
...
.w-header {
    ...
    .menu-child1 {
        ...
        *min-height: 564px;
        ...
        .triangles_back {
            ...
            height: 19px;
            position: absolute;
            background: url(/static/tycp/img/triangles_back.png) no-repeat;
            left: 125px;
            top: -8px;
        }
        ...
        .items {
            ...
            .item {
                ...
                .item-ico {
                    ...
                    color: #222;
                    text-align: center;
                    background: url(/static/tycp/img/game-icon-bg.png) no-repeat;
                    overflow: hidden;
                ...
                &:hover {
                    background: url(/static/tycp/img/Wbg_03.png) repeat;
                }
    ...
    .header-top {
        ...
        .snavInfo {
            ...
            .ServiceBtn {
                background: url('/static/tycp/img/home/service.gif');
