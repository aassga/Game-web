    ...
    <div class="header-top">
      ...
      <div class="header-top-right">
        ...
        <div class="login-after" v-if="$store.state.mainState.loginOrout">
          ...
          <span></span>
          <div @click="$bindPhoneOrbank()">我要存款</div>
          <span></span>
...
.fresh {
  ...
  height: 16px;
  position: relative;
  background: url("/static/amxpj/img/refresh.png");
  vertical-align: sub;
}
.refresh {
  background: url("/static/amxpj/img/newrefresh.png");
}
.fres {
...
.header {
  ...
  .header-top {
    ...
    .header-top-left-time {
      ...
      height: 34px;
      padding-left: 278px;
      background: url(/static/amxpj/img/home/duchang.png) no-repeat;
      margin-top: 8px;
      font-size: 17px;
      color: #5E528F;
      span{
    ...
    .header-top-right {
      ...
      .login-before {
        ...
        .input-item {
          ...
          &.username {
            padding-left: 30px;
            background: url("/static/amxpj/img/home/username.png") no-repeat 12px 10px;
          }
          &.password {
            padding-left: 30px;
            background: url("/static/amxpj/img/home/password.png") no-repeat 12px 10px;
          }
          &.code {
            padding-left: 10px;
            width: 94px;
