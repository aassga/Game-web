    ...
    <div class="carouse" :class="{'bounceOut':$route.path=='/home'}">
      ...
      <div class="newgong">
        <div class="newgong-content" @click="showTextModal">
          <div class="notice">
            <img src="/static/amxpj/img/home/notice-icon.png" class="notice-icon" alt />
            <span>最新公告 :</span>
          </div>
...
export default {
  ...
  methods: {
    ...
    async getBanner() {
      // this.carouselData = [
      //   {
      //     img: "/static/amxpj/img/banner/banner1_1.jpg"
      //   },
      //   {
      //     img: "/static/amxpj/img/banner/banner2.jpg"
      //   },
      //   {
      //     img: "/static/amxpj/img/banner/banner3.jpg"
      //   },
      //   {
      //     img: "/static/amxpj/img/banner/banner4.jpg"
      //   },
      //   {
      //     img: "/static/amxpj/img/banner/banner5.jpg"
      //   },
      //   {
      //     img: "/static/amxpj/img/banner/banner6.jpg"
      //   }
      // ];
...
.new-index {
  ...
  .content {
    overflow: hidden;
    background: url("/static/amxpj/img/home/content-bg.png") no-repeat;
