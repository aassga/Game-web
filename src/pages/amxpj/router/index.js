...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/amxpj/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/amxpj/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/amxpj/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/amxpj/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/amxpj/home/buyu')), 'vpBuyu')
const vpQipai = r => require.ensure([], () => r(require('@/pages/amxpj/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/amxpj/home/tiyu')), 'vpTiyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/amxpj/home/youhui/index')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/amxpj/home/register')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/amxpj/register')), 'register1')
const beforeLogin= r => require.ensure([],()=>r(require("@/pages/amxpj/beforeLogin")),'beforeLogin')
// 帮助
const about = r => require.ensure([], () => r(require('@/pages/amxpj/home/help/about')), 'about')
const issue = r => require.ensure([], () => r(require('@/pages/amxpj/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/amxpj/home/help/partner')), 'partner')
