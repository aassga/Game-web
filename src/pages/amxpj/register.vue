                ...
                <div class="right fr regin" v-if="showForm == 2">
                    <div class="register-wrap">
                        <div class="list-box">
                            ...
                            <!-- 正常验证码 -->
                            <div v-if="!isShowSms&&!isShowTnCode" class="text-context" style="float:none">
...
export default {
    ...
    data() {
        return {
            defaultPwd:"",
            defaultPwd2:"",
            formBg:"../../../static/amxpj/img/form_bg.png",
            showEye1:false,
            showEye2:false,
            showEye3:false,
            showForm:1,
            ...
            codeImg: '/static/amxpj/img/new_games/re.png',
            // smsInputBox: {
            //     marginTop: '15px'
            // },
            codeImg: '/static/amxpj/img/new_games/lo.png',
            tabIndex:1,
    ...
    watch:{
        ...
        showForm(val){
            ...
            if(val == 2){
                this.formBg = '../../../static/amxpj/img/form_bg2.png'
            }else{
                this.formBg = '../../../static/amxpj/img/form_bg.png'
            }
        },
...
.register {
    ...
    height: 100%;
    margin: 0 auto;
    background: url('/static/amxpj/img/register_bg.png') no-repeat center;
        ...
        .login{
            ...
            .text-context{
                ...
                .iconfont1 {
                  width: 20px;
                  height: 22px;
                  background: url("/static/amxpj/img/acc.png");
                ...
                .iconfont2 {
                  width: 20px;
                  height: 24px;
                  background: url("/static/amxpj/img/pwd.png");
                  background-repeat: no-repeat;
                  background-size: 100% 100%;
                  position: absolute;
                  left: 15px;
                ...
                .iconfont3 {
                  width: 22px;
                  height: 24px;
                  background: url('/static/amxpj/img/yanzhengma.png') no-repeat;
                  background-size: 100% 100%;
                  position: absolute;
                  left: 14px;
                  top: 5px;
    ...
    .service{
        ...
        span{
            ...
            &:first-child{
                width: 112px;
                height: 110px;
                background: url('../../../static/amxpj/img/ser.png');
                background-repeat: no-repeat;
                background-size: cover;
            }
        }
    ...
    .content {
        ...
        // background: url('../../../static/amxpj/img/form_bg.png');
        background-repeat: no-repeat;
        background-size:100% 100% ;
        .titleTab{
            width:469px;
            ...
            .list-box {
                .text-context {
                    ...
                    .openEyes{
                      ...
                      height: 13px;
                      display: inline-block;
                      background: url('/static/amxpj/img/eye1.png') no-repeat;
                      background-size: 100% 100%;
                      position: absolute;
                      top: 9px;
                      right: 15px;
                    ...
                    .closeEyes{
                      ...
                      height: 13px;
                      display: inline-block;
                      background: url('/static/amxpj/img/eye2.png') no-repeat;
                      background-size: 100% 100%;
                      position: absolute;
                      top: 9px;
                      right: 15px;
