...
const index = r => require.ensure([], () => r(require('@/pages/103qp/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/103qp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/103qp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/103qp/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/103qp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/103qp/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/103qp/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/103qp/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')

const register = r => require.ensure([], () => r(require('@/pages/103qp/home/register')), 'register') //注册界面
const register2 = r => require.ensure([], () => r(require('@/pages/103qp/home/register2')), 'register2') //注册界面
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/103qp/home/help/about-page')), 'vpAboutPage') //关于我们
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/103qp/home/help/save-help')), 'vpSaveHelp') //存款帮助
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/103qp/home/help/pull-help')), 'vpPullHelp') //取款帮助
const vpRelation = r => require.ensure([], () => r(require('@/pages/103qp/home/help/relation')), 'vpRelation') //联系我们
