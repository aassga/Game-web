...
export default {
    ...
    data() {
        return {
            headBg: '/static/103qp/img/new_games/banner/yh.jpg',
            notice: "/static/103qp/img/home/notice.png",
            lantern: '',
            bannerStyle: {},
            cssStyle: {
                padding: '20px 20px 20px',
                background: 'url(/static/103qp/img/bg_activity.jpg)',
...
.wrapper {
    .notice {
        ...
        .w1000 {
            ...
            span {
                font-size: 12px;
                background: url(/static/103qp/img/notice.png) left center no-repeat;
                padding-left: 30px;
                width: 128px;
                float: left;
                display: block;
