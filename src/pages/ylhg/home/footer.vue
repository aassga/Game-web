            ...
            <ul class="fastFunctions" :class="['view view-slideup on']">
                ...
                <div class="licenseShow" v-if="paizhaoShow">
                    <div class="licenseImg">
                        ...
                        <img class="img" src="/static/ylhg/img/footer/zhanshi.png" alt>
                    </div>
                </div>
            </ul>
...
export default {
    ...
    watch: {
        colorbool(newbool, oldbool) {
            if (newbool == true) {
                this.footerBg = '/static/ylhg/img/index-main-bg-n.jpg';
            } else {
                this.footerBg = '/static/ylhg/img/home/image_2019_02_14T08_56_54_932Z.png';
            }
        }
    },
    mounted() {
...
#footer-bg {
    ...
    .footer {
        ...
        .fastFunctions {
            ...
            .funcItem {
                ...
                .footerIcon {
                    ...
                    height: 60px;
                    margin-right: 16px;
                    background: url('/static/ylhg/img/footer/footer_icons.png') no-repeat center;
        ...
        .sponsors {
            width: 100%;
            height: 66px;
            background: url(/static/ylhg/img/footer/sponsors.png) no-repeat center bottom;
        }
