    ...
    .content {
        ...
        .regBox {
            ...
            .regPanel {
                ...
                background: url(/static/ylhg/img/register/fast_register_panel4.png) no-repeat center;
                display: flex;
                ...
                .listBox {
                    ...
                    .inputBox {
                        ...
                        .submit {
                            ...
                            font-size: 16px;
                            color: #fff;
                            background: url(/static/ylhg/img/register/submit_register1.png) no-repeat center;
                            transition: all 0.2s;

                            &:hover {
                                background: url(/static/ylhg/img/register/submit_register2.png) no-repeat center;
                                transition: all 0.2s;
                            }
                        }
