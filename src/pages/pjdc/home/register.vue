    ...
    <div class="register-area">
      <div class="content clearfloat">
        ...
        <div class="header-img">
          <img src="/static/pjdc/img/reg/reg-header-img.png" alt />
          <div class="title-1">
            <p>注册</p>
            <p>游戏账号</p>
          </div>
...
export default {
  ...
  data() {
    return {
      codeImg: "/static/pjdc/img/re.png",
      setInter: null,
      activeMemberCount: 0,
      joinMemberCount: 0,
      AGMoney: 41126438900,
      ...
      headBg: "/static/pjdc/img/reg/reg-top-bg.jpg",
      bgColor: "#47080E"
    };
  },
  mounted() {},
...
.register-area {
  width: 1920px;
  height: 800px;
  background: url(/static/pjdc/img/reg/reg-bg.png) no-repeat;
  margin: 0 auto;
  ...
  .content {
    ...
    margin: 30px auto 0;
    position: relative;
    background: url("/static/pjdc/img/reg/reg-content-bg.png") no-repeat;
    background-size: 100%;
    .header-img {
      position: absolute;
      top: 38px;
