  ...
  <div class="winlist clearfix slideLeft">
    ...
    <div class="right-area">
      <div class="game-winlist-1 game-winlist">
        <img src="/static/pjdc/img/home/ag-s.png" alt />
      ...
      <div class="game-winlist-2 game-winlist">
        <img src="/static/pjdc/img/home/mg-s.png" alt />
        <span class="win-name">超级奖池</span>
        <div
          class="win-money"
  ...
  methods: {
    ...
    initWinningInfo() {
      ...
      for (let i = 0; i < length; i++) {
        ...
        name = name.substr(0, 2).padEnd(7, '*')+name2.substr(0, 3);
...
.winlist {
  ...
  height: 175px;
  margin: 20px auto 0;
  background: url("/static/pjdc/img/home/winlist-bg.png") no-repeat;
  ...
  .top-title {
    position: absolute;
    top: 0;
    background: url("/static/pjdc/img/home/winlist-top.png") no-repeat;
    width: 176px;
    height: 41px;
    line-height: 41px;
    text-align: center;
