...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/pjdc/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/pjdc/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/pjdc/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/pjdc/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/pjdc/home/buyu')), 'vpBuyu')
const vpQipai = r => require.ensure([], () => r(require('@/pages/pjdc/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/pjdc/home/tiyu')), 'vpTiyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/pjdc/home/youhui/index')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/pjdc/home/register')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/pjdc/register')), 'register1')
// 帮助
const about = r => require.ensure([], () => r(require('@/pages/pjdc/home/help/about')), 'about')
const issue = r => require.ensure([], () => r(require('@/pages/pjdc/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/pjdc/home/help/partner')), 'partner')
