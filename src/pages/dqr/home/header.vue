<template>
  <div class="new-header">
    ...
    <div class="header-top" :class="{night:colorbool}" >
      <!-- 登录 -->
      <div class="timeHead">
        <div class="sj-box clearfix" style="display:flex;justify-content: space-between;">
          <a class="time"  href="javascript:void(0)" >美东时间:<span id="EST_reciprocal">{{time}}</span></a>
          <ul class="clearfix">
      ...
      <div class="headerFlex">
        <div class="flex1"><img src="/static/dqr/logo/logo.png" style="width:270px;"></div>
        <div class="flex2">
          <div class="login">
            <div class="sjContainer">
              <div class="sj">
                  <!-- <div class="sj-box clearfix">
                    <a class="time" v-if="loggedIn != true" href="javascript:void(0)" style="color:#fff;margin-right:8px">美东时间:<span id="EST_reciprocal">{{time}}</span></a>
                    <ul class="clearfix">
                      <li><a href="javascript:;" class="colors-change detection" @click="goHeader(3)">线路检测</a>&nbsp;&nbsp;</li>
                      <li><a href="javascript:;" class="colors-change jiebei" @click="goHeader(1)">免息借呗</a>&nbsp;&nbsp;</li>
                      <li><a href="javascript:;" class="colors-change guanjia" @click="goHeader(2)">金管家</a>&nbsp;&nbsp;</li>
                  ...
                  <div class="login-before">
                      <div class="form">
                        <div class="florList clearfix" v-if="loggedIn == false">
                          ...
                          <!-- 登录 -->
                          <div>
                            <input type="button"  id="loginBtn" style="padding:0;text-indent:0" @click="login">
                          </div>
                          <!-- 开户 -->
                          <div style="margin-right:0">
                            <!-- <a  @click="goKaihu" style="padding:0;text-indent:0"  id="resetBtn">注册</a> -->
                            <input @click="goKaihu" type="button" style="padding:0;text-indent:0"  id="resetBtn">
                          </div>
                        </div>
                        <div class="loginAfter" v-if="loggedIn == true">
                          ...
                          <!-- <div @click="getUrl">
                            <span><img src="/static/dqr/img/icon_ser.png" alt=""></span>
                            <span>在线客服</span>
                          </div> -->
                        </div>
                      </div>
          ...
          <div class="nav">
            <div class="navBox">
              ...
              <!-- <div class="logo" @click="$router.push('/')"><img src="/static/dqr/logo/logo.png" alt=""></div> -->
              <div class="navItems">
                <span @mouseover="getgameData(item)" :class="['navItem',item.text]" v-for="(item,i) in classifyList" :key="i" @click="$goPath('one',item)">
                ...
                <div class="smallWidth" v-if="gameArr.length < 10">
                  <ul>
                    <li :class="gamename" v-for="(item,index) in gameArr" v-show="item.id != '0'" :key="index">
                      <span><img :src="'/static/dqr/img/new_games/new_icon/'+item.id+'.png'" ></span>
                  ...
                  <swiper :options="swiperOption" ref="mySwiper" >
                      <swiper-slide v-for="(item,index) in gameArr" :key="index">
                          <div :class="['slide_list',gamename]" >
                              <span v-if="lotteryImg"><img width="70px" :src="'/static/dqr/img/new_games/lottery/'+item.id+'.svg'" ></span>
                              <span v-else><img :src="'/static/dqr/img/new_games/new_icon/'+item.id+'.png'" ></span>
                              <span>{{item.name}}</span>
                              <span @click="gogames(item)">进入游戏</span>
                          </div>
                      </swiper-slide>
  ...
  methods: {
    ...
    getNativeDatas() {
        if (localStorage.gameSortV4_chess) {
          this.classifyList[1].arr = this.$gameClassV4('chess');
          console.log(this.$gameClassV4('chess'))
          this.classifyList[2].arr = this.$gameClassV4('slot');
          this.classifyList[3].arr = this.$gameClassV4('fish');
          this.classifyList[4].arr = this.cpArr;
          this.classifyList[5].arr = this.$gameClassV4('live');
          ...
          .login-before {
            .form {
              .florList {
                ...
                #loginBtn {
                  background: url('/static/dqr/img/l2.png') no-repeat;
                  background-size: 100% 31px;
                  color: #563500;
                  border: none;
                }
                #resetBtn {
                  background: url('/static/dqr/img/l1.png') no-repeat;
      ...
      .navBox{
        ...
        .navItems{
          ...
          span{
            ...
            // height: 85px;
            // line-height: 85px;
            background: url(/static/dqr/img/arro.png) 100% no-repeat;
