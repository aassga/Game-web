    ...
    <div class="top_nav">
            ...
            <div class="nav_box">
                <ul class="nav-bar fl">
                    <li :class="['tpT',item.name == 'logo' ? 'logoClass':'']" v-for="(item,i) in classifyList" :key="i" >
                        <img src="/static/dqr/img/thirdparty/hot.gif" class="x-dh-i" alt v-if="item.hotShow && item.name != 'logo'">
        ...
        <div class="newgong" v-if="$route.path==='/home'" :class="{youhuiActive:$route.path=='/home/youhui'}">
            <div class="newgong-content" @click="showTextModal()">
                <div class="notice">
                    <i class="iconfont"><img src="/static/dqr/img/speaker.png" alt=""></i>
                    澳门威尼斯人公告
                </div>
                ...
                <div class="kf" @click="goService">
                    <img src="/static/dqr/img/index_13.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    data() {
        return {
            ...
            classifyList: [
                ...
                {
                    name: "logo",
                    logoUrl:'/static/dqr/img/logo_4.png',
                    type:"logo",
                },
                {
                    name: "电子游艺",
