                ...
                <div class="title_tab">
                    ...
                    <div class="close1" @click="close">
                        <a href="javascript:void(0)">
                            ...
                            <img src="/static/dqr/img/xx.png" alt="">
                        </a>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            list: [
                {img:"/static/dqr/img/sl1.png"},
                {img:"/static/dqr/img/sl2.png"},
                {img:"/static/dqr/img/sl3.png"},
                {img:"/static/dqr/img/sl4.png"},
            ],
...
.register {
    ...
    .popup {
        ...
        .headline {
            ...
            background: url('/static/dqr/img/reheader.png') no-repeat;
        ...
        .logAside{
            ...
            ul{
                li{
                    ...
                    &:first-child{
                        background: url('/static/dqr/img/tan2.png') no-repeat;
                        background-size: 100% 100%;
                        span{
                            &:last-child{
                                font-size: 14px;
                    ...
                    &:nth-child(2){
                        background: url('/static/dqr/img/tan1.png') no-repeat;
                        background-size: 100% 100%; 
                    }
                    &:nth-child(3){
                        background: url('/static/dqr/img/tan3.png') no-repeat;
                        background-size: 100% 100%; 
                    }
                    &:last-child{
                        background: url('/static/dqr/img/tan4.png') no-repeat;
                        background-size: 100% 100%; 
                    }
                }
            }
