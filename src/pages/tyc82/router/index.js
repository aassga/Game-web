...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/tyc82/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/tyc82/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/tyc82/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/tyc82/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/tyc82/home/buyu')), 'vpBuyu')
const vpQipai = r => require.ensure([], () => r(require('@/pages/tyc82/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/tyc82/home/tiyu')), 'vpTiyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/tyc82/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/tyc82/home/register')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/tyc82/register')), 'register1')
// 帮助
const agent = r => require.ensure([], () => r(require('@/pages/tyc82/home/agent')), 'register') // 注册界面
const about = r => require.ensure([], () => r(require('@/pages/tyc82/home/help/about')), 'about')
const issue = r => require.ensure([], () => r(require('@/pages/tyc82/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/tyc82/home/help/partner')), 'partner')
