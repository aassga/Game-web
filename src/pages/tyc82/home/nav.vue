    ...
    <div class="nav-content">
      <div class="nav_list">
        <div class="nav_contaner">
          <div class="logo fl">
            <router-link to="/">
              <img src="/static/tyc82/img/tyclogo.png" style="height:105px;width:317px;margin-top:5px;" />
            </router-link>
          </div>
...
export default {
  data() {
    return {
      isActive:0,
      showClass:false,
      codeImg:"/static/tyc82/img/home/lo2.png",
...
.top_nav {
    ...
    .nav-bar {
      ...
      li.nav-item > a {
        ...
        .ico {
          ...
          margin-bottom: 7px;
          &.icon_Home {
              background: url(/static/tyc82/img/icon_Home.png) no-repeat center center;
          }
          &.icon_slot {
              background: url(/static/tyc82/img/icon_slot.png) no-repeat center center;
          }
          &.icon_chess {
              background: url(/static/tyc82/img/icon_chess.png) no-repeat center center;
          }
          &.icon_casino {
              background: url(/static/tyc82/img/icon_casino.png) no-repeat center center;
          }
          &.icon_lottery {
              background: url(/static/tyc82/img/icon_lottery.png) no-repeat center center;
          }
          &.icon_fishing {
              background: url(/static/tyc82/img/icon_fishing.png) no-repeat center center;
          }
          &.icon_sport {
              background: url(/static/tyc82/img/icon_sport.png) no-repeat center center;
          }
          &.icon_promo {
              background: url(/static/tyc82/img/icon_promo.png) no-repeat center center;
          }
          &.icon_service {
              background: url(/static/tyc82/img/icon_service.png) no-repeat center center;
          }
       }
       &:hover {
  ...
  .left{
    ...
    .server{
      height: 370px;
      width: 140px;
      background: url('/static/tyc82/img/home/left.gif') no-repeat;
      li{
        height: 45px;
      }
    }
  ...
  .right{
    ...
    .server{
      height: 370px;
      width: 140px;
      background: url('/static/tyc82/img/home/right.gif') no-repeat
    }
    p{
      position: absolute;
      top: 94px;
