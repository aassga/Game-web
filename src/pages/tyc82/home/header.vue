<template>
  <div class="header">
    ...
    <div class="header-top">
      <div class="header-top-left-time"><img src="/static/tyc82/img/11.png" alt="">
...
export default {
  ...
  data() {
    return {
      codeImg:"/static/tyc82/img/home/lo.png",
      top: -193,
      time: "",
  ...
  methods: {
    ...
    goHeader(name){
      switch (name) {
        case 'downLoad':
          window.open('/static/tyc82/html/download/index.html');
          break;
        case 'borrowM':
          if(localStorage.token){
              if(this.$store.state.game.jieBeiData.show){
                 ...
                 //window.open('/static/tyc82/html/active/jiebei/index.html');
              }
          }else{
            //window.open('/static/tyc82/html/active/jiebei/index.html');
...
.fresh {
  ...
  height: 16px;
  position: relative;
  background: url("/static/tyc82/img/refresh.png");
  vertical-align: sub;
}
.refresh {
  background: url("/static/tyc82/img/newrefresh.png");
}
.fres {
...
.header {
  ...
  .header-top {
    ...
    .header-top-left-time {
      float: left;
      padding-left: 30px;
      background: url(/static/tyc82/img/mar.png) no-repeat left center;
      font-size: 14px;
      color: #868686;
      img{
        display: block;
    ...
    .header-top-right {
      ...
      .login-before {
        ...
        margin: 0 auto;
        position: absolute;
        background: url('/static/tyc82/img/login.png') no-repeat;
        left: 50%;
        top: 200px;
        z-index: 3;
        ...
        .input-item {
          ...
          &.username {
            padding-left: 30px;
            background: url("/static/tyc82/img/home/username.png") no-repeat 12px 10px;
          }
          &.password {
            padding-left: 30px;
            background: url("/static/tyc82/img/home/password.png") no-repeat 12px 10px;
          }
          &.code {
            padding-left: 30px;
            width: 130px;
            background-size: 13%;
            background: url("/static/tyc82/img/home/yzCode.png") no-repeat 9px 8px;
          }
        }
        .code-img {
          width: 76px;
        ...
        .reg-item {
          ...
          &.login-item {
            ...
            // cursor: pointer;
            // outline: none;
            background: url("/static/tyc82/img/home/dl.png") no-repeat;
            &:hover{
              cursor:pointer;
            }
          }
          &.reg-item {
            background: url("/static/tyc82/img/home/ro.png") no-repeat;
            cursor: pointer;
            a {
              color: #fff;
            }
    ...
    .header-login {
      ...
      #loginForm {
          ...
          // padding-left: 360px;
          .header-logincon {
              background: url(/static/tyc82/img/wzs.png) left center no-repeat;
              height: 100%;
              width: 1200px;
              margin: 0 auto;
              display: flex;
              ...
              .subbtn {
                  background: url(/static/tyc82/img/subbtn.png) no-repeat;
                  width: 100px;
                  height: 30px;
                  border: none;
                  padding: 0;
              ...
              .regbtn {
                  background: url(/static/tyc82/img/regbtn.png) top center no-repeat;
                  width: 100px;
                  height: 30px;
                  display: block;
                  float: left;
              ...
              span {
                  a {
                      ...
                      &.logOut {
                          ...
                          text-align: center;
                          color: #000;
                          background: url(/static/tyc82/img/log_out.png) center center no-repeat;
    ...
    .login-after {
      ...
      .refresh_balance {
          .refresh {
              ...
              width: 22px;
              height: 20px;
              background: url('/static/tyc82/img/refresh.png') center center no-repeat;
              transform: scale(1.2);
              margin-top: 19px;
          }
          .newfresh{
              background:url('/static/tyc82/img/newfresh.png') no-repeat center;
          }
          .fres{
