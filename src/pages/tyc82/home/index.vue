    ...
    <div class="carouse" :class="{'bounceOut':$route.path=='/home'}">
      ...
      <div class="newgong">
        <div class="newgong-content">
          <div class="notice">
            <img src="/static/tyc82/img/home/notice-icon.png" class="notice-icon" alt />
            <span>最新公告 :</span>
          </div>
...
export default {
  data() {
    return {
      ...
      carouselData: [
      //   {
      //     img: "/static/tyc82/img/banner/A.jpg"
      //   },
      //   {
      //     img: "/static/tyc82/img/banner/B.jpg"
      //   },
      //   {
      //     img: "/static/tyc82/img/banner/C.jpg"
      //   },
...
.new-index {
  ...
  .content {
    overflow: hidden;
    background: url('/static/tyc82/img/background.jpg') no-repeat;
