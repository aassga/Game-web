<template>
  <div>
    <div class="vp-hsyl-style" :class="{'tcgBlur':$store.state.personal.isPersonal}">
      ...
      <!-- 主页 -->
      <div v-else class="hsyl-cont-wrap" style="background:#141414">
  ...
  export default {
    ...
    data () {
      return {
        ...
        poptype: 'vnso',
        lotHeadDatas: {
          logoUrl: '/static/tyc82/img/lottery_logo.png',
          downLoadurl: '/static/tyc82/html/download/index.html',
        },
        attPar:{
          btnColor:'#1B1B1B',
          closeImg: "close_1", //弹窗关闭图片
          coverImgUrl:"../../../../static/tyc82/img/tc.png",
        },
      }
    },
    methods: {
