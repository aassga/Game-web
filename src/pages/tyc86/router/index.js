...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/tyc86/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/tyc86/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/tyc86/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/tyc86/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/tyc86/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/tyc86/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/tyc86/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/tyc86/register.vue')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/tyc86/home/register1.vue')), 'register1')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/tyc86/home/help/About')), 'about')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/tyc86/home/tiyu')), 'tiyu')
// const vp_caipiao = r => require.ensure([], () => r(require('@/pages/tyc86/home/caipiao/index')), 'caipiao')
