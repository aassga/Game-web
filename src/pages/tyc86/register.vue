<template>
  <div class="register">
            ...
            <div class="list-box">
              ...
              <div class="text-context">
                ...
                <div class="input-cont">
                  ...
                  />
                  <i
                    :class="showEye1 ? 'openEyes' : 'closeEyes'"
                    @click="changeEyes(1)"
                  ></i>
                </div>
              </div>
              ...
              <div class="text-context">
                ...
                <div class="input-cont">
                  ...
                  />
                  <i
                    :class="showEye2 ? 'openEyes' : 'closeEyes'"
                    @click="changeEyes(2)"
                  ></i>
                </div>
              </div>
              ...
              <div class="treaty">
                已有帐号？<span @click="changeTab(1)">点击登录</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="list-box">
              ...
              <div class="text-context">
                ...
                <div class="input-cont">
                  ...
                  />
                  <i
                    :class="showEye3 ? 'openEyes' : 'closeEyes'"
                    @click="changeEyes(3)"
                  ></i>
                </div>
              </div>
    ...
    <div
      ...
      class="service"
      @mousedown="move"
      style="position: absolute; width: 102px"
    >
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      defaultPwd: "",
      defaultPwd2: "",
      formBg: "../../../static/tyc86/img/form_bg.png",
      showEye1: false,
      showEye2: false,
      showEye3: false,
      showForm: 1,
      ...
      codeImg: "/static/tyc86/img/new_games/re.png",
      codeImg: "/static/tyc86/img/new_games/log.png",
      tabIndex: 1,
  ...
  created() {
    this.$store.commit(
      "home/isImgortg",
      JSON.parse(localStorage.config).VerificationCode.pc[0]
    );
  },
  watch: {
    screenWidth(val) {
...
.register {
  ...
  overflow: hidden;
  padding: 0 !important;
  background: url(/static/tyc86/img/register_bg.png) no-repeat;
  background-size: cover;
  .clearfloat1 {
    position: relative;
    top: 195px !important;
    ...
    .login {
      ...
      .text-context {
        ...
        .iconfont1 {
          width: 20px;
          height: 22px;
          background: url("/static/tyc86/img/acc.png");
        ...
        .iconfont2 {
          width: 20px;
          height: 24px;
          background: url("/static/tyc86/img/pwd.png");
          background-repeat: no-repeat;
          background-size: 100% 100%;
          position: absolute;
          left: 15px;
        ...
        .iconfont3 {
          width: 22px;
          height: 24px;
          background: url("/static/tyc86/img/yanzhengma.png") no-repeat;
          background-size: 100% 100%;
          position: absolute;
          left: 14px;
          top: 5px;
      ...
      .code {
        ...
        input {
          ...
          border-image: linear-gradient(to bottom, transparent 50%, #e7e7e7 50%)
            0 0 100%/1px 0;
        }
        input::-webkit-input-placeholder {
          font-size: 17px;
  ...
  .service {
    ...
    span {
      ...
      //     width: 114px;
      //     height: 114px;
      //     background: url('../../../static/tyc86/img/ser.png');
      //     background-repeat: no-repeat;
      //     background-size: cover;
      // }
    }
  ...
  .content {
    ...
    background: #fff;
    border-radius: 30px;
    background: url("/static/tyc86/img/register_img.png");
    background-repeat: no-repeat;
    background-size: 100% 100%;
    // margin-top: 41px;
    .reg-img {
    ...
    .titleTab {
      ...
      margin-bottom: 15px;
      border-bottom: 1px solid transparent;
      border-image: linear-gradient(to bottom, transparent 60%, #e7e7e7 60%) 0 0
        100%/1px 0;
      .clicked {
        color: #721922;
        font-size: 36px;
      ...
      .list-box {
        .text-context {
          ...
          .openEyes {
            ...
            height: 13px;
            display: inline-block;
            background: url("/static/tyc86/img/eye1.png") no-repeat;
            background-size: 100% 100%;
            position: absolute;
            top: 9px;
            right: 15px;
          ...
          .closeEyes {
            ...
            height: 13px;
            display: inline-block;
            background: url("/static/tyc86/img/eye2.png") no-repeat;
            background-size: 100% 100%;
            position: absolute;
            top: 9px;
            right: 15px;
