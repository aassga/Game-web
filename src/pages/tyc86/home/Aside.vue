<template>
  <div>
    <ul
      id="TplFloatPic_0"
      class="TplFloatSet TplFloatPic_1"
      picfloat="left"
      v-if="s1"
    >
      <div id="adleft" style="display: block" href="javascript:void(0)">
        <img src="/static/tyc86/img/left.png" style="width: 223px" />
      </div>
      <div class="close1" @click="s1 = false">
        <img src="/static/tyc86/img/close.png" alt="" />
      </div>
    ...
    <ul
      ...
      v-if="s2"
    >
      <div id="adright" style="display: block" href="javascript:void(0)">
        <img src="/static/tyc86/img/right.png" style="width: 223px" />
      </div>
      <div class="close2" @click="s2 = false">
        <img src="/static/tyc86/img/close.png" alt="" />
      </div>
      ...
      <a
        class="right by3"
        href="/static/tyc86/html/download/index.html"
        target="_blank"
      ></a>
      <a class="right by4" href="http://653.com" target="_blank"></a>
    </ul>
  </div>
</template>
