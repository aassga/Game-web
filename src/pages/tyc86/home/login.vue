<template>
  <div class="login" v-if="this.$store.state.home.showLogin">
    <div
      class="logBox animated bounceIn animate__animated animate__bounce"
      ref="logBox"
    >
      <div class="logTitle">
      ...
      <div class="logBottom">
        ...
        <div class="logMember">
          <div class="logMemberL">
            <img src="../../../../static/tyc86/login/yuan.png" alt="" />
            <span>记住密码</span>
          </div>
          <div class="logMemberM" @click="$forget()">忘记密码?</div>
          <a>
...
.login {
  ...
  .logBox {
    ...
    background-image: url(/static/tyc86/login/login-bg.png);
    ...
    .logTitle {
      ...
      background-image: url(/static/tyc86/logo/logos.png),
        url(/static/tyc86/login/bg-close.png);
      background-repeat: no-repeat;
