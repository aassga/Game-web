    ...
    <div class="popup">
      ...
      <div class="content">
        <div class="title_tab">
          <div class="close1" @click="close">
            <a href="javascript:void(0)">
              ...
              <img src="/static/tyc86/img/xx.png" alt="" />
            </a>
          </div>
        </div>
        ...
        <div class="row" v-if="!isShowSms && !isShowTnCode">
          ...
          <div class="group" style="width: 410px">
            <input
              autocomplete="off"
              class="regCode"
              type="text"
        ...
        <div class="row tip_info">
          <p>
            完成即视为同意已年满18岁，且在此网站所有活动并没抵触本人所在国家所管辖的法律
          </p>
        </div>
      </div>
      <div class="logAside">
...
export default {
  ...
  data() {
    return {
      ...
      list: [
        { img: "/static/tyc86/img/sl1.png" },
        { img: "/static/tyc86/img/sl2.png" },
        { img: "/static/tyc86/img/sl3.png" },
        { img: "/static/tyc86/img/sl4.png" },
      ],
...
.register {
  ...
  .popup {
    ...
    .headline {
      ...
      background: url("/static/tyc86/img/reheader.png") no-repeat;
    ...
    .logAside {
      ...
      ul {
        li {
          ...
          &:first-child {
            background: url("/static/tyc86/img/tan2.png") no-repeat;
            background-size: 100% 100%;
            span {
              &:last-child {
                font-size: 14px;
          ...
          &:nth-child(2) {
            background: url("/static/tyc86/img/tan1.png") no-repeat;
            background-size: 100% 100%;
          }
          &:nth-child(3) {
            background: url("/static/tyc86/img/tan3.png") no-repeat;
            background-size: 100% 100%;
          }
          &:last-child {
            background: url("/static/tyc86/img/tan4.png") no-repeat;
            background-size: 100% 100%;
          }
        }
      }
