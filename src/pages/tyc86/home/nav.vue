  ...
  <div class="top_nav">
    <div
      class="carouse t-default"
      v-if="$route.path === '/home'"
      style="cursor:pointer,background:#696969;"
    >
      <div class="carouse">
        <Carousel
          v-model="curIndex"
    ...
    <div
      class="newgong"
      v-if="$route.path === '/home'"
      :class="{ youhuiActive: $route.path == '/home/youhui' }"
    >
      <div class="newgong-content" @click="showTextModal()">
        ...
        <div class="kf" @click="goService">
          <img src="/static/tyc86/img/index_13.png" alt="" />
        </div>
      </div>
    </div>
  </div>
  ...
  data() {
    return {
      ...
      classifyList: [
        ...
        {
          name: "logo",
          logoUrl: "/static/tyc86/img/logo_4.png",
          type: "logo",
        },
        {
          name: "电子游艺",
  ...
  .newgong {
    ...
    .newgong-content {
      ...
      .notice {
        ...
        font-size: 14px;
        color: #fff;
        background: url("/static/tyc86/img/speake.png") no-repeat;
        i {
          font-weight: 500;
          color: #4b9bf1;
