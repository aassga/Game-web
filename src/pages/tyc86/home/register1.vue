    ...
    <div class="register">
          ...
          <div class="list-box">
            <div class="text-context">
              <div class="input-cont">
                <div class="iconfont">
                  <img
                    src="/static/tyc86/img/register/pel.png"
                    alt=""
                  />
                </div>
                <input
            ...
            <div class="text-context">
              <div class="input-cont">
                <div class="iconfont">
                  <img
                    src="/static/tyc86/img/register/key.png"
                    alt=""
                  />
                </div>
                <input
      ...
      <div class="register-right">
        <div class="iconR">
          ...
          <!-- <span><img src="../../../../static/tyc86/img/register/erm.png"  alt=""/></span> -->
        </div>
        <div class="testR">
          <p style="color: #fff;">扫码下载 太陽城集團 APP</p>
          <span>（ iOS / Android 通用 ）</span>
        </div>
        <div class="phoneR">
          <img
            src="../../../../static/tyc86/img/register/regPhone.png"
            alt=""
          />
...
export default {
  ...
  data() {
    return {
      hasSendMsg:false,
      countDownTime:60,
      codeImg: "/static/tyc86/img/new_games/lo.png",
      tabIndex: 1,
...
.banner{
    ...
    height: 300px;
    margin: 0 auto;
    background: url('/static/tyc86/img/banner/headImg.png') top/cover no-repeat;
}
.registerBox {
  width: 100%;
  padding: 20px 0;
