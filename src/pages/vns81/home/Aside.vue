    ...
    <div>
        <ul id="TplFloatPic_0" class="TplFloatSet" picfloat="left">
            <a id="adleft" style="display:block;" href="javascript:void(0)">
                <img src="/static/vns81/img/left.gif">
            </a>
        ...
        <ul id="TplFloatPic_1" class="TplFloatSet" picfloat="right">
            <a id="adright" style="display:block;" href="javascript:void(0)"><img src="/static/vns81/img/right.gif"></a>
            ...
            <a class="download" href="/static/vns81/html/download/index.html" target="_blank"></a>
            <div class="codebox">
                <div ref="qr-code"></div>
            </div>
...
export default {
    ...
    methods: {
        ...
        goView(link) {
            if (link == '/home/jiebei') {
                window.open('/static/vns81/html/active/jiebei/index.html');
                return false;
            }
