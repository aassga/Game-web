...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/vns81/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/vns81/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/vns81/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/vns81/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/vns81/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/vns81/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/vns81/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/vns81/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')

const register = r => require.ensure([], () => r(require('@/pages/vns81/home/register')), 'register') //帮助页面
const register1 = r => require.ensure([], () => r(require('@/pages/vns81/register')), 'register1') //帮助页面
const agent = r => require.ensure([], () => r(require('@/pages/vns81/home/agent')), 'agent') //代理
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/vns81/home/help/about-page')), 'vpAboutPage') //关于我们
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/vns81/home/help/save-help')), 'vpSaveHelp') //存款帮助
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/vns81/home/help/pull-help')), 'vpPullHelp') //取款帮助
const vpRelation = r => require.ensure([], () => r(require('@/pages/vns81/home/help/relation')), 'vpRelation') //联系我们
