<template>
  <div id="footer-bg" class="clear">
    <div class="footer">
        <div class="footer-detail" :style="{background: 'url(' + footerBg + ')  no-repeat center top'}" :class="{night:colorbool}">
            <div class="foot_links">
                <ul class="wp flex">
                    <li class="introduce-cont">
                        <h3 class="footer-link-title">金星国际</h3>
                        <div>
                    ...
                    <li class="support-browser-cont">
                        ...
                        <div>
                            <img src="/static/amvns/img/home/image_2019_02_14T08_53_01_247Z.png" alt="" width="100">
                        </div>
                    </li>
                    <li class="regulatory-authority">
                        <h3 class="footer-link-title">监管机构</h3>
                        <div>
                            <img src="/static/amvns/img/home/image_2019_02_14T08_52_29_378Z.png" alt="" width="60">
                        </div>
                    </li>
                    <li class="platform-cont">
                        <h3 class="footer-link-title">合作伙伴</h3>
                        <div>
                            <img src="/static/amvns/img/image_2019_02_14T07_35_30_910Z.png" alt="" width="100%">
                        </div>
                    </li>
                </ul>
            </div>
    ...
    >
      ...
      <div class="agent-con">
          <span class="iconspan" :class="{newspan:modeldetail.leftspan}"> <i class="iconfont icon-baojing"></i><span class="tispan">{{modeldetail.title}}</span></span>
      </div>
      <div slot="footer"></div>
    </Modal>
...
export default {
  data() {
    return {
      ...
      footerBg: "/static/amvns/img/home/image_2019_02_14T08_56_54_932Z.png"
    };
  },
  methods: {
    goHelp(link) {
  ...
  watch: {
    colorbool(newbool, oldbool) {
      if (newbool == true) {
        this.footerBg = "/static/amvns/img/index-main-bg-n.jpg";
      } else {
        this.footerBg =
          "/static/amvns/img/home/image_2019_02_14T08_56_54_932Z.png";
      }
    }
  },
  mounted() {
    ...
    if (routerSrc === "/home/live") {
      this.footerBg =
        "/static/amvns/img/live/image_2019_02_18T01_13_08_099Z.png";
    } else if (routerSrc === "/home/buyu") {
      this.footerBg = "/static/amvns/img/buyu/footer-bg.jpg";
    } else if (routerSrc === "/home/tiyu") {
      this.footerBg = "/static/amvns/img/home/footer-bg.png";
    } else if (routerSrc === "/home/games") {
      this.footerBg = "/static/amvns/img/home/lhjfooter-bg.jpg";
    } else if (routerSrc == "/home/qipai") {
      this.footerBg = "/static/amvns/img/home/qpfooter-bg.jpg";
    } else if (routerSrc == "/home/youhui") {
      this.footerBg = "/static/amvns/img/home/yhfooter-bg.jpg";
    } else {
      this.footerBg =
        "/static/amvns/img/home/image_2019_02_14T08_56_54_932Z.png";
    }
