...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/amvns/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/amvns/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/amvns/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/amvns/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/amvns/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/amvns/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/amvns/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/amvns/home/register')), 'register')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/amvns/home/help/About/index')), 'about')
//购彩大厅
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/amvns/home/tiyu/index')), 'tiyu')
