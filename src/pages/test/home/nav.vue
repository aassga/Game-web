    ...
    <div class="nav-content">
      <div class="logo fl">
        <a href="javascript:void(0)" @click="goHome">
          <img src="/static/test/img/logo.png">
        </a>
      </div>
      ...
      <ul class="nav-bar fl">
        ...
        >
          <img src="/static/test/img/thirdparty/hot.gif" class="x-dh-i" alt v-if="item.hotShow">
      ...
      classifyList: [
        {
          ...
          list: [
            {
              name: "皇冠体育",
              img: "/static/test/img/thirdparty/hg.png",
              id: "39"
            },
            {
              name: "沙巴体育",
              img: "/static/test/img/thirdparty/saba.png",
              id: "38"
            },
               {
              name: "IM体育",
            ...
            // {
            //   name: "BBIN体育",
            //   img: "/static/test/img/thirdparty/bb.png",
            //   id: "41"
            // },
            // {
            //   name: "AG体育",
            //   img: "/static/test/img/thirdparty/agty.png",
            //   id: "40"
            // }
          ]
        },
        {
          ...
          list: [
            ...
            {
              name: "BG视讯",
              img: "/static/test/img/thirdparty/bg.png",
              id: "3180"
            },
            {
              name: "DG视讯",
              img: "/static/test/img/thirdparty/gpi.png",
              id: "42"
            },
            {
              name: "DS视讯",
              img: "/static/test/img/thirdparty/DS.png",
              id: "34"
            },
            {
              name: "LEBO视讯",
              img: "/static/test/img/thirdparty/lebo.png",
              id: "44"
            },
            {
              name: "OG视讯",
              img: "/static/test/img/thirdparty/evo.png",
              id: "48"
            },
            {
              name: "eBET视讯",
              img: "/static/test/img/thirdparty/ebet.png",
              id: "43"
            },
            {
              name: "LMG视讯",
              img: "/static/test/img/thirdparty/LMG.png",
              id: "45"
            },
            {
              name: "欧博视讯",
              img: "/static/test/img/thirdparty/ab.png",
              id: "46"
            },
            {
              name: "SA视讯",
              img: "/static/test/img/thirdparty/sa.png",
              id: "49"
            }
          ]
        },
        ...
        },
        {
          ...
          text: "MG CASINO",
          platform: "MG_GAME",
          link: "/home/games?navid=9&id=10022",
          hotShow: true,
          list: [
            {
              name: "不朽的浪漫",
        ...
        },
        {
          ...
          platform: "MG_GAME",
          hotShow: true,
          link: "/home/games?navid=9&id=0",
          list: [
            {
              name: "PT老虎机",
              img: "/static/test/img/thirdparty/pt.png",
              num: "10024"
            },
            {
              name: "AG老虎机",
            ...
            {
              name: "CQ9电子",
              img: "/static/test/img/thirdparty/CQ9.png",
              num: "10018"
            },
            {
              name: "MG老虎机",
              img: "/static/test/img/thirdparty/mg.png",
              num: "10022"
            },
            {
              name: "FG老虎机",
              img: "/static/test/img/thirdparty/fg.png",
              num: "10020"
            }
          ]
        },
       ...
       if(res && res.code==200){
        res.data[10004].forEach((item,index)=>{
              const qipai = {
                  ...
                  platform: item.code,
                  link: "/home/games?id="+item.id,
               }
               if(item.id==10042){
                   qipai.id=243
               }else if(item.id==10041){
                   qipai.id=10091
               }else if(item.id == 10612){
                   qipai.id=10613
               }else if(item.id == 10636){
                   qipai.id=10693
               }else if(item.id ==10694){
                   qipai.id=10695
               }else if(item.id == 10732){
                   qipai.id=10733
               }
