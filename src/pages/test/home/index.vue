      ...
      <div class="jackpots active">
        <div class="light">
          <div class="jackpot-title">
            <img src="/static/test/img/jockpot.png" alt>
          </div>
          ...
          <div class="jackpots_bar">
            <img src="/static/test/img/jack_bar.png">
          </div>
          <div class="jackpots_model">
            <img src="/static/test/img/jack_model.png">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="game-list-right">
            ...
            >
              <Carousel-item>
                <ul class="item_list">
                  <li
                    class="item"
                    @click="getItemId({name:'OG视讯厅',id:'48',platform:'live_casino'})"
                  >
                  ...
                  <li
                    class="item"
                    @click="getItemId({name:'eBET视讯厅',id:'43',platform:'live_casino'})"
                  >
                  ...
                  <li
                    class="item loy"
                    @click="getItemId({name:'LMG视讯厅',id:'45',platform:'live_casino'})"
                  >
                  ...
                  <li
                    class="item"
                    @click="getItemId({name:'欧博视讯厅',id:'46',platform:'live_casino'})"
                  >
                  ...
                  <li
                    class="item"
                    @click="getItemId({name:'SA视讯厅',id:'49',platform:'live_casino'})"
                  >
              ...
              <Carousel-item>
                <ul class="item_list">
                  <li class="item" @click="getItemId({name:'AG视讯',id:'31',platform:'live_casino'})">
                    <div class="ball">AG</div>
                    <div class="text">AG视讯</div>
                  </li>
                  <li
                    class="item"
                    @click="getItemId({name:'BBIN视讯',id:'32',platform:'live_casino'})"
                  >
                    <div class="ball">BBIN</div>
                  ...
                  <li
                    class="item loy"
                    @click="getItemId({name:'BG视讯',id:'3180',platform:'live_casino'})"
                  >
                    <div class="ball">BG</div>
                    <div class="text">BG视讯</div>
                  </li>
                  <li class="item" @click="getItemId({name:'DG视讯',id:'42',platform:'live_casino'})">
                    <div class="ball">DG</div>
                    <div class="text">DG视讯</div>
                  </li>
                  <li class="item" @click="getItemId({name:'DS视讯',id:'34',platform:'live_casino'})">
                    <div class="ball">DS</div>
                    <div class="text">DS视讯</div>
                  </li>
                  <li
                    class="item"
                    @click="getItemId({name:'LEBO视讯',id:'44',platform:'live_casino'})"
                  >
            ...
            >
              <Carousel-item>
                <ul class="item_list">
                  ...
                  <li class="item" @click="getItemId({name:'沙巴体育',id:'38',platform:'sport'})">
              ...
              <Carousel-item>
                <ul class="item_list">
                  <li class="item" @click="getItemId({name:'皇冠体育',id:'39',platform:'sport'})">
                    <div class="ball">皇冠</div>
                    <div class="text">皇冠体育</div>
                  </li>
                  <li class="item" @click="getItemId({name:'AG体育',id:'40',platform:'sport'})">
                    <div class="ball">AG</div>
        ...
        <div class="fish_game game-bg">
          <ul class="item_list">
            ...
            <li
              class="item"
              @click="trustLogin({name:'深海大赢家',platform:'PT_GAME',gameName:'cashfi',id:3296})"
            >
              <div class="ball">PT</div>
            ...
            <li
              class="item loy"
              @click="trustLogin({name:'千炮捕鱼',platform:'MW_GAME',gameName:'1051',id:151})"
            >
              <div class="ball">MW</div>
            ...
            <li
              class="item"
              @click="trustLogin({name:'龙王捕鱼',platform:'JDB_GAME',gameName:'7#7002',id:174})"
            >
              <div class="ball">JDB</div>
            ...
            <li
              class="item"
              @click="trustLogin({name:'欢乐捕鱼',platform:'FG_GAME',gameName:'fish_hl',id:2626})"
            >
              <div class="ball">FG</div>
            ...
            <li
              class="item"
              @click="trustLogin({name:'美人捕鱼',platform:'FG_GAME',gameName:'fish_mm',id:2576})"
            >
              <div class="ball">FG</div>
...
export default {
  ...
  methods: {
    ...
    downloadAppFc() {
      window.open("/static/test/html/download/index.html");
    },
    ...
    //获取捕魚参数
    async getBuyuData() {
      let res = await postS(`ChessFishSort`,{device:'pc',type:2})//type:类型：1：棋牌；2:：捕鱼
      if (res && res.code == 200) {
...
.new-index {
  ...
  .downLoad-wrap {
    ...
    .jackpots {
      ...
      width: 850px;
      height: 150px;
      background: url("/static/test/img/jackpot_in1.jpg") no-repeat center,
        url("/static/test/img/jackpot_out1.jpg") no-repeat;
      position: relative;
      ...
      @-webkit-keyframes bg {
        ...
        100% {
          background: url("/static/test/img/jackpot_in1.jpg") no-repeat center,
            url("/static/test/img/jackpot_out2.jpg") no-repeat;
        }
      }
      @-moz-keyframes bg {
        0% {
  ...
  .kelake-bot-wrap {
    ...
    .game-list-right {
      ...
      .all {
        ...
        .arrow {
          ...
          .bg-arrow_left {
            ...
            background: url(/static/test/img/arrow_sprites.png) -10px -10px;
          }
          ...
          .bg-arrow_right {
            ...
            -ms-transform: translateY(-50%);
            transform: translateY(-50%);
            background: url(/static/test/img/arrow_sprites.png) -45px -10px;
          }
        }
      ...
      .slot_game {
        height: 200px;
        margin-bottom: 20px;
        background-image: url("/static/test/img/game/slot_game.jpg");
      ...
      .live_game {
        ...
        .live {
          ...
          overflow: hidden;
          position: relative;
          background-image: url("/static/test/img/game/live_casino.jpg");
          float: left;
          background-size: cover;
        }
        ...
        .gym {
          ...
          position: relative;
          float: left;
          background-image: url("/static/test/img/game/sports_events.jpg");
          background-size: cover;
        }
      }
      ...
      .fish_game {
        height: 180px;
        margin-top: 10px;
        background-image: url("/static/test/img/game/fishing_game.jpg");
        background-size: cover;
      ...
      .lottery_game {
        height: 180px;
        margin-top: 10px;
        background-image: url("/static/test/img/game/lottery.jpg");
        background-size: cover;
      }
    }
  }
