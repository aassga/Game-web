          ...
          <div class="bannerHead">
            <ul class="bannerUl">
              <li @click="fetchActive(item.id)" :class="{activeItem:activeId==item.id}"
                  v-for="(item,index) in headerList" :key="index" :style="{width:(1200/headerList.length).toFixed(1)+'px'}">
                <div class="liItem">
...
<style lang="less" scoped>
  ...
  .maincontainer {
    padding-top: 60px;
    background: url(/static/test/img/youhui/bg.jpg) center top no-repeat, #f3f2ef;
  }
