...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/cpzj/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/cpzj/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/cpzj/home/home-live')), 'vpHomeLive')
// const vpRegister = r => require.ensure([], () => r(require('@/pages/cpzj/home/register')), 'vpRegister')
// const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/cpzj/home/home-contactUs')), 'vpHomeContactUs')
const vpGames = r => require.ensure([], () => r(require('@/pages/cpzj/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/cpzj/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/cpzj/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/cpzj/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/cpzj/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const vpIssue = r => require.ensure([], () => r(require('@/pages/cpzj/home/issue')), 'vpIssue')
const vpDuty = r => require.ensure([], () => r(require('@/pages/cpzj/home/duty')), 'vpDuty')
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/cpzj/home/help/save-help')), 'vpSaveHelp')
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/cpzj/home/help/pull-help')), 'vpPullHelp')
const vpRelation = r => require.ensure([], () => r(require('@/pages/cpzj/home/help/relation')), 'vpRelation')
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/cpzj/home/help/about-page')), 'vpAboutPage')
const vpPartnerPage = r => require.ensure([], () => r(require('@/pages/cpzj/home/help/partner-page')), 'vpPartnerPage')
const agent = r => require.ensure([], () => r(require('@/pages/cpzj/home/agent')), 'agent')
  ...
  routes: [
    {
      ...
      children: [
        ...
        {
          path: '/home/partner-page',
          component: vpPartnerPage
        },
        // 传统彩票
        {
          path: '/plays',
