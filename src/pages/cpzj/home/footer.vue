  ...
  <div class="footer-main">
    <ul class="footer-child footer-nav clear-fix">
      ...
      <li class="nav-item">
        ...
        <ol>
          <li><a href="javascript: void(0)" @click="goUserCen('recharge',0)">存款</a></li>
          <li><a href="javascript: void(0)" @click="goUserCen('withdraw',0)">取款</a></li>
          <li><a href="javascript: void(0)" @click="goUserCen('personage',1)">财务记录</a></li>
        </ol>
      </li>
      <li class="nav-item">
...
<script>
  import data from "../../public/homeMeans/Aside.js";
  import newModal from "../../public/home/modal.vue";
  export default {
    mixins: [data],
    components:{
      newModal
