                ...
                <div class="all-item">
                    <div :key="indexInner" @click="clickFocus(itemInner)" v-for="(itemInner,indexInner) in itemOut.mess" class="box">
                        <div class="banBo-item-left">
                            ...
                            <vp-drop-down class="select-toggle-add" v-on:drop-down-say="seletPrice" v-on:drop-down-hide="hidePrice" :itemInner="itemInner" v-if="seletPriceStaue==itemInner.id" ></vp-drop-down>
                        </div>
                        <div class="banBo-item-right">
                            <span :key="indexThird" v-for="(itemThird,indexThird) in itemInner.list" :style="{'background':itemInner.color}">{{itemThird.num}}</span>
                        </div>
                    </div>
                </div>
          ...
          <div :key="indexOut" v-for="(itemOut,indexOut) in listTop" class="decial-1-item">
            <div class="all-item">
              <div :key="indexInner" @click="clickFocus(itemInner)" v-for="(itemInner,indexInner) in itemOut.mess"
                ...
                <div class="banBo-item-right">
                  <span :key="indexThird" v-for="(itemThird,indexThird) in itemInner.list"
