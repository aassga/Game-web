    ...
    <form ref="formDynamic">
      <div class="lottery-content-all-left">
        <div class="lottery-content-min-height">
          ...
          <div class="decial-1 haveMargin lotFour">
  ...
  export default {
    ...
    data () {
      return {
        ...
        allData: data.zhengTeMa,
        listTop: data.zhengTeMa[0].list,
        listBot: data.zhengTeMa[1].list,
    ...
    methods: {
      ...
      async oddsBelong () {
        let codeString = ''
        if (this.navSelect == '正1特') {
          codeString = '20207'
        }
        if (this.navSelect == '正2特') {
          codeString = '20208'
        }
        if (this.navSelect == '正3特') {
          codeString = '20209'
        }
        if (this.navSelect == '正4特') {
          codeString = '20210'
        }
        if (this.navSelect == '正5特') {
          codeString = '20211'
        }
        if (this.navSelect == '正6特') {
          codeString = '20212'
        }
