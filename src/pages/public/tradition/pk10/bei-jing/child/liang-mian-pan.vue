      ...
      async oddsBelong () {
        ...
        this.listGYHe.forEach((outItem, v) => {
          ...
          outItem.mess.forEach((inItem, v) => {
            let oddballs=inItem.ball.substr(2,1)
            inItem.code = '20301'
            inItem.price = this.oddsList['20301_' + oddballs + ''].odds
            inItem.fixedOdds = this.oddsList['20301_' + oddballs + ''].odds
            inItem.fsrate = this.oddsList['20301_' + oddballs + ''].fsrate
          })
        })
