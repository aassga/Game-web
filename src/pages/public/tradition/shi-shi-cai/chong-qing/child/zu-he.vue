<template>
  <div class="lottery-content-all-wrap">
    ...
    <Modal :scrollable=true title="投注信息" v-model="modal" class-name="vp-betting-warp" width="584" height="400"
      ...
      <vp-betting ref="betting" v-on:bet-ball-list="changInputstatus"></vp-betting>
       <div slot="footer">
      ...
      async oddsBelong () {
        ...
        this.listNumber.forEach((outItem, v) => {
          ...
          outItem.mess.forEach((inItem, v) => {
            inItem.code = '20101'
            inItem.price = this.oddsList['20101_' + inItem.ball + ''].odds
            inItem.fixedOdds = this.oddsList['20101_' + inItem.ball + ''].odds
            inItem.fsrate = this.oddsList['20101_' + inItem.ball + ''].fsrate
          })
        })
        // 玩法
