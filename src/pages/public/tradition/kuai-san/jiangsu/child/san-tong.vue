...
<script>
  ...
  export default {
    ...
    data () {
      return {
        allData: data.ziXuan,
        listCenter: data.ziXuan[0].list,
        sanTong: data.ziXuan[1].list,
        confirmbet:true
      }
    },
    methods: {
      ...
      async oddsBelong () {
        this.listCenter.forEach((outItem, v) => {
          ...
          outItem.mess.forEach((inItem, v) => {
            inItem.code = '20502'
            inItem.price = this.oddsList['20502_' + inItem.ball + ''].odds
            inItem.fixedOdds = this.oddsList['20502_' + inItem.ball + ''].odds
            inItem.fsrate = this.oddsList['20502_' + inItem.ball + ''].fsrate
          })
        })
