    ...
    <form ref="formDynamic">
      <div class="lottery-content-all-left">
        ...
        <div class="lottery-content-min-height">
          ...
          <div class="lottery-header-common-all first">
            <span>从11-66中任意选1个或者多个号码，选号与奖号（包含11-66，不限顺序）相同，即为中奖（不含豹子）</span>
          </div>
      ...
      async oddsBelong () {
        this.listBot.forEach((outItem, v) => {
          ...
          outItem.mess.forEach((inItem, v) => {
            inItem.code = '20504'
            inItem.price = this.oddsList['20504_' + inItem.ball + ''].odds
            inItem.fixedOdds = this.oddsList['20504_' + inItem.ball + ''].odds
            inItem.fsrate = this.oddsList['20504_' + inItem.ball + ''].fsrate
          })
        })
      },
      // 提交前检查，展示
          ...
          .all-item {
            .box {
              ...
              .ksBall {
                ...
                &.bgActive4 {
                  background: url("/static/public/image/lottery/kuai3/kuai3/ksfour@3x.png");
                  background-size: 100% 100%;
                }
