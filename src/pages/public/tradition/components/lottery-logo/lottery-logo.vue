              ...
              <div class="name">{{$route.meta.name}}</div>
                <div class="number">
                  ...
                  <span v-if="$route.meta.id==11?false:$route.meta.id==28?false:true"><span class="black">&nbsp;总共:</span>
                                <span
                                  v-if="$route.meta.id==12||$route.meta.id==16||$route.meta.id==24||$route.meta.id==27">1329</span>
                                ...
                                <span v-else-if="$route.meta.id==3">288</span>
                                ...
                                <span v-else-if="$route.meta.id==10044">1329</span>
