...
export default {
  ...
  data() {
    ...
    const divList = arrayFromCache(10).map((n, i) => `<div class='dig-${i}'></div>`);
...
<style>
  ...
  .rol2 .d-roll-list .d-roll-item{
    list-style: none;
    float: left;
    flex-grow: 1;
    overflow: hidden;
  }
  .rol2 .d-roll-item>.d-roll-bar{
    backface-visibility: hidden;
    perspective: 1000;
  }
  .rol2 .d-roll-item>.d-roll-bar>div{
    width:21px;
    height: 27px;
    line-height:27px;
    margin-left:4px; 
  ...
  .rol2 .dig-0{
    background-image: url('/static/public/image/digitroll/roll/0.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
  .rol2 .dig-1{
    background-image: url('/static/public/image/digitroll/roll/1.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
  .rol2 .dig-2{
    background-image: url('/static/public/image/digitroll/roll/2.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
  .rol2 .dig-3{
    background-image: url('/static/public/image/digitroll/roll/3.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
  .rol2 .dig-4{
    background-image: url('/static/public/image/digitroll/roll/4.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
  .rol2 .dig-5{
    background-image: url('/static/public/image/digitroll/roll/5.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
  .rol2 .dig-6{
    background-image: url('/static/public/image/digitroll/roll/6.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
  .rol2 .dig-7{
    background-image: url('/static/public/image/digitroll/roll/7.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
  .rol2 .dig-8{
    background-image: url('/static/public/image/digitroll/roll/8.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
  .rol2 .dig-9{
    background-image: url('/static/public/image/digitroll/roll/9.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
