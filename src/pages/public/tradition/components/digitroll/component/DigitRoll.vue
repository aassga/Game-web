...
<style>
  ...
  .rol1 .d-roll-list{
   ...
   .rol1 .d-roll-list .d-roll-item{
    list-style: none;
    float: left;
    flex-grow: 1;
    overflow: hidden;
  }
   .rol1 .d-roll-item>.d-roll-bar{
    backface-visibility: hidden;
    perspective: 1000;
  }
   .rol1 .d-roll-item>.d-roll-bar>div{
    width:15px;
    height: 22.5px;
    line-height:22.5px;
   ...
   .rol1 .dig-0{
    background-image: url('/static/public/image/digitroll/0.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
   .rol1 .dig-1{
    background-image: url('/static/public/image/digitroll/1.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
   .rol1 .dig-2{
    background-image: url('/static/public/image/digitroll/2.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
   .rol1 .dig-3{
    background-image: url('/static/public/image/digitroll/3.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
   .rol1 .dig-4{
    background-image: url('/static/public/image/digitroll/4.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
   .rol1 .dig-5{
    background-image: url('/static/public/image/digitroll/5.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
   .rol1 .dig-6{
    background-image: url('/static/public/image/digitroll/6.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
   .rol1 .dig-7{
    background-image: url('/static/public/image/digitroll/7.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
   .rol1 .dig-8{
    background-image: url('/static/public/image/digitroll/8.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
   .rol1 .dig-9{
    background-image: url('/static/public/image/digitroll/9.png');
    background-size: auto 100%;
    background-repeat: no-repeat;
    background-position: center;
  }
