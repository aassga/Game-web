                ...
                <div class="td-lottery-wide">
                  ...
                  <div class="wide-wrap" :key="outIndex" v-for="(outItem,outIndex) in newDatas.leftDatas.newSingle">
                    <div class="wide-inner-wrap">
                      ...
                      <!-- <div :class="{'active':intItem=='大'||intItem=='单'}" :style="{'width':intItem.length>=3?88+'px':60+'px'}" :key="intIndex" v-for="(intItem,intIndex) in outItem" class="item">{{intItem}}</div> -->
                    </div>
                  </div>
                </div>
              </div>
    ...
    methods: {
      ...
      async getHisDatas () {
        ...
        if (res && res.code == 200) {
          ...
          let rankConfig = [ //xxx
            {index: 0, name: 'hz'}, {index: 1, name: 'hdx'}, {index: 2, name: 'hds'}, {index: 3, name: 'kd'},
            {index: 4, name: 'xt'}
          ]
