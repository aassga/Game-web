<template>
  <div id="maincontainer">
    <div class="content">
      <div class="list_nav">
        <ul>
          <li
            ...
            :key="index"
            :class="[nav_active == item.id ? 'active' : '']"
            @click="setNav(item)"
          >
            <p>{{item.name}}</p>
          </li>
      ...
      <!-- <div class="content_box" ref="gameMenu" v-show="nav_active == 9999">
        <div class="mainbox">
          <ul class="game_type game_type1">
            <li
              :class="[maker_active == item.id ? 'active' : '']"
              :key="index"
              @click="setGameMaker(item)"
              v-for="(item,index) in listData.platform"
            >
              <div style="display: flex;justify-content: center;">
                <p class="game_icon" :class="[{'newactive':maker_active == item.id},`${classConfig[item.id]}`]"></p>
              </div>
              <span>{{item.name}}</span>
            </li>
          </ul>
        ...
        <div class="box">
          <ul class="list_type" v-show="nav_active == 9 && GameTypeList.length>1">
            ...
            <li
              ...
              :key="index"
              :class="[gameType_active == item.id ? 'active' : '']"
              @click="setGameType(item)"
            >{{item.name}}</li>
          </ul>
          <ul class="list_type" v-show="nav_active == 9 && gameTitleList.length<0">
            <li class="top">
              <i class="gicon gicon2"></i>赔付线数:
            </li>
            <li
              v-for="(item, index) in gameTitleList"
              :key="index"
              :class="[gameTitle_active == item.id ? 'active' : '']"
      ...
      <div class="hot_game" v-show="showHot&&nav_active != 9">
  ...
  methods: {
    ...
    setNav(item) {
      ...
      if (this.nav_active !== item.id) {
        ...
        this.maker_active = 99;
        this.gameType_active = 99;
        this.GameListAll = [];
        this.showGameList = [];
        this.iptVal='';
        //全部游戏
        if (item.id === 9) {
          if (this.$route.query.id) {
            this.listData.platform.some(ele => {
            ...
            this.setGameMaker(this.listData.platform[0]);
             window.scrollTo(0, scrollTop);
          }
        }
        //收藏游戏
        else if (item.id == 999) {
          this.showHotName='收藏游戏',
          this.showHot=true;
          this.getCollectList();
    ...
    joinCollect(item,index) {
      if (!localStorage.token || !localStorage.userinfo) {
        ...
        let arr = [];
        this.listData.platform.forEach(ele => {
          let Obj = {
            id: ele.id,
            name: ele.name
          };
    ...
    //获取捕鱼全部参数 是否在session里 不在则获取
    async getGameList() {
      let fishGame = sessionStorage.getItem("fishGame");
      let collectGame = sessionStorage.getItem("collectgames_fish");
      if (fishGame) {
        fishGame = JSON.parse(fishGame);
      } else {
      ...
      this.listData = fishGame.list;
      if (this.listData.label.length > 0) {
        this.listData.label.forEach(val => {
          if(val.id!=0){
              this.list_nav.push(val)
          }
        });
        for(var i=0;i<this.listData.label.length;i++){//热门游戏列表
          if(this.listData.label[i].name=='热门捕鱼'){
            this.searchList=this.listData.label[i].list.slice(0,15)
        ...
        if(this.listData.label[0].list){
          let swipList=this.listData.label[0].list
  ...
  .content {
    ...
    .list_nav {
      ...
      & > ul {
        ...
        li.active {
          background: url(/static/public/image/casino/images/border-bg.png)
      ...
      .search-head {
        ...
        .btn-search {
          ...
          .search_icon {
            ...
            height: 16px;
            display: inline-block;
            background: url("/static/public/image/casino/youyi/fdj.png")
    ...
    .content_box {
      ...
      .list_img {
        ...
        .slidePrev {
          left: 0;
          i {
            background: url("/static/public/image/game/new_games/next_l.png")
              center center / 17px no-repeat;
          }
        }
        .slidePrev:hover {
          i {
            background: url("/static/public/image/game/new_games/next_l_a.png")
              center center / 17px no-repeat;
          }
        }
        .slideNext {
          right: 0;
          i {
            background: url("/static/public/image/game/new_games/next_r.png")
              center center / 17px no-repeat;
          }
        }
        .slideNext:hover {
          i {
            background: url("/static/public/image/game/new_games/next_r_a.png")
              center center / 17px no-repeat;
          }
        }
        .list_img_btn {
      ...
      .mainbox {
        ...
        .game_type {
          ...
          li {
            ...
            &:hover ,&.active {
              .ag {
                background: url("/static/test-6/img/buyu/h_ag.png") no-repeat
                  center center;
              }
              .fg {
                background: url("/static/test-6/img/buyu/h_fg.png") no-repeat
                  center center;
              }
              .mw {
                background: url("/static/test-6/img/buyu/h_mw.png") no-repeat
                  center center;
              }
              .jdb {
                background: url("/static/test-6/img/buyu/h_jdb.png") no-repeat
                  center center;
              }
              .cq9 {
                background: url("/static/test-6/img/buyu/h_cq9.png") no-repeat
                  center center;
              }
              .pt {
                background: url("/static/test-6/img/buyu/h_pt.png") no-repeat
                  center center;
              }
              .bg {
                background: url("/static/test-6/img/buyu/h_bg.png") no-repeat
                  center center;
              }

              .hot_game {
                background: url("/static/public/image/casino/youyi/qb-hover.png") no-repeat
                  center center;
              }
            }
            ...
            div {
              ...
              & .ag {
                background: url("/static/test-6/img/buyu/ag.png") no-repeat
                  center center;
              }
              & .fg {
                background: url("/static/test-6/img/buyu/fg.png") no-repeat
                  center center;
              }
              & .mw {
                background: url("/static/test-6/img/buyu/mw.png") no-repeat
                  center center;
              }
              & .cq9 {
                background: url("/static/test-6/img/buyu/cq9.png") no-repeat
                  center center;
              }
              & .pt {
                background: url("/static/test-6/img/buyu/pt.png") no-repeat
                  center center;
              }
              & .bg {
                background: url("/static/test-6/img/buyu/bg.png") no-repeat
                  center center;
              }
              & .jdb {
                background: url("/static/test-6/img/buyu/jdb.png") no-repeat
                  center center;
              }

              & .hot_game {
                background: url("/static/public/image/casino/youyi/qb.png") no-repeat
                  center center;
              }
            }
          ...
          li:hover .hot_game {
            background: url("/static/public/image/casino/youyi/qb-hover.png")
              center top no-repeat;
          }
          li:hover .ag_game {
            background: url("/static/public/image/casino/youyi/ag-hover.png")
              center top no-repeat;
          }
          li:hover .ae_game {
            background: url("/static/public/image/casino/youyi/ae-hover.png")
              center top no-repeat;
          }
          li:hover .bbin_game {
            background: url("/static/public/image/casino/youyi/bbin-hover.png")
              center top no-repeat;
          }
          li:hover .cq9_game {
            background: url("/static/public/image/casino/youyi/cq9-hover.png")
              center top no-repeat;
          }
          li:hover .dt_game {
            background: url("/static/public/image/casino/youyi/dt-hover.png")
              center top no-repeat;
          }
          li:hover .fg_game {
            background: url("/static/public/image/casino/youyi/fg-hover.png")
              center top no-repeat;
          }
          li:hover .jdb_game {
            background: url("/static/public/image/casino/youyi/jdb-hover.png")
              center top no-repeat;
          }
          li:hover .mg_game {
            background: url("/static/public/image/casino/youyi/mg-hover.png")
              center top no-repeat;
          }
          li:hover .mw_game {
            background: url("/static/public/image/casino/youyi/mw-hover.png")
              center top no-repeat;
          }
          li:hover .pt_game {
            background: url("/static/public/image/casino/youyi/pt-hover.png")
              center top no-repeat;
          }
          li:hover .ttg_game {
            background: url("/static/public/image/casino/youyi/ttg-hover.png")
              center top no-repeat;
          }
          li:hover .more_game {
            background: url("/static/public/image/casino/youyi/more-hover.png")
              center top no-repeat;
          }
          li.active {
      ...
      .box {
        ...
        .list_line {
          ...
          li {
            ...
            .gicon1 {
              background: url("/static/public/image/casino/youyi/game_type.png")
                no-repeat center center;
              background-size: 22px 22px;
            }
            .gicon2 {
              background: url("/static/public/image/casino/youyi/money.png")
                no-repeat center center;
              background-size: 22px 22px;
            }
            .gicon {
