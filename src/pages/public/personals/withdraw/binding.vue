  ...
  <div class="binding">
    ...
    <div class="content clearfloat">
      ...
      <div class="deposit-left fl">
        ...
        <!-- <div class="row" v-if="this.$store.state.mainState.userinfo.secret=='unset'&& !['935qp','632qp','kyqp','839qp','k78qp'].includes(this.$websiteName)">
          <label class="text">
            密保问题：
          </label>
        ...
        <!-- <div class="bar" v-if="!['935qp','632qp','kyqp','839qp','k78qp'].includes(this.$websiteName)">
          <label>温馨提示：</label>
