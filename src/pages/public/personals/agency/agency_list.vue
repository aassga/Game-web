            ...
            return h("div", [
              h(
                "span",
                {
                  style: {
                    cursor: "pointer",
                    marginRight: params.row.is_agency == "0" ? (this.personal_commission_mode =='mode_b'? "0px":"12px") : "0px"
                  },
                  domProps: {
                    title: "修改赔率"
                  },
              ...
              h(
                "span",
                {
                  style: {
                    cursor: "pointer",
                    display:
                      params.row.is_agency == "0" && this.personal_commission_mode !='mode_b'? "inline-block" : "none"
                  },
                  domProps: {
