	...
	<div class="agency_repot">
		...
		<div class="repot" v-if="toggleTeam =='repot'">
			...
			<div class="search">
				...
				<Input class="mySearch" icon="android-search" @on-enter="searchSth" v-model="searchStr" placeholder="下级报表查询（代理账号）" style="width: 200px;margin-left:28px;" @on-click="getTeamMember"></Input>
			</div>
