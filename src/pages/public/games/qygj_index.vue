    ...
    <div class="mainContent">
      <div class="mainbox" ref="gameMenu">
        <ul class="game_type game_type1">
          <li
            :class="[{'active':$route.query.id===item.id},item.class,item.newclass+'_hover']"
            :key="index"
...
.mainbox {
  ...
  .game_type {
    ...
    li.hot_game {
      background: url("/static/public/image/youyi/hot-game2.png") center top
        no-repeat;
    }
    li.hot_game:hover {
      background: url("/static/public/image/youyi/hot-game-hover2.png") center
        top no-repeat;
