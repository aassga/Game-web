<template>
    <div id="maincontainer">
        <div class="banner">
            <img src="/static/public/image/game/new_games/banner.png" alt="" />
            <ul>
                <li>
                    <p>￥{{jackpotNum1.toString().substring(0,3)}},{{jackpotNum1.toString().substring(3,6)}},{{jackpotNum1.toString().substring(6,9)}}.{{jackpotNum1.toString().substring(9,11)}}</p>
                    <span>AG老虎机累计奖池</span>
                </li>
                <li>
                    <p>￥{{jackpotNum2.toString().substring(0,3)}},{{jackpotNum2.toString().substring(3,6)}},{{jackpotNum2.toString().substring(6,9)}}.{{jackpotNum2.toString().substring(9,11)}}</p>
                    <span>PT老虎机累计奖池</span>
                </li>
                <li>
                    <p>￥{{jackpotNum3.toString().substring(0,3)}},{{jackpotNum3.toString().substring(3,6)}},{{jackpotNum3.toString().substring(6,9)}}.{{jackpotNum3.toString().substring(9,11)}}</p>
                    <span>DT老虎机累计奖池</span>
                </li>
            </ul>
        </div>
        <div class="content">
            ...
            <div class="list_user">
                ...
                <swiper :options="swiperOption" ref="mySwiper">
                    <swiper-slide v-for="(item,index) in list_arr" :key="index">
                        <div class="slide_list" @click="loginGame(item)">
            ...
            <div class="content_box" v-show="nav_active == 9">
                <div class="list_gams" v-show="nav_active == 9">
                    <span class="slidePrev" @click="setSwiper(3)"><i></i></span>
                    ...
                    <span class="slideNext" @click="setSwiper(4)"><i></i></span>
                </div>
            </div>
            <!-- 推荐游戏 -->
            <div class="content_boxer" v-show="nav_active !=9&&swiperList.length>0">
            ...
            <div class="list_box">
                <div class="box">
                    ...
                    <div class="title_line" v-show="nav_active != 9"><img :src="'/static/public/image/game/new_games/'+this.showName+'_bg.png'" alt="" v-if="this.showName!=''"></div>
                    ...
                    <ul class="img_box">
                        <li v-for="(item, index) in showGameList" :key="index">
                            <div class="itemBox">
                                ...
                                <span v-if="item.line">{{item.line}}</span>
                            </div>
