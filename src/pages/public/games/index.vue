    ...
    <div class="mainContent">
      ...
      <div class="mainbox">
        ...
        <div class="box">
          <ul id="slider">
            <li
              :class="[{'active':$route.query.id===item.id||$route.query.id==rollList[index].id},item.class]"
              :key="index"
...
#slider li:hover .slider-jdb-icon,
#slider li.active .slider-jdb-icon {
  background: url("/static/public/image/game/ptgame/jdb2.png");
  background-size: 76px;
  background-position: -5px -18px;
  margin-bottom: -5px !important;
}
