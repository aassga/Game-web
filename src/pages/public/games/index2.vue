    ...
    <div class="mainContent">
      <div class="mainbox" ref="gameMenu">
        <ul class="game_type game_type1">
          <li
            :class="[{'active':$route.query.id===item.id},item.class,item.newclass+'_hover',bgColor]"
            :key="index"
        ...
        <ul class="game_type game_type2" @click="changeMenu" v-show="rollList.length>10">
          <li @mouseover="changeSrc1" @mouseout="changeSrc2" class="deGame" id="ali">
            <img v-if="showGtu" :src="bgColor == 'darkPurple' ? src : src1" alt />
            <img
              class="imgTrue"
              v-else
              :src="bgColor == 'darkPurple' ? src2 : src3"
              alt
            />
          </li>
        </ul>
      </div>
      <div ref="search-container" :class="bgColor" class="search-container">
          ...
          <div class="search-info">
            <div class="search-head">
              <div>
                ...
                <button class="btn-search active" @click="search()">
      ...
      <div class="game-box">
        <div class="game-content">
          <ul>
            <li class="game-item" :class="bgColor" :key="index" v-for="(item,index) in gameData">
              <div class="game-pic">
...
export default {
  ...
  data() {
    return {
      ...
      iptVal: "",
      showGtu: true,
      src: "/static/dqr/img/hot_icon/other-item-qygj.png",
      src1: "/static/fhcp/img/game/buyu/other-item-qygj21.png",
      src2: "/static/dqr/img/hot_icon/other-item-hover-qygj.png",
      src3: "/static/fhcp/img/game/buyu/other-item-hover-qygj25.png",
  ...
  methods: {
    ...
    changeMenu() {
      ...
      if (parseInt(gao) <= 135) {
        ...
        this.src = "/static/dqr/img/hot_icon/other-item-hover-qygj.png";
      } else {
        menu.style.height = "135px";
        this.showGtu = true;
        aLi.className = "deGame";
        this.src = "/static/dqr/img/hot_icon/other-item-qygj.png";
      }
    },
    changeSrc1() {
      this.src = "/static/dqr/img/hot_icon/other-item-hover-qygj.png";
...
.darkPurple{
  background: #2C3966;
  .btn-search{
    background: linear-gradient(#7385bd, #2c3966); /* 标准的语法 */
  }
}
.redColor{
  background: #ffffff;
  .btn-search{
    background: linear-gradient(rgba(253, 144, 128, 1),rgba(247, 27, 44, 1));
  }
}
.banner {
...
.mainbox {
  ...
  .game_type {
    ...
    li.redColor.hot_game{
      background: url("/static/fhcp/img/game/buyu/hot-game21.png") center top
        no-repeat;
    }
    li.redColor.hot_game.active{
      background: url("/static/fhcp/img/game/buyu/hot-game-hover25.png") center top
        no-repeat;
    }
    li.redColor.hot_game:hover{
      background: url("/static/fhcp/img/game/buyu/hot-game-hover25.png") center top
        no-repeat;
    }
    li.darkPurple.hot_game {
      background: url("/static/dqr/img/hot_icon/hot-game2.png") center top
        no-repeat;
    }
    li.darkPurple.hot_game:hover {
      background: url("/static/dqr/img/hot_icon/other-item-hover-qygj.png") center
        top no-repeat;
    ...
    li {
      ...
      div {
        ...
        .pg_game {
          background: url("/static/public/image/youyi/pg-qygj1.png") center top
            no-repeat;
        }
        .ttg_game {
        ...
        .pg_game.newactive {
          background: url("/static/public/image/youyi/pg-hover.png") center top
            no-repeat;
        }
        .ttg_game.newactive {
    ...
    li.hot_game:hover {
      background: url("/static/dqr/img/hot_icon/hot-game-hover2.png") center
        top no-repeat;
      background-size: 100% 100%;
      div {
        border-bottom: 1px solid transparent;
