_<template>
     <div id="maincontainer">
         <div class="content">
             <div class="list_nav" :class="`list_${themes.clientWidth}`" :style="themes.allbgStyle">
                  <ul>
             ...
             <div class="content_box" :class="`content_${themes.clientWidth}`"  ref="gameMenu" v-if="nav_active == 9">
                <div class="mainbox">
                     <ul class="game_type" :class="`theme_${themes.name}`" v-if="['935qp','632qp','kyqp','839qp','k78qp','99qp'].includes(this.$websiteName)">
                        <li :class="[item.id==0 ? `slot_${item.id}`:'' ,active == item.id ? 'active' : '']" :key="index" @click="setGameMaker(item)"
                            v-for="(item,index) in listDatas.platform" v-if="item.id!= 10024&&item.id !=11677">
                            <div style="display: flex;justify-content: center;">
                                <p class="game_icon"  :class="[{'newactive':active == item.id},item.id !=0 ? (gameType != 'fish'?`slot_${item.id}`:`slot_${idConfig.idImg[item.id].id}`): '']"></p>
                            </div>
                    ...
                    <ul class="game_type" :class="`theme_${themes.name}`" v-else>
                        <li :class="[item.id==0 ? `slot_${item.id}`:'' ,active == item.id ? 'active' : '']" :key="index" @click="setGameMaker(item)"
                            v-for="(item,index) in listDatas.platform">
                            <div style="display: flex;justify-content: center;">
                                <p class="game_icon"  :class="[{'newactive':active == item.id},item.id !=0 ? (gameType != 'fish'?`slot_${item.id}`: item.id == 12042 ? `slot_${item.id}` : `slot_${idConfig.idImg[item.id].id}`): '']"></p>
                            </div>
                            <span v-if="item.id!=0">{{item.name}}</span>
                        </li>
                    </ul>
             ...
             <!-- 推荐游戏 -->
            <div class="content_boxer"  :class="`content_boxer_${themes.clientWidth}`" v-if="nav_active !=9&&swiperList.length>0" :style="themes.allbgStyle">
                 <div class="title_line" v-if="nav_active != 9"><img :src="'/static/'+themes.name+'/img/new_games/tjyx.png'" alt=""></div>
                  <div class="list_gamser" v-if="nav_active != 9">
                    <span class="slidePrev" @click="setSwiper(6)" @mouseover="changeSrc1" @mouseout="changeSrc2"><i :style="{background:'url('+leftImageSrc+') center center / 17px no-repeat'}"></i></span>
                    <swiper :options="swiperOption2" ref="mySwiper2">
                        <swiper-slide v-for="(item,index) in swiperList" :key="index+1" v-if="swiperList.length > 1">
                            <div class="gams_lister">
                                <div class="img_boxer" :style="themes.liStyle">
                                    <img :src="item.icon" alt="">
                                    <span :style="themes.platColor" v-if="idConfig[item.upid]" class="code">{{idConfig[item.upid].name}}</span>
									                  <span v-if="item.line" :style="themes.lineColor" class="code2">{{item.line}}</span>
                                    <i v-show="item.Hot == 1"></i>
                                    <p :style="{color:themes.otherColor.leftColor}">{{item.name}}</p>
                                    <div class="list_btn" v-if="isSwiper">
                                        <span class="collect" v-show="item.love == 'no'" @click="joinCollect(item,index,'recode')" :style="{background:'url(/static/'+themes.name+'/img/new_games/qxshoucang.png) center center no-repeat'}"></span>
                                        <span class="collectY" v-show="item.love == 'yes'" @click="cancelCollect(item,index,'recode')" :style="{background:'url(/static/'+themes.name+'/img/new_games/shoucang.png) center center no-repeat'}"></span>
                                        <span v-if="themes.name == 'mgm'" class="begin" :style="themes.btnColor" @click="$loginGame(item,themes.name)">开始游戏</span>
                                        <span v-else class="begin" :style="themes.btnColor" @click="$loginGame(item,themes.name)">开始游戏</span>
                                    </div>
                                </div>
                            </div>
                        </swiper-slide>
                    </swiper>
                    <span class="slideNext" @click="setSwiper(5)" @mouseover="changeSrc3" @mouseout="changeSrc4"><i :style="{background:'url('+rightImageSrc+') center center / 17px no-repeat'}"></i></span>
                </div>
            </div>
             <!-- 展示列表 -->
            <div class="list_box" :style="themes.allbgStyle" :class="`list_box_${themes.clientWidth}`" ref="getHeight" >
                <div class="box">
                    ...
                    <ul class="img_box">
                        <li v-for="(item, index) in showGameList" :key="index" :style="themes.liStyle">
                            <div class="itemBox">
                                 <div v-lazy-container="{ selector: 'img' }" v-if="isLazy">
                                     <img :data-src="item.icon"
                                          :data-error="idConfig[item.upid].errorImg"
                                          :data-loading="'/static/'+themes.name+'/img/new_games/load.gif'"
                                          :key="item.id"/>
                                 </div>
                                 <div v-if="!isLazy"><img v-lazy="item.icon" alt=""></div>
                                <span :style="themes.platColor" v-if="idConfig[item.upid]">{{idConfig[item.upid].name}}</span>
                                <span v-if="item.line" :style="themes.lineColor">{{item.line}}</span>
                            </div>
                            <i v-show="item.Hot == 1"></i>
                            <div class="textBox">
                            ...
                            <div class="list_btn">
                                <span class="collect" v-show="item.love == 'no'" @click="joinCollect(item,index,'tab',themes.name)" :style="{background:'url(/static/'+themes.name+'/img/new_games/qxshoucang.png) center center no-repeat'}"></span>
                                <span class="collectY" v-show="item.love == 'yes'" @click="cancelCollect(item,index,'tab')" :style="{background:'url(/static/'+themes.name+'/img/new_games/shoucang.png) center center no-repeat'}"></span>
                                <span v-if="themes.name == 'mgm'" class="begin" :style="themes.btnColor" @click="$loginGame(item,themes.name)">开始游戏</span>
                                <span v-else class="begin" :style="themes.btnColor" @click="$loginGame(item,themes.name)">开始游戏</span>
                            </div>
                        </li>
      ...
      .mainbox {
        ...
        .theme_betsb {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/betsb/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:not(:first-child):hover {
            ...
            -webkit-transform: scale(1.1);
            -ms-transform: scale(1.1);
            background: linear-gradient(135deg,#e9d89c,#cb9b35); /* Safari 5.1 - 6.0 */
            color: #fff;
            div {
              border-bottom: 1px solid #fff;
            }
          ...
          li:nth-child(1).active {
            background: url("/static/betsb/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_tycjt {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/tycjt/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/tycjt/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_tyc82 {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/tyc82/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/tyc82/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_test-4 {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/test-4/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/test-4/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_pjdc {
          li {
            ...
            color: #bc7783;
            &.slot_0 {
              background: url("/static/pjdc/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:not(:first-child):hover {
            ...
            -webkit-transform: scale(1.1);
            -ms-transform: scale(1.1);
            background: -webkit-linear-gradient(#f3cb52,#fcdf84); /* Safari 5.1 - 6.0 */
            background: -o-linear-linear-gradient(#f3cb52,#fcdf84); /* Opera 11.1 - 12.0 */
          ...
          li:nth-child(1).active {
            background: url("/static/pjdc/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_mgm {
          ...
          li:not(:first-child):hover {
            ...
            -webkit-transform: scale(1.1);
            -ms-transform: scale(1.1);
            background: -webkit-linear-gradient(  #ffb459,#ff5f00); /* Safari 5.1 - 6.0 */
            background: -o-linear-linear-gradient(  #ffb459,#ff5f00); /* Opera 11.1 - 12.0 */
        ...
        .theme_cmgm {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/cmgm/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:not(:first-child):hover {
            ...
            -webkit-transform: scale(1.1);
            -ms-transform: scale(1.1);
            background: -webkit-linear-gradient(  #ad1c16,#37251c); /* Safari 5.1 - 6.0 */
            background: -o-linear-linear-gradient(  #ad1c16,#37251c); /* Opera 11.1 - 12.0 */
          ...
          li:nth-child(1).active {
            background: url("/static/cmgm/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_amxpj{
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/amxpj/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/amxpj/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_test-1 {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/test-1/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/test-1/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
         ...
         .theme_vnso {
          ...
          li:nth-child(1).active {
            background: url("/static/vnso/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_99qp {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/99qp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/99qp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_478qp {
          ...
          li:nth-child(1).active {
            background: url("/static/478qp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_jsyl {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/jsyl/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/jsyl/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_jltx{
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/jltx/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/jltx/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
         ...
         .theme_jltx-new2{
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/jltx-new2/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/jltx-new2/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_vnst {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/vnst/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:not(:first-child):hover {
            ...
            background: -webkit-linear-gradient(135deg,#faf762,#c19b38); /* Safari 5.1 - 6.0 */
            background: -o-linear-gradient(135deg,#faf762,#c19b38); /* Opera 11.1 - 12.0 */
            background: -moz-linear-gradient(135deg,#faf762,#c19b38);/* Firefox 3.6 - 15 */
            background: linear-gradient(135deg,#faf762,#c19b38);/* 标准的语法 */
            color: #fff;
            div {
              border-bottom: 1px solid #fff;
          ...
          li:nth-child(1).active {
            background: url("/static/vnst/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_tccp {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/tccp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:not(:first-child):hover {
            ...
            -webkit-transform: scale(1.1);
            -ms-transform: scale(1.1);
            background: -webkit-linear-gradient(0deg, #C000BB, #E65BE3); /* Safari 5.1 - 6.0 */
            background: -o-linear-gradient(0deg, #C000BB, #E65BE3); /* Opera 11.1 - 12.0 */
            background: -moz-linear-gradient(0deg, #C000BB, #E65BE3);/* Firefox 3.6 - 15 */
            background: linear-gradient(0deg, #C000BB, #E65BE3);/* 标准的语法 */
            color: #fff;
            div {
              border-bottom: 1px solid #fff;
            }
          ...
          li:nth-child(1).active {
            background: url("/static/tccp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_dqr {
          ...
          li:nth-child(1).active {
            background: url("/static/dqr/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_737qp {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/737qp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/737qp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_qxcp {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/qxcp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
              background: url("/static/qxcp/img/new_games/new_icon_a/h0.png")
                center top no-repeat;
              border-bottom: 1px solid transparent;
            }
            div {
              ...
              .backgroundcard(@className,@pngName) {
                .slot_@{className} {
                  background: url("/static/qxcp/img/new_games/new_icon/@{className}.png")
                    center top no-repeat;
                }
              }
              .loop(@i) when (@i < length(@bgcardList)+1) {
              ...
              .background2(@className,@pngName) {
                .slot_@{className}.newactive {
                  background: url("/static/qxcp/img/new_games/new_icon_a/@{className}.png")
                    center top no-repeat;
                }
              }
              .loop2(@i) when (@i < length(@bgcardList2)+1) {
          ...
          li:nth-child(1).active {
            background: url("/static/qxcp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_103qp {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/103qp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/103qp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_hty {
          ...
          li:nth-child(1).active {
            background: url("/static/hty/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_fhcp {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/fhcp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/fhcp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_xpj83 {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/xpj83/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/xpj83/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_amvnsr {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/amvnsr/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/amvnsr/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_aqvns {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/aqvns/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/aqvns/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_js85 {
          li {
            ...
            div {
              border-bottom: 1px solid #4c4b4e;
              @bgcardList: 999, 10014, 10015, 10016, 10018, 10019, 10020, 10021,
                10022, 10023, 10024, 11320, 10041, 10042, 10612, 10694, 10732,10058,11759,11775,11828,11857,11881,11906,12042;
              .backgroundcard(@className,@pngName) {
                .slot_@{className} {
                  background: url("/static/aqvns/img/new_games/new_icon/@{className}.png")
                    center top no-repeat;
        ...
        .theme_amhg {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/amhg/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/amhg/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_qygj {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/qygj/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/qygj/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_hsyl {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/hsyl/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/hsyl/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_cjw {
          ...
          li:nth-child(1).active {
            background: url("/static/cjw/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_500wcp {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/500wcp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/500wcp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_fczx {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/fczx/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/fczx/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_500w {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/500w/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
              background: url("/static/500wcp/img/new_games/new_icon_a/h0.png")
          ...
          li:nth-child(1).active {
            background: url("/static/500w/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_cpzj {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/cpzj/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/cpzj/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_tczj {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/tczj/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/tczj/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_wycp {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/wycp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/wycp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_szc {
          ...
          li:nth-child(1).active {
            background: url("/static/szc/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_jhcp {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/jhcp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/jhcp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_dalao {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/dalao/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/dalao/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_qmcp {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/qmcp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/qmcp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_ecp {
          ...
          li:nth-child(1).active {
            background: url("/static/ecp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_sjcp {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/sjcp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/sjcp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_t111 {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/t111/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/t111/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_amvns {
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/amvns/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/amvns/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_632qp{
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/632qp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/632qp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_935qp{
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/935qp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/935qp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_k78qp{
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/k78qp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/k78qp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_839qp {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/839qp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/839qp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_kyqp{
          li {
            ...
            color: #000;
            &.slot_0 {
              background: url("/static/kyqp/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/kyqp/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
      ...
      .mainbox {
        ...
        .theme_mgm {
          li {
            ...
            div {
              // border-bottom: 1px solid #efefef;
              @bgcardList: 999, 10014, 10015, 10016, 10018, 10019, 10020, 10021,
                10022, 10023, 10024, 11320, 10041, 10056, 10042, 10612, 10694, 10732,10058,11759,11775,11828,11857,11881,11906,12042,12465;
              .backgroundcard(@className,@pngName) {
                .slot_@{className} {
                  background: url("/static/klk/img/new_games/new_icon/@{className}.png")
                    center top no-repeat;
          ...
          @bgcardList3: 999, 10014, 10015, 10016, 10018, 10019, 10020, 10021,
            10022, 10023, 10024, 11320, 10041, 10042,10056, 10612, 10694, 10732,10058,11759,11775,11828,11857,11881,11906,12042,12465;
          .background3(@className,@pngName) {
            li:hover .slot_@{className} {
              background: url("/static/klk/img/new_games/new_icon_a/@{className}.png")
                center top no-repeat;
        ...
        .theme_betsb {
          ...
          li:not(:first-child):hover {
            ...
            -webkit-transform: scale(1.1);
            -ms-transform: scale(1.1);
            background: -webkit-linear-gradient(#25c199,#008260); /* Safari 5.1 - 6.0 */
            background: -o-linear-gradient(#25c199,#008260); /* Opera 11.1 - 12.0 */
          ...
          li:nth-child(1).active {
            background: url("/static/betsb/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_bet365 {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/bet365/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:nth-child(1).active {
            background: url("/static/bet365/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        // }
         ...
         .theme_hqyl {
          li {
            ...
            color: #fff;
            &.slot_0 {
              background: url("/static/hqyl/img/new_games/new_icon/0.png") center
                top no-repeat;
            }
            &.slot_0:hover {
          ...
          li:not(:first-child):hover {
            ...
            -webkit-transform: scale(1.1);
            -ms-transform: scale(1.1);
            background: -webkit-linear-gradient(180deg,#DFB65F,#8E7938); /* Safari 5.1 - 6.0 */
            background: -o-linear-gradient(180deg,#DFB65F,#8E7938); /* Opera 11.1 - 12.0 */
            background: -moz-linear-gradient(180deg,#DFB65F,#8E7938);
            /* Firefox 3.6 - 15 */
            background: linear-gradient(180deg,#DFB65F,#8E7938); /* 标准的语法 */
            color: #fff;
            div {
              border-bottom: 1px solid #fff;
            }
          ...
          li:nth-child(1).active {
            background: url("/static/hqyl/img/new_games/new_icon_a/0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
        ...
        .theme_xpj {
          ...
          li:not(:first-child):hover {
            ...
            -ms-transform: scale(1.1);
            background: -webkit-linear-gradient( #ffb459,#ff5f00); /* Safari 5.1 - 6.0 */
            background: -o-linear-gradient( #ffb459,#ff5f00); /* Opera 11.1 - 12.0 */
            background: -moz-linear-gradient( #ffb459,#ff5f00);/* Firefox 3.6 - 15 */
            background: linear-gradient( #ffb459,#ff5f00);/* 标准的语法 */
            color: #fff;
            div {
              border-bottom: 1px solid #fff;
          ...
          li:nth-child(1).active {
            background: url("/static/xpj/img/new_games/new_icon_a/h0.png") center
              top no-repeat;
            border-bottom: 1px solid transparent;
            transform: scale(1.1);
            -webkit-transform: scale(1.1);
