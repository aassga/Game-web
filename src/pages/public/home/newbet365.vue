<template>
     <div>
        <div class="newBox" v-show="showPopout">
             <div class="text">
                  <div class="header">
                      <div class="title">bet365亚洲最新网址</div>
                      <div class="button" @click="showPopout=false">
                           关闭
                      </div>
                  </div>
                  <div class="content">
                      <div class="desprite">
                           <span v-html="popups" v-if="isTest" style="color:#F6FAF8;white-space: normal !important;"></span>
...
<style lang="less" scoped>
       .newBox{
          ...
          .text{
              ...
              min-height:540px;
              border-radius:12px; 
              background-color: rgba(0,153,113,0.6);
              .header{
                   height: 50px;
                   width: 100%;
                   overflow: hidden;
