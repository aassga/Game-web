...
export default {
  ...
  data() {
    return {
      ...
      //   headerImg: "/static/478qp/img/carouel/qp.jpg",
      scrollDatas: [],
      isloading: false,
    ...
    .game-list {
      .js-list-items {
        ...
        dd {
          ...
          .game_ky {
            background: url("/static/public/image/game/ptgame/ky-qygj.png");
          }
          .game_ly {
            background: url("/static/public/image/game/ptgame/ly-qygj.png");
          }
          .game_dz {
            background: url("/static/public/image/game/ptgame/dz-qygj.png");
          }
          .game_vg {
            background: url("/static/public/image/game/ptgame/vg-qygj.png");
          }
          .game_th {
          ...
          &:hover {
            ...
            color: #fff;
            div {
              border-bottom: 1px solid #4fade6;
            }
          }
          &:hover .game_ky {
          ...
          &:hover .game_fg {
            background: url("/static/public/image/game/ptgame/fg-qy-hover.png");
          }
        }
