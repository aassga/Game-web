...
const mixin = {
    ...
    methods: {
        ...
        async getItemId(item) {
            if (this.$websiteName && (['qygj', 'xpj80', 't111', 'ybcp', 'amvns', 'bet365', 'vnst', 'cfgj', 'betsb', '478qp', 'tycjt', 'tyc82','amvnsr','vns81', 'jsyl-preview','jsyl','wpgj','cjw','tyc','aqvns','test-6','amxpjdc'].includes(this.$websiteName))) {
        ...
        loginGame(item) {
            if (
                this.$websiteName && (['qygj', 'xpj80', 't111', 'ybcp', 'amvns', 'bet365', 'vnst', 'cfgj', 'betsb', '478qp', 'tycjt', 'tyc82', 'amvnsr', 'vns81', 'jsyl-preview','jsyl','wpgj','cjw','tyc','aqvns','test-6','amxpjdc'].includes(this.$websiteName))
            ) {
                if (!localStorage.token || !localStorage.userinfo) {
                    this.$store.commit('alert/newshowtip', {
                        bool: true,
