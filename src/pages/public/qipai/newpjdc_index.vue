      ...
      <div class="game-list">
        ...
        <div class="game-box">
          <div class="game-content">
            <ul>
              <li :class="['game-item',sportAnimated]" :key="index" v-for="(item,index) in gameData">
                <div class="game-pic">
                  <img
                    v-lazy="item.icon"
    ...
    .game-list {
      .js-list-items {
        ...
        border-radius: 4px;
          ...
          transition: all 0.2s;
           background: url('/static/public/image/casino/images/btn_bg.png') no-repeat center center;
            background-size: 100% 100%;

          &.firstdd1 {
            background: url("/static/public/image/casino/images/hot_bg.png") no-repeat center center;
            background-size: 100% 100%;
            &:hover {
                background: url('/static/public/image/casino/images/hot_bg1.png') no-repeat center center;
                background-size: 100% 100%;
            }
          ...
          &:not(:first-child):hover {
            font-size: 16px;
            background: linear-gradient( rgba(252,223,132,1),rgba(243,203,82,1));
            color: #fff;
          }
          &:hover .game_ky {
        ...
        .active {
          ...
          font-size: 16px;
          color: #fff;
          background: linear-gradient(180deg, rgba(243,203,82,1), rgba(252,223,132,1));
          .game_ky {
