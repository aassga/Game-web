    ...
    .game-list {
      .js-list-items {
        ...
        background-size: 100% 100%;
          ...
          &.firstdd1 {
            background: url("/static/public/image/casino/blue_image/hot_bg.png") no-repeat center center;
            background-size: 100% 100%;
            &:hover {
                background: url('/static/public/image/casino/blue_image/hot_bg1.png') no-repeat center center;
                background-size: 100% 100%;
            }
          ...
          &:not(:first-child):hover {
            font-size: 16px;
            background: linear-gradient( rgba(81,177,231,1),rgba(98,219,242,1));
            color: #fff;
          }
          &:hover .game_ky {
        ...
        .search-info {
          ...
          .search-head {
            ...
            .btn-search {
              ...
              color: #fff;
              vertical-align: middle;
              background: linear-gradient(to bottom right, rgba(81,177,231,1),rgba(98,219,242,1));
              cursor: pointer;
              margin-left: 20px;
