        ...
        <div class="chessGame-content">
            <div class="game-list">
                ...
                <dl class="js-list-items list-item ">
                    <dd v-for="(item,index) in qipaidata" :key="index" @click="changgeme(item,index)"
                    ...
                    <div class="game-content">
                        <ul>
                            <li class="game-item" :key="index" v-for="(item,index) in gameData">
                                ...
                                <h3>{{item.name}}</h3>
                                <!-- 预览版  loginGame(item) -->
                                <a href="javascript:void(0)" class="play" @click="noShow">进入游戏</a>
                            </li>
                        </ul>
        ...
        .game-list {
            .js-list-items {
                ...
                dd {
                    ...
                    &.firstdd1 {
                        background: url('/static/public/image/casino/hot.jpg') no-repeat center center;
                        &:hover {
                            background: url('/static/public/image/casino/hot-hover.jpg') no-repeat center center;
                        }
                    ...
                    .game_ky {
                        background: url('/static/public/image/casino/ky-vnst.png') no-repeat center center;
                    }
                    .game_ly {
                        background: url('/static/public/image/casino/ly-vnst.png') no-repeat center center;
                    }
                    .game_dz {
                        background: url('/static/public/image/game/ptgame/dz-qygj.png') no-repeat center center;
                    }
                    .game_vg {
                        background: url('/static/public/image/casino/vg-vnst.png') no-repeat center center;
                    }
                    .game_fg {
                        background: url('/static/public/image/game/ptgame/fg-qygj.png') no-repeat center center;
                    }
                    .game_th {
                        background: url('/static/public/image/game/ptgame/th-qygj.png') no-repeat center center;
                    }
                    ...
                    &:hover .game_ky {
                        background: url('/static/public/image/casino/ky-hover.png') no-repeat center center;
                    }
                    &:hover .game_ly {
                        background: url('/static/public/image/casino/ly-hover.png') no-repeat center center;
                    }
                    &:hover .game_dz {
                        background: url('/static/public/image/game/ptgame/dz-qy-hover.png') no-repeat center center;
                    }
                    &:hover .game_vg {
                        background: url('/static/public/image/casino/vg-hover.png') no-repeat center center;
                    }
                    &:hover .game_fg {
                        background: url('/static/public/image/game/ptgame/FG_icon.png') no-repeat center center;
                    }
                    &:hover .game_th {
                        background: url('/static/public/image/game/ptgame/th-qy-hover.png') no-repeat center center;
                    }
                }
                        ...
                        .search-type {
                            .search-game {
                                ...
                                dt {
                                    ...
                                    .gicon1 {
                                        background: url('/static/vnst/img/image/youyi/game_type.png') no-repeat center center;
                                    }
                                    .gicon2 {
                                        background: url('/static/vnst/img/image/youyi/money.png') no-repeat center center;
                                    }
                                    .gicon3 {
                                        background: url('/static/vnst/img/image/youyi/fengge.png') no-repeat center center;
                                    }
