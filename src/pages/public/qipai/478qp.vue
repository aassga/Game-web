<template>
  <div class="chessContainer" :class="{night:colorbool}">
    ...
    .game-list {
      .js-list-items {
        ...
        dd {
          ...
          &.firstdd1 {
            background: url("/static/478qp/img/chess/hot-vnst.jpg") no-repeat
              center center;
            &:hover {
              background: url("/static/478qp/img/chess/hot-hover.jpg") no-repeat
                center center;
            }
          ...
          .game_ky {
            background: url("/static/478qp/img/chess/ky-vnst.png") no-repeat
              center center;
          }
          .game_ly {
            background: url("/static/478qp/img/chess/ly-vnst.png") no-repeat
              center center;
          }
          .game_dz {
          ...
          .game_vg {
            background: url("/static/478qp/img/chess/vg-vnst.png") no-repeat
              center center;
          }
          .game_fg {
          ...
          &:hover .game_ky {
            background: url("/static/478qp/img/chess/ky-hover.png") no-repeat
              center center;
          }
          &:hover .game_ly {
            background: url("/static/478qp/img/chess/ly-hover.png") no-repeat
              center center;
          }
          &:hover .game_dz {
          ...
          &:hover .game_vg {
            background: url("/static/478qp/img/chess/vg-hover.png") no-repeat
              center center;
          }
          &:hover .game_fg {
            ...
            .goGamebtn {
              ...
              a {
                &.playBtn {
                  ...
                  background: url("/static/public/image/game/ptgame/btn1.png")
                    no-repeat;
                  font-size: 16px;
                  cursor: pointer;
                  text-align: center;
