            ...
            <div class="tiyu" :style="{paddingTop:theme.name=='amjs_sport'?'15px':''}">
                ...
                <dl class="list-items" :class="theme.name">
                    <dd v-for="(item,index) in sport_nav_data" :key="index" @click="changgeme(item.id)"
                        ...
                        <br>
                        {{item.name=='188体育'&& $websiteName=='betnew'?'365体育':item.name}}
                    </dd>
                </dl>
...
export default {
  ...
  methods: {
    getSports() {
      if (this.$getObjByLocalStorage(`gameSortV4_sport`)) {
        this.inintSports();
      } else {
        this.getData(true);
      }
    ...
    inintSports() {
      let allGame = this.$getObjByLocalStorage(`gameSortV4_sport`).games;
...
.wrapper {
  ...
  .tiyu_cont_1000 {
    ...
    .tiyu {
      ...
      .betsb_sport {
        ...
        .firstdd1 {
          background: url("/static/betsb/img/sports_bg_1.png") no-repeat center
            center;
            background-size: cover;
          &:hover {
            background: url("/static/betsb/img/sports_active_1.png") no-repeat center
              center;
              background-size: cover;
          }
        }
      ...
      .betnew_sport {
        dd {
          ...
          .sport_11756{
              background: url("/static/public/image/sports/newsport/betnew.png")
                no-repeat center center;
           }
           &:hover .sport_11756{
               background: url("/static/public/image/sports/newsport/hbetnew.png")
                no-repeat center center;
           }
        }
        .firstdd1 {
          background: url("/static/betnew/img/new_games/0.png") no-repeat center
            center;
            background-size: cover;
          &:hover {
            background: url("/static/betnew/img/new_games/h0.png") no-repeat center
              center;
              background-size: cover;
          }
        }
       ...
       .newbet_sport {
        ...
        .firstdd1 {
          background: url("/static/newbet/img/new_games/0.png") no-repeat center
            center;
            background-size: cover;
          &:hover {
            background: url("/static/newbet/img/new_games/h0.png") no-repeat center
              center;
              background-size: cover;
          }
        }
  ...
  .tiyu_cont_1200 {
    .tiyu {
      ...
      //   }
      //   .firstdd1 {
      //     background: url("/static/jltx/img/hover.png") no-repeat center
      //       center;
      //       background-size: cover;
      //     &:hover {
      //       background: url("/static/jltx/img/hover_active.png") no-repeat center
      //         center;
      //         background-size: cover;
      //     }
      //   }
      ...
      .mgm-preview {
        ...
        .firstdd1 {
          background: url("/static/mgm-preview/img/new_games/0.png") no-repeat center
            center;
            background-size: cover;
          &:hover {
            background: url("/static/mgm-preview/img/new_games/h0.png") no-repeat center
              center;
              background-size: cover;
          }
        }
      ...
      .vns81_sport {
        ...
        .firstdd1 {
          background: url("/static/vns81/img/new_games/0.png") no-repeat center
            center;
            background-size: cover;
          &:hover {
            background: url("/static/vns81/img/new_games/h0.png") no-repeat center
              center;
              background-size: cover;
          }
        }
        ...
        .firstdd1 {
          background: url("/static/cpxpj/img/new_games/0.png") no-repeat center
            center;
            background-size: cover;
          &:hover {
            background: url("/static/cpxpj/img/new_games/h0.png") no-repeat center
              center;
              background-size: cover;
          }
        }
       ...
       .aqvns_sport {
        ...
        .firstdd1 {
          background: url("/static/aqvns/img/new_games/0.png") no-repeat center
            center;
            background-size: cover;
          &:hover {
            background: url("/static/aqvns/img/new_games/h0.png") no-repeat center
              center;
              background-size: cover;
          }
        }
      ...
      .a478qp_sport {
        ...
        .firstdd1 {
          background: url("/static/ylhg/img/new_games/0.png") no-repeat center
            center;
            background-size: cover;
          &:hover {
            background: url("/static/ylhg/img/new_games/h0.png") no-repeat center
              center;
              background-size: cover;
          }
        }
