...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goDownload(){
         window.open("/static/kyqp/html/download/index.html")
      },
      goResiter () {
...
<style lang="less" scoped>
  .qy-service {
    ...
    li:hover {
      background: url("/static/kyqp/img/thirdparty/service-bg.png");
      border: unset;
    }

    .service {
      div{
        background: url("/static/kyqp/img/thirdparty/kefu.png");
      }
    }
    .by-service{
      div{
        background:url(/static/kyqp/img/thirdparty/by-kefu.png)
      }
    }

    .cs-mail {
      div{
        background: url("/static/kyqp/img/thirdparty/tousu.png");
      }
      .shrink {
        right: 70px;
        background: #fff;
    ...
    .Agency{
      div{
         background:url(/static/kyqp/img/thirdparty/daili.png)
      }
    }
    .jiebei {
      div{
        background: url("/static/kyqp/img/thirdparty/jiebei.png");
      }
    }

    .gold_housekeeper {
      div{
        background: url("/static/kyqp/img/thirdparty/jinguanjia.png");
      }
    }

    .download{
      div{
        background: url("/static/kyqp/img/thirdparty/download.png")
      }
    }

    .cs-goTop {
      div{
        background: url("/static/kyqp/img/thirdparty/zhiding.png")
      }
    }
  }
  .new2019{
    ...
    width: 230px;
    height: 230px;
    background-image: url('/static/kyqp/img/new2019.gif');

    .clBtn{
      background: url('/static/kyqp/img/new2019_close.png');
      z-index: 99999;
      position: absolute;
      width: 23px;
      height: 23px;
