  ...
  <div class="winlist clearfix slideLeft">
    ...
    <div class="right-area">
      <div class="game-winlist-1 game-winlist">
        <img src="/static/kyqp/img/home/ag-s.png" alt />
      ...
      <div class="game-winlist-2 game-winlist">
        <img src="/static/kyqp/img/home/mg-s.png" alt />
        <span class="win-name">超级奖池</span>
        <div
          class="win-money"
...
.winlist {
  ...
  height: 175px;
  margin: 20px auto 0;
  background: url("/static/kyqp/img/home/winlist-bg.png") no-repeat;
  ...
  .top-title {
    position: absolute;
    top: 0;
    background: url("/static/kyqp/img/home/winlist-top.png") no-repeat;
    width: 176px;
    height: 41px;
    line-height: 41px;
    text-align: center;
