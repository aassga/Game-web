            ...
            <div class="foot_links">
                <ul class="wp flex">
                    ...
                    <li class="support-browser-cont">
                        ...
                        <div>
                            <img src="/static/kyqp/img/home/image_2019_02_14T08_53_01_247Z.png" alt="" width="100">
                        </div>
                    </li>
                    <li class="regulatory-authority">
                        <h3 class="footer-link-title">监管机构</h3>
                        <div>
                            <img src="/static/kyqp/img/home/image_2019_02_14T08_52_29_378Z.png" alt="" width="60">
                        </div>
                    </li>
                    <li class="platform-cont">
                        <h3 class="footer-link-title">合作伙伴</h3>
                        <div>
                            <img src="/static/kyqp/img/footer_bg.png" alt="" width="100%">
                        </div>
                    </li>
                </ul>
            </div>
  ...
  export default {
    data () {
      return {
        ...
        footerBg:"/static/kyqp/img/home/image_2019_02_14T08_56_54_932Z.png",
        footbgcolor:'',
        newmodal:{
          title:"来自开元棋牌的消息",
          bgcolor:{
    ...
    watch:{
       colorbool(newbool,oldbool){
          if(newbool==true){
            this.footerBg ='/static/kyqp/img/index-main-bg-n.jpg'
          }else{
            this.footerBg = "/static/kyqp/img/home/image_2019_02_14T08_56_54_932Z.png"
          }
       },
       $route(to,from){
          this.initColor()
...
<style lang="less" scoped>
  .clear{
      ...
      .night{
           background:url(/static/kyqp/img/index-main-bg-n.jpg) no-repeat center top;
      }
  }
