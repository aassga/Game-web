...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/kyqp/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/kyqp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/kyqp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/kyqp/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/kyqp/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/kyqp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/kyqp/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/kyqp/home/register')), 'register')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/kyqp/home/help/About')), 'about')
const agent = r => require.ensure([], () => r(require('@/pages/kyqp/home/help/Agent')), 'agent')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/kyqp/home/tiyu')), 'tiyu')
// const vp_caipiao = r => require.ensure([], () => r(require('@/pages/kyqp/home/caipiao/index')), 'caipiao')
