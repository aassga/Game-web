...
export default {
    ...
    data() {
        return {
            ...
            defaultPwd:"",
            defaultPwd2:"",
            formBg:"../../../static/vnso/img/form_bg.png",
            showEye1:false,
            showEye2:false,
            showEye3:false,
            showForm:1,
            ...
            codeImg: '/static/vnso/img/new_games/re.png',
            // smsInputBox: {
            //     marginTop: '15px'
            // },
            codeImg: '/static/vnso/img/new_games/log.png',
            tabIndex:1,
...
.register {
    ...
    overflow: hidden;
    padding: 0!important;
    background: url(/static/vnso/img/register_bg.jpg) no-repeat;
    background-size: cover;
    .clearfloat1{
        position: relative;
        top: 135px!important;
        ...
        .login{
            ...
            .text-context{
                ...
                .iconfont1 {
                  width: 20px;
                  height: 22px;
                  background: url("/static/vnso/img/acc.png");
                ...
                .iconfont2 {
                  width: 20px;
                  height: 24px;
                  background: url("/static/vnso/img/pwd.png");
                  background-repeat: no-repeat;
                  background-size: 100% 100%;
                  position: absolute;
                  left: 15px;
                ...
                .iconfont3 {
                  width: 22px;
                  height: 24px;
                  background: url('/static/vnso/img/yanzhengma.png') no-repeat;
                  background-size: 100% 100%;
                  position: absolute;
                  left: 14px;
                  top: 5px;
    ...
    .service{
        ...
        span{
            ...
            &:first-child{
                width: 114px;
                height: 114px;
                background: url('../../../static/vnso/img/ser.png');
                background-repeat: no-repeat;
                background-size: cover;
            }
        }
    ...
    .content {
        ...
        background: url('/static/vnso/img/form_bg.png');
        background-repeat: no-repeat;
        background-size:100% 100% ;
        margin-top: 41px;
        .titleTab{
            ...
            span{
                ...
                text-align: center;
                color: transparent;
                background:linear-gradient(60deg,rgba(85,203,255,1) 0%, rgba(75,155,241,1) 100%);;
            ...
            .list-box {
                .text-context {
                    ...
                    .openEyes{
                      ...
                      height: 13px;
                      display: inline-block;
                      background: url('/static/vnso/img/eye1.png') no-repeat;
                      background-size: 100% 100%;
                      position: absolute;
                      top: 9px;
                      right: 15px;
                    ...
                    .closeEyes{
                      ...
                      height: 13px;
                      display: inline-block;
                      background: url('/static/vnso/img/eye2.png') no-repeat;
                      background-size: 100% 100%;
                      position: absolute;
                      top: 9px;
                      right: 15px;
                ...
                .submit {
                    width:404px;
                    height:60px;
                    background:url('/static/vnso/img/btn_bg.png')no-repeat;
                    background-size: 100% 100%;
                    border-radius:30px;
                    line-height: 60px;
                    border: none;
