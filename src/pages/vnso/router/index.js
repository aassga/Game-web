...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/vnso/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/vnso/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/vnso/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/vnso/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/vnso/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/vnso/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/vnso/home/youhui/index')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/vnso/register.vue')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/vnso/home/register1.vue')), 'register1')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/vnso/home/help/About/index')), 'about')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/vnso/home/tiyu/index')), 'tiyu')
// const vp_caipiao = r => require.ensure([], () => r(require('@/pages/vnso/home/caipiao/index')), 'caipiao')
