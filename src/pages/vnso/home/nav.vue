            ...
            <div class="nav_box">
                <ul class="nav-bar fl">
                    <li :class="['tpT',item.name == 'logo' ? 'logoClass':'']" v-for="(item,i) in classifyList" :key="i" >
                        <img src="/static/vnso/img/thirdparty/hot.gif" class="x-dh-i" alt v-if="item.hotShow && item.name != 'logo'">
                        <img v-if="item.name == 'logo'" :src="item.logoUrl" >
...
export default {
    data() {
        return {
            ...
            gameIndex: 0,
            carouselData: [
                // {img:"/static/vnso/img/zhuce/a.jpg"},
                // {img:"/static/vnso/img/zhuce/b.jpg"},
                // {img:"/static/vnso/img/zhuce/c.jpg"},
                // {img:"/static/vnso/img/zhuce/d.jpg"},
                // {img:"/static/vnso/img/zhuce/e.jpg"},
                // {img:"/static/vnso/img/zhuce/f.jpg"},
                // {img:"/static/vnso/img/zhuce/g.jpg"},
                // {img:"/static/vnso/img/zhuce/h.jpg"},
            ],
            bounceTrue: false,
            checked: 0,
            classifyList: [
                ...
                {
                    name: "logo",
                    logoUrl:'/static/vnso/img/logo_4.png',
                    type:"logo",
                },
                {
                    name: "电子游艺",
