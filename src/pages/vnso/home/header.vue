<template>
  <div class="new-header">
    ...
    <!-- <div class="header-top" :class="{night:colorbool}" :style="{backgroundColor:headerbgColor}"> -->
      ...
      <div class="login">
        <div class="sj">
            <img src="/static/vnso/img/china.png" alt="" style="vertical-align: middle;margin-right:10px;">
            ...
            <span class="somePart jing" @click="goHeader(2)">金管家</span>
            <span class="somePart yue" @click="goHeader(0)">余额宝</span>
            <span class="somePart jie" @click="goHeader(1)">免息借呗</span>
        </div>
        <!-- 登录前 -->
        ...
        <div class="login-after" v-if="$store.state.mainState.loginOrout">
          ...
          <div class="part2 " :class="{headerColor:headerColorBool}">
            ...
            <span style="margin-left: -7px; margin-right: 5px;">{{userinfo&&userinfo.balance}}
          ...
          <div class="part5" :class="{headerColor:headerColorBool}">
            ...
            <a href="javascript:void(0)" @click="$bindPhoneOrbank()">充值大厅</a>
            ...
            <a href="javascript:void(0)" @click="$goUserCen('message',0)" class="unread_msg">
                站内信
                <font id="user_num"><span style="color:#FF0000"><span style="color: #ADADAD;">(</span><span style="color:#FF0000">{{allUnReadCount}}</span><span style="color: #ADADAD;">)</span></span></font>
                <!-- (<font id="user_num" style="color:rgb(255, 0, 0);">{{allUnReadCount}}</font>) -->
            </a>
          </div>
          <div class="last_item" style="margin-left:10px">
      ...
      .login {
        ...
        .login-before {
          ...
          div {
            ...
            #loginBtn {
              background: #4a9bf1; /* Safari 5.1 - 6.0 */
            }
            .ques{
              width: 20px;
              height: 20px;
        ...
        .login-after {
          ...
          .refresh_balance {
            .refresh {
                ...
                height: 20px;
                margin-top: -2px;
                background: url('/static/vnso/img/refresh.png') center center no-repeat;
            }
            .newfresh {
                background: url('/static/vnso/img/newfresh.png') no-repeat center;
            }
            .fres {
