...
<div>
  ...
  <!-- <div class="new2019 animated fadeInUp mobile_auto" onclick="window.open('/static/vnso/html/active/pig2019/#')" v-if="showNew2019">
  ...
  export default {
    data () {
      return {
        ...
        url:"",
        asideLink:[
          {name:'在线客服',mark:'解决各种问题',icon:'/static/vnso/img/1.png'},
          {name:'原生APP',mark:'从容尽显',icon:'/static/vnso/img/2.png'},
          {name:'免息借呗',mark:'秒放款0利息',icon:'/static/vnso/img/3.png'},
          {name:'优惠活动',mark:'领取每日福利',icon:'/static/vnso/img/4.png'},
        ]
      }
    },
    methods: {
      ...
      async advantageClick(advanItem){
        if(advanItem=='tryplay'){
             window.open("/static/vnso/html/active/jiebei/index.html")
        }
...
<style lang="less" scoped>
  .aside{
    ...
    div{
      ...
      background: linear-gradient(90deg,#22acfb,#4cbcfc);
      transition:width .4s;
  ...
  .qy-service {
    ...
    li:hover {
      background: url("/static/vnso/img/thirdparty/service-bg.png");
      border: unset;
    }
    ...
    .service {
      a{
        ...
        height:65px;
        width:65px;
        background: url("/static/vnso/img/thirdparty/kefu.png");
      }
    }
    .by-service{
      div{
        background:url(/static/vnso/img/thirdparty/by-kefu.png)
      }
    }

    .cs-mail {
      div{
        background: url("/static/vnso/img/thirdparty/tousu.png");
      }
      .shrink {
        right: 70px;
        background: #fff;
    ...
    .Agency{
      div{
         background:url(/static/vnso/img/thirdparty/daili.png)
      }
    }
    .jiebei {
      div{
        background: url("/static/vnso/img/thirdparty/jiebei.png");
      }
    }

    .gold_housekeeper {
      div{
        background: url("/static/vnso/img/thirdparty/jinguanjia.png");
      }
    }

    .download{
      div{
        background: url("/static/vnso/img/thirdparty/download.png")
      }
    }

    .cs-goTop {
      div{
        background: url("/static/vnso/img/thirdparty/zhiding.png")
      }
    }
  }
  .new2019{
    ...
    width: 230px;
    height: 230px;
    background-image: url('/static/vnso/img/new2019.gif');

    .clBtn{
      background: url('/static/vnso/img/new2019_close.png'); 
      z-index: 99999; 
      position: absolute; 
      width: 23px;
      height: 23px; 
