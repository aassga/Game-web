...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/amhg/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/amhg/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/amhg/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/amhg/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/amhg/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/amhg/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/amhg/home/youhui/index')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
// const register = r => require.ensure([], () => r(require('@/pages/amhg/register.vue')), 'register')
// const register1 = r => require.ensure([], () => r(require('@/pages/amhg/home/register1.vue')), 'register1')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/amhg/home/help/About/index')), 'about')
const agent = r => require.ensure([], () => r(require('@/pages/amhg/home/help/Agent/index')), 'agent')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/amhg/home/tiyu/index')), 'tiyu')
// const vp_caipiao = r => require.ensure([], () => r(require('@/pages/amhg/home/caipiao/index')), 'caipiao')
