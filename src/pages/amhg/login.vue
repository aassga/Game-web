    ...
    <div class="content">
      <div class="silider">
         <Carousel autoplay dots="none">
          <Carousel-item>
              <div class="demo-carousel"><img src="/static/amhg/img/s1.png" alt=""></div>
          </Carousel-item>
          <Carousel-item>
              <div class="demo-carousel"><img src="/static/amhg/img/s2.png" alt=""></div>
          </Carousel-item>
      ...
      <div class="login_area">
        ...
        <div class="register-wrap" v-if="isLogin">
            <div class="list-box">
                ...
                <div class="text-context1">
                    ...
                    <div @click="changeLog">快速注册</div>
                </div>
                <!-- <div class="treaty">完成即视为同意已满18岁，且同意各项开户条约。</div> -->
            </div>
        </div>
        <div class="register-wrap" v-if="isReg">
            <div class="list-box">
                <div class="text-context">
                    <div class="input-cont">
                        <i class="iconfont yonghu"></i>
                ...
                <div class="treaty">已有账号，点击<span @click="changeLog">立即登录</span></div>
            </div>
        </div>
      </div>
...
export default {
    ...
    computed:{
        clickIndex(){
            return this.$store.state.home.showLoginIndex;
        }
    },
    watch:{
        clickIndex(val){
