    ...
    <div class="wrap lotteryNav">
      ...
      <ul>
        <li v-for="(navItem,index) in navCont" :key="index">
          <span v-if="navItem.id == 2 || navItem.id == 5 || navItem.id == 7 || navItem.id == 10" class="stopSale"><img width="65px" src="/static/fczj/img/home/stopsale.png"></span>
          <a>
...
export default {
  data() {
    return {
      carouselData: [
        "/static/fczj/img/banner1.png",
        "/static/fczj/img/banner2.png"
      ],
      // 滚动名单
      random: [
        {
