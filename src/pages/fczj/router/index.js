...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/fczj/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/fczj/home')), 'vpHome')

const vpYouhui = r => require.ensure([], () => r(require('@/pages/fczj/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/fczj/home/register')), 'register')
const login = r => require.ensure([], () => r(require('@/pages/fczj/home/login')), 'login')
const help = r => require.ensure([], () => r(require('@/pages/fczj/home/help')), 'help')
const moblie = r => require.ensure([], () => r(require('@/pages/fczj/home/moblie')), 'moblie')
const vpCaipiao = r => require.ensure([], () => r(require('@/pages/fczj/home/caipiao')), 'vpCaipiao')
const vpQipai = r => require.ensure([], () => r(require('@/pages/fczj/home/qipai')), 'vpQipai')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/fczj/home/home-contactUs')), 'vpHomeContactUs')
