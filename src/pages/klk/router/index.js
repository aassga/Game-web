...
Router.prototype.push = function push(location) { return originalPush.call(this, location) }
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/klk/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/klk/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/klk/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/klk/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/klk/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/klk/home/tiyu')), 'vpTiyu')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/klk/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/klk/home/youhui/index')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/klk/home/register')), 'register')
// 帮助
const about = r => require.ensure([], () => r(require('@/pages/klk/home/help/About/index')), 'about')
const contact = r => require.ensure([], () => r(require('@/pages/klk/home/help/contact')), 'contact')
const savings = r => require.ensure([], () => r(require('@/pages/klk/home/help/Savings/index')), 'savings')
const issue = r => require.ensure([], () => r(require('@/pages/klk/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/klk/home/help/partner')), 'partner')
const help_withdrawals = r => require.ensure([], () => r(require('@/pages/klk/home/help/help-Withdrawals')), 'help_withdrawals')
