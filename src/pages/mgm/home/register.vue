                ...
                <div class="title_tab">
                    ...
                    <div class="close1" @click="close">
                        <a href="javascript:void(0)">
                            ...
                            <img src="/static/mgm/img/xx.png" alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="group">
                        <input autocomplete="off" :type="pwdInp" ref="pwdInp" @keyup="clearNull" placeholder="请输入8到20位的数字或字母组合" maxlength="20"
                            v-model="password">
                        <!-- <img @click='changType' class='eys_ico1' src="/static/mgm/img/reg/eyes_ico.png" alt=""> -->
                    </div>
                </div>
...
.register {
    ...
    .popup {
        ...
        .headline {
            ...
            background: url('/static/mgm/img/reg/dialogImg.png') no-repeat;
