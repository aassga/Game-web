      ...
      <ul class="nav-bar fl">
        <li class="nav-item" v-for="(item,i) in classifyList" :key="i" @click="$goPath('one',item)">
          <a  :class="[{navActive:i==gameIndex ? 'navActive' : ''}]">
            ...
            <img class="hotGif" v-if="item.hot == true" src="/static/mgm/img/home/hot.gif" alt="hot">
            ...
            <ol>
              <li v-for="(v,i) in item.list" :key="i" @click.stop="$goPath('nav',v)">
                <a href="javascript:void(0)">
                  ...
                  <span>{{v.name}}</span>
                  <img class="hotGif2" v-if="v.id == '243' || v.id == '10613' || v.id == '10695' || v.id == '38' || v.id == '11368'|| v.id == '10054' || v.id == '10055' || v.id == '10057'|| v.id == '173'|| v.id == '11421'|| v.id == '11729'" src="/static/mgm/img/home/hot.gif" alt="hot">
                  <br />
                </a>
              </li>
            </ol>
...
export default {
  data() {
    return {
      ...
      logoPng: "/static/mgm/img/logo-2.png",
      navChecked: 0,
      gameIndex: 0
    };
  },
