        ...
        <div class="text_box">
          ...
          <dl>
            <dd v-for="(it,i) in item.icons" :key="i"  @click="goLink(it.link)">
              <div class="icon_box">
                <img :src="'/static/mgm/img/home/' + it.icon + '.png'" class="icon">
              </div>
              <h6>{{it.name}}</h6>
            </dd>
          </dl>
      ...
      headerItem: [
        {
          ...
          bImg: "/static/mgm/img/home/boat.png",
          icons: [
        ...
        },
        {
          ...
          bImg: "/static/mgm/img/home/ball.png",
          icons: [
            ...
            { name: "欢乐生肖", icon: "CP-icons2" ,link:'#/plays/hall'},
...
.winlist {
  ...
  .top-title {
    position: absolute;
    top: 0;
    background: url("/static/mgm/img/home/winlist-top.png") no-repeat;
    width: 176px;
    height: 41px;
    line-height: 41px;
    text-align: center;
