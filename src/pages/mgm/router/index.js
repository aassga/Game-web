...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/mgm/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/mgm/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/mgm/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/mgm/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/mgm/home/buyu')), 'vpBuyu')
const vpQipai = r => require.ensure([], () => r(require('@/pages/mgm/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/mgm/home/tiyu')), 'vpTiyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/mgm/home/youhui/index')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/mgm/home/register')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/mgm/register')), 'register1')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/mgm/home/help/about')), 'about')
const issue = r => require.ensure([], () => r(require('@/pages/mgm/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/mgm/home/help/partner')), 'partner')
