          ...
          <div class="join-wrap">
            <div id="join-container">
              <div class="join-header-title">
                金沙娱乐场www.2262.com欢迎您的加入！
              </div>
              <div class="join-header-content" style="font-size:15px;line-height:30px">
                <div>
                  <p><strong>1.  金沙娱乐场：<span>官方直营,诚信第一品牌</span>，值得您的信赖。</strong></p>
...
export default {
  ...
  data() {
    return {
      ...
      headBg: '/static/hty/img/reg/reg-top-bg.png',
      bgColor:'#47080E'
    };
  },
    ...
    #page-right{
          ...
          .join-wrap{
              ...
              #join-container{
                ...
                .join-header-title{
                  margin-bottom: 10px;
                  background: url(/static/hty/img/re/m_welcome.png) 0 0 no-repeat;
                  max-height: 70px;
                  line-height: 80px;
                  color:#fff;
                  text-indent: 1em; 
