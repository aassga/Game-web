    ...
    <div class="header index-header">
        ...
        <div class="header-top">
            <div class="w1000">
                <div class="toplink">
                    <div class="lisence">
                        <img src="/static/hty/img/pz.png">
                    </div>
                    <a class="time">
                        美东时间：
                        <span id="mdtime" data-nowtime="2019/03/29 02:34:04">{{time}}</span>
                    </a>
                    <a class="yiji" href="#">易记域名 www.2262.com</a>
                        ...
                        <li v-for="(item,index) in classListData" :class="item.text" :key="index" @click="$goPath('one',item)">
                            <a href="javascript:void(0)"  @click="$goPath('one',item)" class="nav_item">
                                ...
                                <span class="ch">{{item.name}}</span>
                                 <img v-if="item.hot == true" src="/static/hty/img/hot.gif" alt="hot">
                            </a>
                            <div class="subnav" v-if="item.list&&item.list.length>0">
                                ...
                                <div class="con">
                                    <a v-for="(v,i) in item.list" :key="i" href="javascript:void(0)" style="position:relative;" @click.stop="$goPath('nav',v)">
                                        {{v.name}}
                                        <img src="/static/hty/img/hot.gif" style=" position: absolute; z-index: 99; right: 5px;" v-if="[173,11421,11729,10022,10018,10021,11320,243,10613,10695].includes(v.id)">
                                    </a>
                                </div>
                            </div>
                        </li>
                ...
                <div name="LoginForm" id="loginForms">
                    <div class="index-login" :class="[code_show ? 'withCode':'noCode']">
                        ...
                        <a class="register_btn" :class="[code_show ? 'show_code' : 'no_code']" href="javascript:void(0)"
                            @click="goKaihu"></a>
                            <p style="text-align: center;padding-left:10px;border: none;outline:none">
                                <img style="width: 207px;margin-top: 13px" src="/static/hty/img/1-1.png" alt="">
                            </p>
                    </div>
                </div>
            </div>
        ...
        <div class="header-login" v-if="$store.state.mainState.loginOrout">
            <div class="w1000">
                <div class="img" style="margin-left:8px"><img src="/static/hty/img/new_games/head_log.png" alt=""></div>
                <div class="left">
                    <span class="account">
                ...
                <div class="right">
                    <span>
                        <a href="javascript:void(0)" @click="$bindPhoneOrbank()">我要存款</a>&nbsp; | &nbsp;
        ...
        <div class="header-login" id="xheader-login" style="display:block" v-if="!isShow && !$store.state.mainState.loginOrout">
            <form name="LoginForm" id="loginForm" action="#" method="POST" target="actionframe" onsubmit="return false;">
                <div class="header-logincon">
                    <div>
                        <p><img src="/static/hty/img/8824.png" style="margin-top:11px;" alt=""></p>
                    </div>
                    <div>
                        <p style=""><img src="/static/hty/img/headerlogin.png" style="margin-top:3px"></p>
...
export default {
    ...
    data() {
        return {
            allUnReadCount:10,
            codeImg:'/static/hty/img/new_games/lo.png',
            freh:{
            ...
            headerImg: '/static/hty/img/tiger.jpg',
            time: '',
            lantern: '',
            isShow: true,
            showLittlePic: true,
    ...
    methods: {
        ...
        goHeader(typeNum) {
            if (typeNum == 0) {
                // 线路检测
                window.open('http://391129.com', '_blank');
            } else if (typeNum == 1) {
                // 借呗
                 if(localStorage.token){
                    if(this.$store.state.game.jieBeiData.show){
                     ...
                     this.$goUserCen('recharge',0)
                      //window.open('/static/hty/html/active/jiebei/index.html');
                   }
                  }else{
                    // window.open('/static/hty/html/active/jiebei/index.html');
...
.index-header {
    ...
    .header-float {
        ...
        .navbg {
            ...
            .nav {
                ...
                .logo {
                    background: url(/static/hty/img/home_logo.png) no-repeat;
                    ...
                    li {
                        ...
                        a {
                            ...
                            .ico {
                                ...
                                margin-bottom: 10px;
                                &.home {
                                    background: url(/static/hty/img/homeico.png) no-repeat center center;
                                }
                                &.elec {
                                    background: url(/static/hty/img/elecico.png) no-repeat center center;
                                }
                                &.chess {
                                    background: url(/static/hty/img/chess_icon.png) no-repeat center center;
                                }
                                &.casino {
                                    background: url(/static/hty/img/casinoico.png) no-repeat center center;
                                }
                                &.lottery {
                                    background: url(/static/hty/img/lotteryico.png) no-repeat center center;
                                }
                                &.fishing {
                                    background: url(/static/hty/img/fishingico.png) no-repeat center center;
                                }
                                &.esport {
                                    background: url(/static/hty/img/esportico.png) no-repeat center center;
                                }
                                &.promo {
                                    background: url(/static/hty/img/promoico.png) no-repeat center center;
                                }
                                &.service {
                                    background: url(/static/hty/img/serviceico.png) no-repeat center center;
                                }
                            }
                            img{
                                position: absolute;
        ...
        .index-bannercon {
            #loginForms {
                ...
                .index-login {
                    ...
                    padding-top: 28px;
                    &.withCode {
                        background: url(/static/hty/img/login/no_code.png) no-repeat;
                    ...
                    .title {
                        ...
                        height: 24px;
                        margin-bottom: 12px;
                        background: url(/static/hty/img/login/title.png) center center no-repeat;
                    }
                    p {
                        width: 82%;
                        height: 42px;
                        ...
                        &.username_box {
                            margin-bottom: 10px;
                            background: url(/static/hty/img/login/user_input.png) no-repeat center center;
                        }
                        &.pwd_box {
                            background: url(/static/hty/img/login/pwd_input.png) no-repeat center center;
                        }
                        &.code_box0 {
                            height: 48px;
                            line-height: 48px;
                    ...
                    .button {
                        ...
                        a {
                            ...
                            &.login_btn {
                                text-decoration: none;
                                background: url(/static/hty/img/login/login_btn.png) no-repeat center center;
                                background-size: contain;
                            ...
                            &.forget {
                                background: url(/static/hty/img/login/forget_pwd.png) no-repeat center center;
                                background-size: contain;
                            }
                        }
                        .subbtn {
                    ...
                    .register_btn {
                        display: block;
                        background: url(/static/hty/img/login/register_btn.png) no-repeat center center;
                        width: 83%;
                        height: 42px;
                        &.show_code {
                            margin: 0 auto;
    ...
    .header-login {
        ...
        #loginForm {
            ...
            // padding-left: 360px;
            .header-logincon {
                // background: url(/static/hty/img/headerlogin.png) left center no-repeat;
                height: 100%;
                width: 1200px;
                margin: 0 auto;
                display: flex;
                ...
                .forget {
                    background: url(/static/hty/img/forget.png) no-repeat;
                    width: 60px;
                    height: 32px;
                    display: block;
                    float: left;
                ...
                .subbtn {
                    background: url(/static/hty/img/subbtn.png) no-repeat;
                    width: 130px;
                    height: 34px;
                    border: none;
                    padding: 0;
                ...
                .regbtn {
                    background: url(/static/hty/img/regbtn.png) top center no-repeat;
                    width: 130px;
                    height: 34px;
                    display: block;
                    float: left;
                ...
                span {
                    ...
                    &.refresh_balance {
                        .refresh {
                            ...
                            width: 22px;
                            height: 20px;
                            background: url('/static/hty/img/refresh.png') center center no-repeat;
                            // transform: scale(1.2);
                            margin-top: 17px;
                        }
                        .newfresh{
                            background:url('/static/hty/img/newfresh.png') no-repeat center;
                        }
                        .fres{
                             -webkit-animation: spin 1s linear;
                             animation: spin 1s linear;
                ...
                span {
                    a {
                        ...
                        &.logOut {
                            ...
                            text-align: center;
                            color: #000;
                            background: url(/static/hty/img/log_out.png) center center no-repeat;
                            background-size: contain;
                        }
                    }
                }
...
.header .nav .subnav .jt {
    background: url(/static/hty/img/menujt.png) no-repeat;
    height: 5px;
    width: 9px;
    display: block;
    margin: 0 auto;
