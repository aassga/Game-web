    ...
    <div class='subNav'>
      <ul class="subNavWrapper">
          <li v-for="(item,index) in gameNavList" :key="index" @mouseover="changeDzId(index)"
              ...
              <img  class="img_bg" src="/static/935qp/img/home/game-list-mask.png" alt="">
      ...
      if (res && res.code == 200) {
        ...
        gameList.forEach(val => {
          if(val.name!='全部'){
            ...
            this.showList.push(objectList.list[Object.keys(objectList.list)[0]]);
          }
        })
      }
    },
...
.quickGame {
  ...
  font-family: Microsoft YaHei !important;
    .subNav {
      ...
      width: 1200px;
      height:402px;
      background: url(/static/935qp/img/home/game-list-bg.png) center center no-repeat;
      ...
      .subNavWrapper {
        ...
        .navItem {
            ...
            position: relative;
            cursor: pointer;
            background: url(/static/935qp/img/home/game-list-header.png) no-repeat;
            ...
            .icon_box{
              ...
              top: 14px;
              &.KY-icons1 {
                background: url(/static/935qp/img/home/KY-icons1.png) center center no-repeat;
                background-size: contain;
              }
              &.KY-icons2 {
                background: url(/static/935qp/img/home/KY-icons2.png) center center no-repeat;
                background-size: contain;
              }
              &.KY-icons3 {
                background: url(/static/935qp/img/home/KY-icons3.png) center center no-repeat;
                background-size: contain;
              }
              &.KY-icons4 {
                background: url(/static/935qp/img/home/KY-icons4.png) center center no-repeat;
                background-size: contain;
                height: 40px;
              }
              &.KY-icons5 {
                background: url(/static/935qp/img/home/KY-icons5.png) center center no-repeat;
                background-size: contain;
              }
            }
            p{
      ...
      .list_user{
        ...
        .slidePrev{
            left: 0;
            i{
                background: url("/static/935qp/img/home/go_left.png") center center / 23px no-repeat;
            }
        }
        .slidePrev:hover{
            i{
                background: url("/static/935qp/img/home/go_left2.png") center center / 23px no-repeat;
            }
        }
        .slideNext{
            right: 0;
            i{
                background: url("/static/935qp/img/home/go_right.png") center center / 23px no-repeat;
            }
        }
        .slideNext:hover{
            i{
                background: url("/static/935qp/img/home/go_right2.png") center center / 23px no-repeat;
            }
        }
        .slide_box{
          width: 1200px;
