...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/935qp/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/935qp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/935qp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/935qp/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/935qp/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/935qp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/935qp/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/935qp/home/register')), 'register')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/935qp/home/help/About')), 'about')
const agent = r => require.ensure([], () => r(require('@/pages/935qp/home/help/Agent')), 'agent')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/935qp/home/tiyu')), 'tiyu')
// const vp_caipiao = r => require.ensure([], () => r(require('@/pages/935qp/home/caipiao/index')), 'caipiao')
