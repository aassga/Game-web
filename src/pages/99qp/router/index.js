...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/99qp/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/99qp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/99qp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/99qp/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/99qp/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/99qp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/99qp/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/99qp/register.vue')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/99qp/home/register1.vue')), 'register1')
const beforeLogin= r => require.ensure([],()=>r(require("@/pages/99qp/beforeLogin")),'beforeLogin')
// 帮助
const about = r => require.ensure([], () => r(require('@/pages/99qp/home/help/About')), 'about')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/99qp/home/tiyu')), 'tiyu')
// const vp_caipiao = r => require.ensure([], () => r(require('@/pages/99qp/home/caipiao/index')), 'caipiao')
