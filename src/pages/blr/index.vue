<template>
  <div>
     <!-- <hongbaoyu :theme="'theme1'" v-show="$route.path=='/home'"></hongbaoyu>  -->
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        lotHeadDatas: {
          logoUrl: '/static/blr/img/homeLogo.png',
          downLoadurl: '/static/blr/html/download/index.html'
        },
        dialogPar:{
          borderTop:"3px solid #10A57F",
          headBg:'#00644A',
          bandBorder:'1px solid #3F4248',
          active:'#18B88F',
          titleColor:'#119976',
          ulBg:'#FCFCFC',
          headColor:'#fff',
          borderLeft:'3px solid #15B68C',
          activeName:'betActive',
          hoverName:"hoverName2",
        },
        nameSta:'bet365',
        poptype: 'bet',
        showtype: {
          topImg: 'bet365',//弹窗头部图片
          closeImg: 'close_1',//弹窗关闭图片
          textColor: '#007B5B',//弹窗按钮颜色
        },
        attPar:{
          btnColor:'#017B5B',
          closeImg: "close_1", //弹窗关闭图片
          coverImgUrl:"../../../../static/blr/img/tc.png",
        },
      }
    },
    methods: {},
