...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/blr/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/blr/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/blr/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/blr/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/blr/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/blr/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/blr/register')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/blr/home/register1')), 'register1')
const help = r => require.ensure([], () => r(require('@/pages/blr/home/help/index.vue')), 'help')
const question = r => require.ensure([], () => r(require('@/pages/blr/home/help/question.vue')), 'question')
const vpQipai = r => require.ensure([], () => r(require('@/pages/blr/home/qipai')), 'vpQipai')
const vpSport = r => require.ensure([], () => r(require('@/pages/blr/home/sport')), 'vpSport')
//const register1 = r => require.ensure([], () => r(require('@/pages/blr/home/register1')), 'register1')
//购彩大厅
