                ...
                <div class="w1200 clearfix">
                    <div class="cont-left fl">
                        <ul>
                            ...
                            <li v-for="(item,i) in footerList" :key="i" :class="[item.className,item.hoverClas&&item.name==active?item.hoverClas:'']">
...
export default {
    ...
    data() {
        return {
            ...
            title: '',
            footerList: [
                { name: '关于我们', link: '/home/register1', className: 'lebo' ,hoverClas:'lebohover'},
                { name: '游戏规则', link: '/rules/ssc?id=4', className: 'bbin' },
                { name: '存款帮助', link: '/home/register1', className: 'mg' ,hoverClas:'mghover'},
                { name: '取款帮助', link: '/home/register1', className: 'ct' ,hoverClas:'cthover'},
                { name: '联系我们', link: '/home/register1', className: 'sports' ,hoverClas:'sphover'},
                { name: '真人视讯', link: '/home/live', className: 'liveGame' },
                { name: '棋牌游戏', link: '/home/chess?navid=9&id=0', className: 'qipaiGame' },
    ...
    methods: {
        ...
        goHelp(item) {
            ...
            } else if (item.link == '/home/live' || item.link == '/home/youhui' || item.link == '/home/chess?navid=9&id=0') {
...
.register {
    ...
    .wrapperbox {
        ...
        .registerBanner {
            width: 100%;
            height: 250px;
            background: url(/static/blr/img/8.jpg) no-repeat -5px center;
        ...
        .abount-main {
            ...
            .cont-left {
                ...
                li {
                    a {
                        background: url(/static/blr/img/left_sidbar_bg.png) no-repeat 35px 0px;
                        display: block;
                        width: 100%;
                        height: 23px;
                        line-height: 23px;
...
#ads1 {
    ...
    height: 250px;
    width: 180px;
    background: url(/static/blr/img/ads1.jpg) no-repeat;
