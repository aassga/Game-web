    ...
    data() {
        return {
            aboutData: [
                ...
                { name: '体育赛事', path: '/home/tiyu?id=0' },
                { name: '电子游艺', path: '/home/slot?navid=9&id=0' },
...
.home-help {
    background: url(/static/blr/img/bg-page.jpg) no-repeat center 0;
    background: #fff;
    padding-bottom: 15px;
    ...
    .container {
        ...
        .helpSlider {
            ...
            float: left;
            height: 268px;
            background: url(/static/blr/img/aside.png) no-repeat center;
            ...
            .helpMenu {
                ...
                li:hover {
                    background: url(/static/blr/img/aside-nav.png);
                }
