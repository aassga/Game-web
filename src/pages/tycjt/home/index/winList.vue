  ...
  <div class="winlist clearfix slideLeft">
    <div class="right-area">
      <div class="game-winlist-1 game-winlist">
        <div class="fistTitle">
          <img src="/static/tycjt/img/42.png" alt />
      ...
      <div class="game-winlist-2 game-winlist">
        <div class="fistTitle">
          <img src="/static/tycjt/img/41.png" alt />
...
.winlist {
  ...
  margin: 0px auto 0;
  background-size: 100%;
  background: url("/static/tycjt/img/win_bg.png") no-repeat;
  ...
  .right-area {
    ...
    .game-winlist {
      ...
      .win-money {
        ...
        width: 222px;
        font-weight: 600;
        background: url('/static/tycjt/img/40.png')
      }
      &.game-winlist-1 {
        left: 37px;
        img {
