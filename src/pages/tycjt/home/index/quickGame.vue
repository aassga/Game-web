...
export default {
  data() {
    return {
      ...
      gameIndex2:0,
      liveGameList:[
        {name:"AG女优厅",title:"最顶尖的真人视讯平台，美女荷官在线发牌，画面真实高清...",icon:"/static/tycjt/img/27.png",id:31},
        {name:"BBIN波音厅",title:"亚洲最顶级的真人视讯平台，亿万玩家首选，性感女优...",icon:"/static/tycjt/img/26.png",id:32}
      ],
      slotGameList:[
        {name:"BG大游厅",title:"BG GAME",id:3180,className:"BG",icon:"/static/tycjt/img/25.png",},
        {name:"WM贵宾厅",title:"WM GAME",id:12035,className:"WM",icon:"/static/tycjt/img/12035.png",},
        // {name:"OG东方厅",title:"OG GAME",id:48,className:"OG",icon:"/static/tycjt/img/27.png",},
        {name:"DG梦幻厅",title:"DG GAME",id:42,className:"DG",icon:"/static/tycjt/img/24.png",},
        {name:"eBET易博厅",title:"eBET GAME",id:43,className:"eBET",icon:"/static/tycjt/img/23.png",},
        // {name:"VR彩票厅",title:"VR GAME",id:3180,className:"VR",icon:"/static/tycjt/img/27.png",}
      ]
    };
  },
  methods: {
...
.quickGame {
  ...
  .borderHover:hover{
    ...
    .joinGame{
      color: #000;
      background: url("/static/tycjt/img/29.png") no-repeat;
    }
  }
  & > div {
    display: flex;
    ...
    &:first-child{
      ...
      p{
        ...
        &:first-child{
          background: url('/static/tycjt/img/31.png') -1px no-repeat;
          position: relative;
          
        }
        &:last-child{
          background: url('/static/tycjt/img/32_1.png') -1px no-repeat;
          position: relative;
          top: -15px;
        }
        .fontBg{
          ...
          right:0px;
          top: -1px;
          background: url('/static/tycjt/img/AG_bg.jpg')
        }
        span{
          display: block;
          width: 70%;
    ...
    &:last-child{
      ...
      ul{
        ...
        li{
          ...
          background: url('/static/tycjt/img/BG_bg.jpg') no-repeat;
          cursor: pointer;
          color: #fff;
          border: 1px solid transparent;
          position: relative;
          ...
          .BG{
            background: url('/static/tycjt/img/BG.png') 110px 0 no-repeat
          }
          .DS{
            background: url('/static/tycjt/img/DS.png') 110px 0 no-repeat
          }
          .WM{
            background: url('/static/tycjt/img/DS.png') 110px 0 no-repeat
          }
          .OG{
            background: url('/static/tycjt/img/OG.png') 110px 0  no-repeat
          }
          .DG{
            background: url('/static/tycjt/img/DG.png') 110px 0  no-repeat
          }
          .eBET{
            background: url('/static/tycjt/img/eBET.png') 110px 0 no-repeat
          }
          .VR{
            background: url('/static/tycjt/img/VR.png') 110px 0 no-repeat
          }
        }
      }
    }
  ...
  .joinGame{
    ...
    text-align: center;
    line-height: 31px;
    background: url("/static/tycjt/img/30.png") no-repeat;
    &:hover{
      color: #000;
      background: url("/static/tycjt/img/29.png") no-repeat;
    }
