                ...
                <div class="title_tab">
                    ...
                    <div class="close1" @click="close">
                        <a href="javascript:void(0)">
                            ...
                            <img src="/static/tycjt/img/xx.png" alt="">
                        </a>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            codeImg:'/static/tycjt/img/home/re.png',
            pwdInp: 'password',
            smsInputBox: {
                marginTop: '20px'
            },
...
.register {
    ...
    .popup {
        ...
        .headline {
            ...
            background: url('/static/tycjt/img/home/reheader.png') no-repeat;
        ...
        .content {
            ...
            .title_tab {
                ...
                .close1 {
                    ...
                    top: 15px;
                    right: 0;
                    background: linear-gradient(to bottom, #fef5c4, #fce789);
