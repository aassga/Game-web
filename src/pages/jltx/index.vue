<template>
    <div>
        ...
        <!-- <comModal :poptype="'jsyl'"></comModal> -->
...
export default {
    ...
    data() {
        return {
            ...
            sideNav: false,
            lotHeadDatas: {
                logoUrl: '/static/jltx/img/logo/gc-logo.png',
                downLoadurl: '/static/jltx/html/download/index.html'
            },
            dialogPar:{
            ...
            coverImgUrl:"../../../../static/jltx/img/tc.png",
            },
        };
    },
    methods: {
