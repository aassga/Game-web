...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/jltx/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/jltx/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/jltx/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/jltx/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/jltx/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/jltx/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/jltx/home/youhui/index')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/jltx/home/register')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/jltx/register')), 'register1')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/jltx/home/help/About/index')), 'about')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/jltx/home/tiyu/index')), 'tiyu')
const vp_caipiao = r => require.ensure([], () => r(require('@/pages/jltx/home/caipiao/index')), 'caipiao')
