      ...
      .sidenav {
        ...
        ul {
          li {
            ...
            height: 60px;
            position: relative;
            background: url('/static/jltx/img/youhui/icon-arrow.png') no-repeat 228px center;
            ...
            a {
              ...
              i {
                ...
                &.icon-all {
                  background: url('/static/jltx/img/youhui/icon-all1.png') no-repeat;
                  background-size: 100% 100%;
                }

                &.icon-dz {
                  background: url('/static/jltx/img/youhui/icon-dz1.png') no-repeat;
                  background-size: 100% 100%;
                }

                &.icon-qp {
                  background: url('/static/jltx/img/youhui/icon-qp1.png') no-repeat;
                  background-size: 100% 100%;
                }
                &.icon-by {
                  background: url('/static/jltx/img/youhui/icon-by1.png') no-repeat;
                  background-size: 100% 100%;
                }
                &.icon-sx {
                  background: url('/static/jltx/img/youhui/icon-sx1.png') no-repeat;
                  background-size: 100% 100%;
                }

                &.icon-qt {
                  background: url('/static/jltx/img/youhui/icon-qt1.png') no-repeat;
                  background-size: 100% 100%;
                }
              }
            }
            ...
            &:hover {
              background: url('/static/jltx/img/youhui/icon-arrowh.png') no-repeat 228px center #282828;
              ...
              a {
                ...
                i {
                  &.icon-all {
                    background: url('/static/jltx/img/youhui/icon-all2.png') no-repeat;
                    background-size: 100% 100%;
                  }

                  &.icon-dz {
                    background: url('/static/jltx/img/youhui/icon-dz2.png') no-repeat;
                    background-size: 100% 100%;
                  }

                  &.icon-qp {
                    background: url('/static/jltx/img/youhui/icon-qp2.png') no-repeat;
                    background-size: 100% 100%;
                  }
                  &.icon-by {
                    background: url('/static/jltx/img/youhui/icon-by2.png') no-repeat;
                    background-size: 100% 100%;
                  }
                  &.icon-sx {
                    background: url('/static/jltx/img/youhui/icon-sx2.png') no-repeat;
                    background-size: 100% 100%;
                  }

                  &.icon-qt{
                    background: url('/static/jltx/img/youhui/icon-qt2.png') no-repeat;
                    background-size: 100% 100%;
                  }
                }
              }
          ...
          .promo {
            ...
            .promo-box {
              ...
              .promo-img {
                ...
                position: relative;
                background: url(/static/jltx/img/youhui/default-img.png) no-repeat 50% #1e1e1e;
                overflow: hidden;
                ...
                .promo-mask {
                  ...
                  top: -1px;
                  left: -1px;
                  background: url(/static/jltx/img/youhui/mask.png) repeat;
                }
                ...
                .promoh {
                  ...
                  background: url(/static/jltx/img/youhui/trans1.png) repeat;
                  position: absolute;
                  top: 0;
                  left: 0;
                  padding-top: 50px;
                  ...
                  span {
                    color: #fff;
                    background: url(/static/jltx/img/youhui/btn1.png) no-repeat;
                    width: 120px;
                    height: 37px;
                    margin: 0 auto;
                    text-align: center;
  ...
  .vp-popout-box {
    ...
    .close {
      ...
      span {
        ...
        color: #fff;
        cursor: pointer;
        background: url(/static/jltx/img/youhui/close.png) no-repeat 42% 42%;
