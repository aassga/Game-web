<template>
  <section class="content content-bg-page" style=" width:100%; display: block; position: relative;">
    ...
    <!-- <div style="height:36px">
      <banLantern :notice='notice' :siteName="'jltx'"></banLantern>
    </div> -->
    ...
    <div class="content"
      ...
      <div class="promotlist" style="margin: 0 auto;">
        <div style="width: 1200px; margin: 0 auto;">
          ...
          <div style="padding: 0 23px 20px 22px;border:1px solid #444;box-sizing:border-box">
...
export default {
  data () {
    return {
      headerImg:"/static/jltx/img/youhui.jpg",
...
<style lang='less' scoped>
  ...
  .content{
    ...
    .banner{
      ...
      height: 300px;
      margin: 0 auto;
      background: url('/static/jltx/img/banner/yh.jpg') center top/ cover no-repeat;
    }
  }
  .bannerHead {
    width: 100%;
