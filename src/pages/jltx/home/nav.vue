    ...
    <div class="top_nav">
            ...
            <div class="nav_box">
                <ul class="nav-bar fl">
                    <li :class="['tpT',item.name == 'logo' ? 'logoClass':'']" v-for="(item,i) in classifyList" :key="i" >
                        <img src="/static/jltx/img/thirdparty/hot.gif" class="x-dh-i" alt v-if="item.hotShow && item.name != 'logo'">
                        <img v-if="item.name == 'logo'" :src="item.logoUrl" width="275px" height="43px">
                            ...
                            <ol>
                                <li v-for="(v,i) in item.list" :key="i" @click="$goPath('nav',v)">
                                    <a href="javascript:void(0)">
                                        ...
                                        <img v-if="v.id == '243' || v.id == '10613' || v.id == '10695' || v.id == '11368' || v.id == '38'" src="/static/jltx/img/hot.gif" style=" position: absolute; z-index: 99; right: 5px;top:10px; ">
                                        <span>{{v.name}}</span>
                                        <br>
                                    </a>
                                </li>
        ...
        <div class="newgong" v-if="$route.path==='/home'" :class="{youhuiActive:$route.path=='/home/youhui'}">
            <div class="newgong-content" @click="showTextModal()">
                <div class="notice">
                    <i class="iconfont icon-sound">&nbsp;最新公告: </i>
                </div>
                <div class="demolist list">
                    <marquee v-if="lantern" align="middle" direction="left" loop="-1" scrollamount="5" onmouseout="this.start()" onmouseover="this.stop()"
                        style="color:#fff; font-size:14px; line-height: 40px;overflow: hidden;height: 40px;font-weight:600">
...
export default {
    data() {
        return {
            ...
            gameIndex: 0,
            carouselData: [
                // {img:"/static/jltx/img/banner/6.jpg"},
                // {img:"/static/jltx/img/banner/1.jpg"},
                // {img:"/static/jltx/img/banner/2.jpg"},
                // {img:"/static/jltx/img/banner/3.jpg"},
                // {img:"/static/jltx/img/banner/4.jpg"},
                // {img:"/static/jltx/img/banner/5.jpg"},
            ],
            bounceTrue: false,
            checked: 0,
            classifyList: [
                ...
                {
                    name: "logo",
                    logoUrl:'/static/jltx/img/logo.gif',
                    type:"logo",
                },
                {
                    name: "电子游艺",
    ...
    methods: {
        ...
        getNativeDatas() {
            ...
            if (localStorage.gameSortV4_sport){
                this.classifyList[7].list = this.$gameClassV4("sport");
            }
        },
        async getBanner() {
        ...
        .nav-bar {
            ...
            li {
                ...
                .x-dh-t {
                    display: block;
                    &:hover {
                        border-bottom: 4px #E1C266 solid;
                        color: #E1C266;
                    }
                    &:hover .triangle1 {
                        display: block;
                ...
                .triangle {
                    ...
                    border-bottom: 5px solid #E1C266;
                    transition: all 0.2s;
                }
                .triangle1 {
                    display: none;
                ...
                .dropdown:after {
                    ...
                    border-bottom: 8px solid #ffd053;
                }
            }
            li:last-child {
                margin-right: 0;
