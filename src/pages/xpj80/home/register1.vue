    ...
    <div class="register">
        <div class="content">
            ...
            <div class="content clearfloat">
                <div class="left fl">
                    <img class="phone-img1 animated fadeInLeft" src="/static/xpj80/img/thirdparty/pone-bg.png" alt="">
...
export default {
    ...
    data() {
        return {
            ...
            codeImg: '/static/xpj80/img/new_games/lo.png',
            tabIndex:1,
...
.register {
    ...
    .content {
        ...
        .register-logo {
            ...
            font-size: 36px;
            color: #5caaea;
            background: url(/static/xpj80/img/thirdparty/regbanner.jpg) no-repeat center;
        }
        .reg_step {
            text-align: center;
            margin: 0 auto 50px;
            ...
            ul {
                ...
                .active {
                    background: url(/static/xpj80/img/thirdparty/hover.png) no-repeat center;
                    .tip-num {
                        background: #5caaea;
                    }
                }
        ...
        .content {
            .left {
                ...
                width: 461px;
                height: 486px;
                background: url(/static/xpj80/img/thirdparty/left_banner.png) no-repeat center;
                ...
                .qy-code-down1 {
                    ...
                    width: 213px;
                    height: 249px;
                    background: url('/static/xpj80/img/thirdparty/qy-code-down.png') no-repeat;
                    .qr-code {
                        margin-top: 80px;
                        margin-left: 45px;
                    }
            ...
            .list-box {
                ...
                .text-context {
                    ...
                    .input-cont {
                        ...
                        .yonghu {
                            background: url('/static/xpj80/img/zhuce/username.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .mima {
                            background: url('/static/xpj80/img/zhuce/mimaask.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .yanzhengma {
                            background: url('/static/xpj80/img/zhuce/yanzhengma.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .shoujihao {
                            background: url('/static/xpj80/img/zhuce/shoujihao.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .yaoqingma {
                            background: url('/static/xpj80/img/zhuce/yaoqingma.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .youxiang {
                            background: url('/static/xpj80/img/zhuce/youxiang.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .weixin {
                            background: url('/static/xpj80/img/zhuce/weixin.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .zhifumima {
                            background: url('/static/xpj80/img/zhuce/zhifumima.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        input {
                            position: relative;
