    ...
    <div class="footer">
        <div class="footer-detail" :style="{background: 'url(' + footerBg + ')  no-repeat center top',backgroundColor:footbgcolor,backgroundSize:'cover'}" :class="{night:colorbool}">
            <div class="foot_links">
                <ul class="wp flex">
                    <li class="introduce-cont">
                        <h3 class="footer-link-title">新葡京</h3>
                        <div>
                          <a href="javascript:void(0);"  @click="goHelp('/home/about/'+ index)" v-for="(item,index) in aItems" :key="index">{{item.item}}</a>
                            ...
                            <a href="javascript:void(0);"  @click="goHelp('/home/about')">联系我们</a>
                            <a href="javascript:void(0);"  @click="goHelp('/home/about')">存款帮助</a>
                            <a href="javascript:void(0);"  @click="goHelp('/home/about')" >取款帮助</a>
                            <a href="javascript:void(0);"  @click="goHelp('/home/about')">合作代理</a> -->
                        </div>
                    </li>
                    <li class="support-browser-cont">
                        <h3 class="footer-link-title browser-title">支持浏览器</h3>
                        <div>
                            <img src="/static/xpj80/img/home/image_2019_02_14T08_53_01_247Z.png" alt="" width="100">
                        </div>
                    </li>
                    <li class="regulatory-authority">
                        <h3 class="footer-link-title">监管机构</h3>
                        <div>
                            <img src="/static/xpj80/img/home/image_2019_02_14T08_52_29_378Z.png" alt="" width="60">
                        </div>
                    </li>
                    <li class="platform-cont">
                        <h3 class="footer-link-title">合作伙伴</h3>
                        <div>
                            <img src="/static/xpj80/img/footer_bg.png" alt="" width="100%">
                        </div>
                    </li>
                </ul>
            </div>
            <div class="copyright">
                <div class="wp">
                    <div>
                        <!-- 千赢国际持有菲律宾 PAGCOR合法博彩执照&nbsp;&nbsp;版权为千赢国际所有&nbsp;&nbsp;PT游戏是由PT TransPacific在的授权下部署&nbsp;<img src="/static/xpj80/img/pagcor_xs.png"> -->
                        版权为新葡京 所有 © 2021
                    </div>
                </div>
            </div>
  ...
  export default {
    data () {
      return {
        ...
        footerBg:"/static/xpj80/img/home/image_2019_02_14T08_56_54_932Z.png",
        footbgcolor:'',
        newmodal:{
          title:"来自新葡京的消息",
          bgcolor:{
    ...
    watch:{
       colorbool(newbool,oldbool){
          if(newbool==true){
            this.footerBg ='/static/xpj80/img/index-main-bg-n.jpg'
          }else{
            this.footerBg = "/static/xpj80/img/home/image_2019_02_14T08_56_54_932Z.png"
          }
       },
       $route(to,from){
          this.initColor()
