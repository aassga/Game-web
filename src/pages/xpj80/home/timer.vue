...
export default {
    ...
    methods: {
        ...
        if (this.timer.timeLeave >= 86400 && this.timer.djs_next_kaipan <= 0) {
          ...
          if (this.timerDatas.lotteryName.includes('快速') || this.timerDatas.lotteryName.includes('3分') || this.timerDatas.lotteryName.includes('5分')) {
            if(this.timerDatas.djs_fengpan<0){
                  this.timer.timerModel = 'fengpan'
            }else{
      ...
      timeStart (timeParam) {
        ...
        this.btnTimer = setInterval(() => {
          // this.timerDatas.numMember=this.timerDatas.numMember+10
        ...
        //      }else{
        //            let num;
        //           if(this.timerDatas.lotteryName.includes('快速')){
        //              num=Math.ceil(Math.random()*10 + 70);
        //           }else{
        //              num=Math.ceil(Math.random()*10 + 40);
        //           }
        //           this.timerDatas.numMember=this.timerDatas.numMember+num
        //      }
        // }, 2000)
       },
    },
    computed:{
        djs_fengpan(){
             return this.timerDatas.djs_fengpan
        }
    },
    watch: {
      // timerDatas:{
