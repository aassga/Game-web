...
export default {
  ...
  data() {
    return {
      lotHeadDatas: {
        logoUrl: "/static/xpj80/img/gc-logo.png",
        downLoadurl: "/static/xpj80/html/download/index.html"
      },
      dialogPar:{
          borderTop:"3px solid rgb(104, 176, 216)",
          headBg:'#fff',
          bandBorder:'1px solid #DFDFDF',
          active:'rgb(104, 176, 216)',
          titleColor:'#78BADC',
          ulBg:'#F2F2EA',
          ulBg2:'#f8f8f8',
          headColor:'rgb(104, 176, 216)',
          borderLeft:'3px solid rgb(104, 176, 216)',
          activeName:'test1Active',
          hoverName:"hoverName1"
        },
      attPar:{
        btnColor:'rgba(46,166,238,1)',
        closeImg: "close_1", //弹窗关闭图片
        coverImgUrl:"../../../../static/xpj80/img/attention.png",
      },
      nameSta:"xpj80",
      poptype: "tc",
      showtype: {
