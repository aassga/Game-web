                    ...
                    <div class="register-wrap">
                        <div class="list-box">
                            ...
                            <div class="smsContainer" v-if="isShowSms">
                                ...
                                <sms-input :xpj80="theName" :smsInputBox="smsInputBox" :smsCodeWrapper="smsCodeWrapper" :curLabel="curLabel" :star="star"
...
export default {
    ...
    data() {
        return {
            ...
            codeImg: '/static/xpj80/img/new_games/re.png',
            smsInputBox: {
                marginTop: 15/23 +'vw'
            },
            codeImg: '/static/xpj80/img/new_games/log.png',
            tabIndex:1,
...
.register {
    ...
    height: 100%;
    margin: 0 auto;
    background: url(/static/xpj80/img/register_bg.png) no-repeat center;
    ...
    .service{
        ...
        span{
            ...
            &:first-child{
                width: 102px;
                height: 102px;
                background: url('../../../static/xpj80/img/ser.png');
    ...
    .content {
        ...
        background: url('../../../static/xpj80/img/form_bg.png');
        background-repeat: no-repeat;
        background-size:100% 100% ;
        position: relative;
        .titleTab{
