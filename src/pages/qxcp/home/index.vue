           ...
           <div class="third_part">
                <div class="gameList">
                    <ul>
                        <li v-for="(item,index) in gameArr" :key="index">
                            <span><img :src="'/static/qxcp/img/homeGame/'+item.icon"></span>
                            <span>{{item.name}}</span>
                ...
                <div class="bg2">
                    <div class="gameContainer2 ">
                        ...
                        :key="i">
                            <div class="icon" @click="$router.push(item.link)" style="cursor:pointer">
...
export default {
    ...
    data() {
        return {
            ...
            gameList1: [
                ...
                name: "电子游艺",
                text: "SLOT GAMES",
                bgImg: "/static/qxcp/img/gameBg4.png",
                img: "/static/qxcp/img/game4.png",
                link:"/home/slot?navid=9&id=0",
                content:
                    "全网最全电子游艺，汇聚世界顶级电子游艺平台，画质高清，玩法多样，亿元累计彩池，大奖一触即发！",
                games: [
                    { icon: "/static/qxcp/img/LG_MGWBDZ.png", name: "MG电子", link: "/home/slot?navid=9&id=10022" },
                    { icon: "/static/qxcp/img/LG_CQ.png", name: "CQ9电子", link: "/home/slot?navid=9&id=10018" },
                    {
                    icon: "/static/qxcp/img/LG_JDB_DZ_LHJ.png",
                    name: "JDB电子",
                    link: "/home/slot?navid=9&id=10021",
                    },
                    { icon: "/static/qxcp/img/LG_FGDZ.png", name: "FG电子", link: "/home/slot?navid=9&id=10020" },
                    { icon: "/static/qxcp/img/LG_AGDZ.png", name: "AG电子", link: "/home/slot?navid=9&id=10015" },
                    {
                    icon: "/static/qxcp/img/LG_BBINDZ.png",
                    name: "BBIN电子",
                    link: "/home/slot?navid=9&id=10016",
                    },
                    { icon: "/static/qxcp/img/a15.png", name: "MORE", link: "/home/slot?navid=9&id=0" }
                ]
                },
                {
                name: "棋牌游戏",
                text: "CHESS GAMES",
                bgImg: "/static/qxcp/img/gameBg5.png",
                img: "/static/qxcp/img/game5.png",
                link:"/home/chess?navid=9&id=0",
                content:
                    "全网最全棋牌游戏，汇聚世界顶级棋牌游戏平台，画质高清，玩法多样，亿元累计彩池，大奖一触即发！",
                games: [
                    { icon: "/static/qxcp/img/LG_KYQP.png", name: "开元棋牌", link: "/home/chess?navid=9&id=10042" },
                    {
                    icon: "/static/qxcp/img/LG_SSOCHESS.png",
                    name: "乐游棋牌",
                    link: "/home/chess?navid=9&id=10612"
                    },
                    {
                    icon: "/static/qxcp/img/10694.png",
                    name: "天游棋牌",
                    link: "/home/chess?navid=9&id=10694"
                    },
                    { icon: "/static/qxcp/img/LG_FGQP.png", name: "FG棋牌", link: "/home/chess?navid=9&id=10732" },
                    { icon: "/static/qxcp/img/LG_VG.png", name: "VG棋牌", link: "/home/chess?navid=9&id=10041" },
                    {
                    icon: "/static/qxcp/img/LG_ZILLIONAIRE.png",
                    name: "大富翁棋牌",
                    link: "/home/chess?navid=9&id=11759"
                    },
                    { icon: "/static/qxcp/img/a15.png", name: "MORE", link: "/home/chess?navid=9&id=0" }
                ]
                }
            ],
            gameList2:[
                ...
                name: "捕鱼游戏",
                text: "FISHNG",
                bgImg: "/static/qxcp/img/bg5.png",
                img: "/static/qxcp/img/pic11.png",
                link:"/home/fish?navid=9&id=0",
                },
                {
                name: "体育赛事",
                text: "SPORTS",
                bgImg: "/static/qxcp/img/bg3.png",
                img: "/static/qxcp/img/pic9.png",
                link:"/home/tiyu?id=0",
                },
                {
                name: "彩票游戏",
                text: "LOTTERY",
                bgImg: "/static/qxcp/img/bg4.png",
                img: "/static/qxcp/img/pic10.png",
                link:"#/plays/hall"
                }
            ],
            rollList: [
                {
                    ...
                    id: '10694',
                    class: 'ly',
                    img: '/static/qxcp/img/gamelist/navicon/ly.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '11320',
                    class: 'pg',
                    img: '/static/qxcp/img/gamelist/navicon/pg.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10015',
                    class: 'ag',
                    img: '/static/qxcp/img/gamelist/navicon/ag.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10016',
                    class: 'bbin',
                    img: '/static/qxcp/img/gamelist/navicon/bbin.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10018',
                    class: 'cq9',
                    img: '/static/qxcp/img/gamelist/navicon/cq9.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10019',
                    class: 'dt',
                    img: '/static/qxcp/img/gamelist/navicon/dt.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10020',
                    class: 'fg',
                    img: '/static/qxcp/img/gamelist/navicon/fg.png',
                    list: [
                ...
                
                {
                    ...
                    id: '10021',
                    class: 'jdb',
                    img: '/static/qxcp/img/gamelist/navicon/jdb.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10022',
                    class: 'mg',
                    img: '/static/qxcp/img/gamelist/navicon/mg.png',
                    list: [
                ...
                
                {
                    ...
                    id: '10023',
                    class: 'mw',
                    img: '/static/qxcp/img/gamelist/navicon/mw.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10024',
                    class: 'pt',
                    img: '/static/qxcp/img/gamelist/navicon/pt.png',
                    list: [
                ...
                
                {
                    ...
                    id: '10042',
                    class: 'ky',
                    img: '/static/qxcp/img/gamelist/navicon/ky.png',
                    list: [
            ...
            caipiaoList:[
                {img:"/static/qxcp/img/27.png",name:"快速快3",id:27},
                {img:"/static/qxcp/img/10045.png",name:"快乐飞艇",id:10045},
                {img:"/static/qxcp/img/18.png",name:"快速六合彩",id:18},
                {img:"/static/qxcp/img/16.png",name:"快速时时彩",id:16},
                {img:"/static/qxcp/img/12.png",name:"快速赛车",id:12},
                {img:"/static/qxcp/img/3630.png",name:"幸运赛车",id:3630},
                {img:"/static/qxcp/img/3631.png",name:"3分快3",id:3631},
                {img:"/static/qxcp/img/17.png",name:"3分时时彩",id:17},
                {img:"/static/qxcp/img/10044.png",name:"香港赛马",id:10044},
                {img:"/static/qxcp/img/7.png",name:"广东11选5",id:7},
                {img:"/static/qxcp/img/9.png",name:"江苏快3",id:9},
                {img:"/static/qxcp/img/13.png",name:"快乐赛车",id:13},
            ],
            setting: {
                autoplay: true,
                loop: true,
            ...
            // 轮播名单
            carouselData: [
                // {img:"/static/qxcp/img/home/banner1.jpg"},
                // {img:"/static/qxcp/img/home/banner2.jpg"},
                // {img:"/static/qxcp/img/home/banner3.jpg"},
                // {img:"/static/qxcp/img/home/banner4.jpg"},
                // {img:"/static/qxcp/img/home/banner5.jpg"},
                // {img:"/static/qxcp/img/home/banner6.jpg"},
            ],
    ...
    methods: {
        ...
        godown(){
            window.open('/static/qxcp/html/download/index.html')
        },
        loginGame(item){
...
.hty-new-index {
    ...
    min-width: 1200px;
    margin: 0 auto;
    background: url('/static/qxcp/img/bg.jpg') center top no-repeat;
    ...
    .notice span {
        ...
        i{
            ...
            background: url('/static/qxcp/img/jingling.png') no-repeat;
            width: 25px;
            height: 24px;
    ...
    .wp {
        ...
        .first_part{
                ...
                .super_award {
                    ...
                    .award_num {
                        ...
                        li {
                            ...
                            background: url('/static/qxcp/img/num_bg.webp') no-repeat center center;
            ...
            .part_right{
                span{
                    ...
                    &:nth-child(2){
                        background: url('/static/qxcp/img/zhifubao.webp') no-repeat;
                        background-position: 9px 6px;
                        margin-left: 20px;
                    }
                    &:nth-child(3){
                        background: url('/static/qxcp/img/weixin.webp') no-repeat;
                        background-position: 9px 6px;
                    }
                    &:nth-child(4){
                        background: url('/static/qxcp/img/yinlian.webp') no-repeat;
                        background-position: 9px 6px;
                    }
                    &:nth-child(5){
                        background: url('/static/qxcp/img/kuaisu.webp') no-repeat;
                        background-position: 9px 6px;
                    }
                }
            }
        ...
        .game_nav {
            ...
            .arrow {
                ...
                &.prev {
                    z-index: 999;
                    left: 0;
                    // background-image: url(/static/qxcp/img/prev.png);
                    // &:hover {
                ...
                &.next {
                    right: 0;
                    // background: url(/static/qxcp/img/next.png);
                    // &:hover {
                    //     background-position: center bottom;
                    //     background: url(/static/qxcp/img/next.png);
                    // }
                ...
                .tempWarp {
                    ...
                    #game_list {
                        ...
                        li {
                            ...
                            &.ae:before {
                                background: url(/static/qxcp/img/ae.png) no-repeat center center;
                                background-size: contain;
                                height: 30px;
                            }
                            &.ag:before {
                                background: url(/static/qxcp/img/ag.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.bbin:before {
                                background: url(/static/qxcp/img/bbin.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.cq9:before {
                                background: url(/static/qxcp/img/cq9.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.dt:before {
                                background: url(/static/qxcp/img/dt.png) no-repeat center center;
                                background-size: contain;
                                height: 34px;
                            }
                            &.fg:before {
                                background: url(/static/qxcp/img/fg.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.jdb:before {
                                background: url(/static/qxcp/img/jdb.png) no-repeat center center;
                                background-size: contain;
                                height: 30px;
                            }
                            &.mg:before {
                                background: url(/static/qxcp/img/mg.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.mw:before {
                                background: url(/static/qxcp/img/mw.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.pt:before {
                                background: url(/static/qxcp/img/pt.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.ky:before {
                                background: url(/static/qxcp/img/ky.png) no-repeat center center;
                                background-size: contain;
                                height: 32px;
                            }
                            &.vg:before {
                                background: url(/static/qxcp/img/vg.png) no-repeat center center;
                                background-size: contain;
                                height: 26px;
                            }
                            &.ly:before {
                                background: url(/static/qxcp/img/ly.png) no-repeat center center;
                                background-size: contain;
                                height: 32px;
                            }
                            &.pg:before {
                                background: url(/static/qxcp/img/pg.png) no-repeat center center;
                                background-size: contain;
                                height: 22px;
                            }
                            &.ttg:before {
                                background: url(/static/qxcp/img/ttg.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.ttg:before {
                                background: url(/static/qxcp/img/ttg.png) no-repeat center center;
        ...
        .third_part{
            ...
            .bg2{
                width: 100%;
                background: url('/static/qxcp/img/bg_3.png')no-repeat;
            ...
            .gameContainer2 {
                ...
                .title {
                    ...
                    font-size: 10px;
                    line-height: 12px;
                    // background: url(/static/qxcp/img/bg6.png) 50% no-repeat;
                    }
                }
                .index_layer3{
                    display: flex;
                                ...
                                .text_Top {
                                    ...
                                    a{
                                        ...
                                        &.playBtn {
                                            ...
                                            font-size: 20px;
                                            color:#FFD053;
                                            background: url(/static/qxcp/img/play.png) 100px no-repeat;
                                            text-indent: 40px;
                                            font-weight: 700;
