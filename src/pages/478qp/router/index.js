...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/478qp/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/478qp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/478qp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/478qp/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/478qp/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/478qp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/478qp/home/youhui/index')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/478qp/home/register')), 'register')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/478qp/home/help/About/index')), 'about')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/478qp/home/tiyu/index')), 'tiyu')
const vp_caipiao = r => require.ensure([], () => r(require('@/pages/478qp/home/caipiao/index')), 'caipiao')
