    ...
    methods: {
        ...
        async advantageClick(advanItem) {
            if (advanItem == 'tryplay') {
                window.open('/static/478qp/html/active/jiebei/index.html');
            }
        },
        async tryPlay() {
...
.qy-service {
    ...
    .service {
        div {
            background: url('/static/478qp/img/thirdparty/kefu.png');
        }
    }
    .by-service {
        div {
            background: url(/static/478qp/img/thirdparty/by-kefu.png);
        }
    }

    .cs-mail {
        div {
            background: url('/static/478qp/img/thirdparty/tousu.png');
        }
        .shrink {
            right: 70px;
    ...
    .Agency {
        div {
            background: url(/static/478qp/img/thirdparty/daili.png);
        }
    }
    .xl {
        div {
            background: url(/static/478qp/img/thirdparty/xl.png);
        }
    }
    .jiebei {
        div {
            background: url('/static/478qp/img/thirdparty/jiebei.png');
        }
    }

    .gold_housekeeper {
        div {
            background: url('/static/478qp/img/thirdparty/jinguanjia.png');
        }
    }

    .download {
        div {
            background: url('/static/478qp/img/thirdparty/download.png');
        }
    }

    .cs-goTop {
        div {
            background: url('/static/478qp/img/thirdparty/zhiding.png');
        }
    }
}
.new2019 {
    ...
    width: 230px;
    height: 230px;
    background-image: url('/static/478qp/img/new2019.gif');

    .clBtn {
        background: url('/static/478qp/img/new2019_close.png');
        z-index: 99999;
        position: absolute;
        width: 23px;
        height: 23px;
