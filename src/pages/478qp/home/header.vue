<template>
    <div class="new-header view view-slideup on">
        ...
        <div class="header-top" :class="{night:colorbool}">
            ...
            <div class="login">
                <div class="sj">
                    <img src="/static/478qp/img/logo/Homelogo.png" alt="" style="height:50px;margin-top:10.5px">
        ...
        .login {
            ...
            .sj {
                ...
                .class1 {
                    ...
                    background-image: url('/static/478qp/img/logo/1.png');
                    background-size: 100%;
                ...
                .class2 {
                    ...
                    height: 45px;
                    animation: mytwo 2s;
                    background-image: url('/static/478qp/img/logo/2.png');
                    background-size: 100%;
                    background-repeat: no-repeat;
                    margin-left: -8px;
                }
