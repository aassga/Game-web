<template>
    <div class="header index-header">
        ...
        <div class="headerTop">
            <div class="w1000">
                <div class="toplink">
                    <img src="/static/amvnsr/img/china.png" alt="" style="vertical-align: middle;margin-top: -3px;">
            ...
            <div class="main_content">
                ...
                <ul class="navBar">
                    <li class="tpT" v-for="(item,i) in classifyList" :key="i" :class="[{isColor:item.hotShow ==true},item.className,item.text]" @click.stop="$goPath('one',item)">
                        <img src="/static/amvnsr/img/home/hot.gif" class="ico" alt v-if="item.hotShow">
...
export default {
    ...
    data() {
        return {
            ...
            headerImg: '/static/amvnsr/img/tiger.jpg',
            time: '',
            lantern: '',
            isShow: true,
            showLittlePic: true,
    ...
    methods: {
        ...
        goHeader(typeNum) {
            if (typeNum == 0) {
                ...
                window.open('/static/amvnsr/html/download/index.html');
            } else if (typeNum == 5) {
...
.index-header {
      ...
      .indexBannercon {
        ...
        #loginForms {
          ...
          .indexLogin {
            ...
            padding-top: 28px;
            &.withCode {
              background: url(/static/amvnsr/img/login/with_code.png) no-repeat;
              .subbtn {
                bottom: 10px;
              }
            }
            &.noCode {
              background: url(/static/amvnsr/img/login/no_code.png) no-repeat;
              .subbtn {
                bottom: 64px;
              }
            }
            ...
            .title {
              ...
              height: 24px;
              margin-bottom: 12px;
              background: url(/static/amvnsr/img/login/title.png) center center
                no-repeat;
            }
            p {
              width: 82%;
              ...
              &.username_box {
                margin-bottom: 10px;
                background: url(/static/amvnsr/img/login/user_input.png)
                  no-repeat center center;
              }
              &.pwd_box {
                background: url(/static/amvnsr/img/login/pwd_input.png)
                  no-repeat center center;
              }
              &.code_box0 {
                height: 48px;
            ...
            .button {
              ...
              a {
                ...
                &.login_btn {
                  text-decoration: none;
                  background: url(/static/amvnsr/img/login/login_btn.png)
                    no-repeat center center;
                ...
                &.forget {
                  background: url(/static/amvnsr/img/login/forget_pwd.png)
                    no-repeat center center;
                  background-size: contain;
                }
              }
            ...
            .register_btn {
              display: block;
              background: url(/static/amvnsr/img/login/register_btn.png)
                no-repeat center center;
              width: 83%;
              height: 42px;
              background-size: contain;
        ...
        .main_content {
            ...
            .top_left {
                ...
                .logo {
                    ...
                    height: 167px;
                    width: 176px;
                    background: url(/static/amvnsr/img/home/logo.png) no-repeat center;
                    background-size: 100%;
                }
            }
            .navBar {
    ...
    .headerLogin {
        ...
        #loginForm {
            ...
            .headerLogincon {
                ...
                .forget {
                    background: url(/static/amvnsr/img/forget.png) no-repeat;
                    width: 60px;
                    height: 32px;
                    display: block;
                    float: left;
                ...
                .subbtn {
                    background: url(/static/amvnsr/img/subbtn.png) no-repeat;
                    width: 130px;
                    height: 34px;
                    border: none;
                    padding: 0;
                ...
                .regbtn {
                    background: url(/static/amvnsr/img/regbtn.png) top center no-repeat;
                    width: 130px;
                    height: 34px;
                    display: block;
                    float: left;
                ...
                span {
                    ...
                    &.refresh_balance {
                        .refresh {
                            ...
                            width: 22px;
                            height: 20px;
                            background: url('/static/amvnsr/img/refresh.png') center center no-repeat;
                            margin-top: 17px;
                        }
                        .newfresh {
                            background: url('/static/amvnsr/img/newfresh.png') no-repeat center;
                        }
                        .fres {
                            -webkit-animation: spin 1s linear;
                            animation: spin 1s linear;
                ...
                span {
                    a {
                        ...
                        &.logOut {
                            ...
                            text-align: center;
                            color: #000;
                            background: url(/static/amvnsr/img/log_out.png) center center no-repeat;
                            background-size: contain;
                        }
                    }
                }
    ...
    .notice {
        ...
        .w1000 {
            ...
            span {
                font-size: 12px;
                background: url(/static/amvnsr/img/notice.png) left center no-repeat;
                padding-left: 30px;
                width: 128px;
                float: left;
                display: block;
...
.navBar .subnav .jt {
    background: url(/static/amvnsr/img/menujt.png) no-repeat;
    height: 5px;
    width: 9px;
    display: block;
    margin: 0 auto;
