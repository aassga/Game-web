<template>
    <div class="amvnsrNewIndex" :style="{marginTop: loggedIn ? '-90px' : '0'}">
        <!-- 登录框 滚动到一定距离显示 -->
                    ...
                    <div class="tempWarp">
                        <ul id="game_list" :style="{width:rollList.length*120+'px',left:0}" ref="gameList">
                            <li v-for="(item,index) in rollList " :key="index"
                                :style="{backgroundImage:'url(/static/amvnsr/img/image/game/'+item.id+'.png)'}" @click="goto(item)">
                                {{item.name}}
                                <i class="hover_bg"></i>
                            </li>
                        </ul>
...
export default {
  data() {
    return {
      codeImg: "/static/amvnsr/img/new_games/lo.png",
      lanternData: "",
      loggedIn: false,
      showLoginBox: false,
      carheight: 599,
...
.amvnsrNewIndex {
    ...
    #loginForm {
      ...
      .headerLogincon {
        ...
        .logBut {
          ...
          &.subbtn1 {
            color: #fff;
            background: url(/static/amvnsr/img/login/login_btn2.png) no-repeat
              center;
            &:hover {
          ...
          &.regbtn1 {
            ...
            color: #3f3d0a;
            font-weight: bold;
            background: url(/static/amvnsr/img/login/reg_btn2.png) no-repeat
              center;
            :hover {
              filter: grayscale(0.2);
            }
        ...
        span {
          ...
          &.refresh_balance {
            .refresh {
              ...
              width: 22px;
              height: 20px;
              background: url("/static/amvnsr/img/login/refresh.png") center
                center no-repeat;
              margin-top: 17px;
            }
            .newfresh {
              background: url("/static/amvnsr/img/login/newfresh.png") no-repeat
                center;
            }
            .fres {
        ...
        span {
          a {
            ...
            &.logOut {
              ...
              text-align: center;
              color: #000;
              background: url(/static/amvnsr/img/login/log_out.png) center
                center no-repeat;
  ...
  .dianziPart {
    ...
    .game_nav {
      ...
      .arrow {
        ...
        &.prev {
          left: 0;
          background-image: url(/static/amvnsr/img/home/prev.png);
        }

        &.next {
          right: 0;
          background-image: url(/static/amvnsr/img/home/next.png);
        }
      }
          ...
          #game_list {
            ...
            li {
              ...
              .hover_bg {
                ...
                right: 0;
                bottom: 0;
                background: url(/static/amvnsr/img/home/hover.png) no-repeat
                  center;
                opacity: 0;
  ...
  .cont {
    height: 716px;
    position: relative;
    background: url("/static/amvnsr/img/home/bottom_nav/bottom_bg.jpg");
    ...
    .inner {
      ...
      .ng-scope {
        ...
        li {
          ...
          cursor: pointer;
          &.game {
            background-image: url("/static/amvnsr/img/home/casino_slot.jpg");
            background-size: cover;
          }
          &.live {
            background-image: url("/static/amvnsr/img/home/casino_live.jpg");
            background-size: cover;
          }
          &.board {
            background-image: url("/static/amvnsr/img/home/casino_board.jpg");
            background-size: cover;
          }
          &.fish {
            background-image: url("/static/amvnsr/img/home/casino_fish.jpg");
            background-size: cover;
          }
        }
        li:hover {
      ...
      .home-info {
        ...
        li {
          ...
          &.mobile {
            height: 420px;
            margin-bottom: 10px;
            background: url("/static/amvnsr/img/home/info_moblie.png") no-repeat;
            background-size: contain;
          }
          &.qrcode {
            height: 204px;
            padding: 23px 53px 56px 46px;
            background: url("/static/amvnsr/img/home/infor_qr.png") no-repeat;
            background-size: contain;
            display: flex;
            justify-content: space-between;
            align-items: center;
