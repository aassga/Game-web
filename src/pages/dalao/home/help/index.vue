<template>
  <div class="help">
    <div class="wrapper">
      <div :style="{display:$route.params.p_id==0 ? 'block':'none'}" class="page">
        <div class="title">存款帮助</div>
        <div class="article">
          <p>
            一、公司入款:（赠送存款金额1.0%）强烈推荐使用</p>
          <p>
            <br>
            1. 会员登入后点击 【充值】，选择【网银转帐】<br>
            2. 请选择欲使用的银行卡。<br>
      ...
      <div :style="{display:$route.params.p_id==1 ? 'block':'none'}" class="page">
        ...
        <div class="article">
          <p align="left">
            彩票网的客服中心全年无休，提供1周7天、每天24小时的优质服务。</p>
          <p align="left">
            如果您对本网站的使用有任何疑问，可以透过下列任一方式与客服人员联系，享受最实时的服务</p>
          <p align="left">
            点击"在线客服"链接，即可进入在线客服系统与客服人员联系。</p>
          <p align="left">
            您亦可使用Email与客服人员取得联系</p>
          <p align="left">
            会员邮箱:dlcp@tgjt888.com</p>
        </div>
      </div>
