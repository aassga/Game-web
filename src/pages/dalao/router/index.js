...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/dalao/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/dalao/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/dalao/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/dalao/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/dalao/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/dalao/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/dalao/home/qipai')), 'vpQipai')
const vpSport = r => require.ensure([], () => r(require('@/pages/dalao/home/sport')), 'vpSport')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/dalao/home/register')), 'register')
const agent = r => require.ensure([], () => r(require('@/pages/dalao/home/agent')), 'agent')

// 帮助
const vpHomeHelp = r => require.ensure([], () => r(require('@/pages/dalao/home/help')), 'vpHomeHelp')
