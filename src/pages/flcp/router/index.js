...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/flcp/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/flcp/home')), 'vpHome')

const vpYouhui = r => require.ensure([], () => r(require('@/pages/flcp/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/flcp/home/register')), 'register')
const login = r => require.ensure([], () => r(require('@/pages/flcp/home/login')), 'login')
const help = r => require.ensure([], () => r(require('@/pages/flcp/home/help')), 'help')
const moblie = r => require.ensure([], () => r(require('@/pages/flcp/home/moblie')), 'moblie')
const vpCaipiao = r => require.ensure([], () => r(require('@/pages/flcp/home/caipiao')), 'vpCaipiao')
const vpQipai = r => require.ensure([], () => r(require('@/pages/flcp/home/qipai')), 'vpQipai')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/flcp/home/home-contactUs')), 'vpHomeContactUs')
...
const router = new Router({
  routes: [{
    ...
    children: [
      ...
      {
        path: '/home/contactUs/:p_id',
        name: 'contactus',
        component: vpHomeContactUs,
      },
      {
        path: '/home/register',
        component: register,
