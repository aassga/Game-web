<template>
    <div class="wbw-register">
        ...
        <ul class="regMain">
            ...
            <li>
                <span>密码：</span>
                <input type="password" placeholder="密码（8-20位数字或字母）" autocomplete="off" class="userInput" v-model="password" minlength="8"
                    maxlength="20">
            </li>
            <!-- 确认密码 -->
            <li>
                <span>重复密码：</span>
                <input type="password" placeholder="密码（8-20位数字或字母）" autocomplete="off" class="userInput" v-model="password_confirmation"
                    maxlength="20">
            </li>
            <!-- 手机号等信息 -->
...
.wbw-register {
    ...
    padding-top: 20px;
    font-size: 14px;
    background: url('../../../../static/flcp/img/home/loginBg.png') no-repeat 450px 220px #fff;
