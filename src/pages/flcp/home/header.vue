    ...
    <div class="w-header">
        ...
        <div class="header-top">
            <div class="container-top">
                <div class="snavAll">
                    Hi，欢迎来到<span>福利</span>彩票!
                </div>

                <!-- 登录前 -->
                <ul class="snavInfo" v-if="!$store.state.mainState.loginOrout">
            ...
            <div class="container">
                ...
                <h3>
                    <router-link to="/home" class="router-link-exact-active curr">
                        <img src="../../../../static/flcp/img/home/logo1.png">
                    </router-link>
                </h3>

                <!-- 导航 -->
                <ul>
                    <li v-for="(item,i) in navDate" :key="i">
                        <a @click="$goPath('one',item)" :class="item.class">{{item.name}}</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="asideNav">
            <span @click="changeTarget('1')">
                <img src="/static/flcp/img/home/bag.png">
                <span>红包</span>
            </span>
            <!-- <span @click="changeTarget('2')">
                <img src="/static/flcp/img/home/secrit.png">
                <span>密聊</span>
            </span> -->
            <span @click="changeTarget('2')">
                <img src="/static/flcp/img/home/help.png">
                <span>长龙</span>
            </span>
            <span @click="changeTarget('5')">
                <img src="/static/flcp/img/home/yh.png">
                <span>活动</span>
            </span>
            <span @click="changeTarget('4')">
                <img src="/static/flcp/img/home/app.png">
                <span>APP</span>
            </span>
            <span @click="changeTarget('3')">
                <img src="/static/flcp/img/home/server.png">
                <span>客服</span>
            </span>
        </div>
    </div>
...
export default {
    data() {
        return {
            ...
            navDate: [
                ...
                { name: '棋牌游戏', class: 'chess', link: '/home/qipai' },
    ...
    methods: {
        ...
        changeTarget(num){
            switch (num) {
                case '1':
                    //  this.$router.push({ path: "/home/qipai" });
                     window.open('/static/flcp/html/active/czjhb/index.html')
                    break;
                case '2':
                    if (localStorage.token) {
                        // window.open('/#/plays/hall');
                        this.$router.push({ path: "/plays/tradition/99996" });
                    } else {
                         this.$store.commit('alert/showTipModel', {
                        bool: true,
                        title: '请先登录',
                ...
                case '3':
                    ...
                    break;
                case '4':
                    window.open("/static/flcp/html/download/index.html")
                    break;
                 case '5':
...
.asideNav{
    ...
    span{
        ...
        span{
            ...
            height: 33px;
            text-align: center;
            transition: width 1s,opacity 4s linear;
            font-size: 12px;
            z-index: -1!important;
            line-height: 30px;
            text-align: center;
            transition: width 1s;
            z-index: -1!important;
            background-image: linear-gradient(to left,  #d0d2d4, #fff);
        }
        &:hover{
            span{
                display: inline-block;
...
.w-header {
    ...
    .menu-child1 {
        ...
        *min-height: 564px;
        ...
        .triangles_back {
            ...
            height: 19px;
            position: absolute;
            background: url(/static/flcp/img/triangles_back.png) no-repeat;
            left: 125px;
            top: -8px;
        }
        ...
        .items {
            ...
            .item {
                ...
                .item-ico {
                    ...
                    color: #222;
                    text-align: center;
                    background: url(/static/flcp/img/game-icon-bg.png) no-repeat;
                    overflow: hidden;
                ...
                &:hover {
                    background: url(/static/flcp/img/Wbg_03.png) repeat;
                }
    ...
    .header-top {
        ...
        .snavInfo {
            ...
            .ServiceBtn {
                background: url('/static/flcp/img/home/service.gif');
