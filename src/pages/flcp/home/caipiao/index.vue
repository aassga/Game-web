    ...
    <div class="wrap lotteryNav">
      ...
      <ul>
        <li v-for="(navItem,index) in navCont" :key="index">
          <span v-if="navItem.id == 2 || navItem.id == 5 || navItem.id == 7 || navItem.id == 10" class="stopSale"><img width="65px" src="/static/flcp/img/home/stopsale.png"></span>
          <a>
            <!-- <img :src="'/static/public/image/lottery/ico/vp-' + navItem.name + '.png' " alt> -->
            <img :src="navItem.id|capitalize" alt>
            <div style="marginTop:23px;" v-if="!navItem.issue">
              <h4>{{navItem.name}}</h4>
            </div>
            <div v-else>
              <h4>{{navItem.name}}</h4>
...
export default {
  data() {
    return {
      carouselData: [
        "/static/flcp/img/banner1.png",
        "/static/flcp/img/banner2.png"
      ],
      // 滚动名单
      random: [
        {
        ...
        },
        {
          account: "",
          name: "快速快3",
          ico: "/static/public/image/lottery/nico/png/27.png",
          out: 0
        },
        {
          account: "",
          name: "3分时时彩",
          ico: "/static/public/image/lottery/nico/png/17.png",
          out: 0
        },
        {
          account: "",
          name: "快乐飞艇",
          ico: "/static/public/image/lottery/nico/png/10045.png",
          out: 0
        },
        {
          account: "",
          name: "幸运赛车",
          ico: "/static/public/image/lottery/nico/png/3630.png",
          out: 0
        },
        {
          account: "",
          name: "快乐赛车",
          ico: "/static/public/image/lottery/nico/png/13.png",
          out: 0
        },
        {
          account: "",
          name: "香港赛马",
          ico: "/static/public/image/lottery/nico/png/10044.png",
          out: 0
        },
        {
          account: "",
          name: "3分快3",
          ico: "/static/public/image/lottery/nico/png/3631.png",
          out: 0
        },
        {
          account: "",
          name: "5分六合彩",
          ico: "/static/public/image/lottery/nico/png/19.png",
          out: 0
        },
        {
          account: "",
          name: "5分快3",
          ico: "/static/public/image/lottery/nico/png/3632.png",
          out: 0
        },
        {
          account: "",
          name: "江苏快3",
          ico: "/static/public/image/lottery/nico/png/9.png",
          out: 0
        },
        {
          account: "",
