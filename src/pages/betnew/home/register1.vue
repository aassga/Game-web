...
.register {
    ...
    .wrapperbox {
        ...
        .registerBanner {
            width: 100%;
            height: 250px;
            background: url(/static/betnew/img/8.jpg) no-repeat -5px center;
        ...
        .abount-main {
            ...
            .cont-left {
                ...
                li {
                    a {
                        background: url(/static/betnew/img/left_sidbar_bg.png) no-repeat 35px 0px;
                        display: block;
                        width: 100%;
                        height: 23px;
                        line-height: 23px;
...
#ads1 {
    ...
    height: 250px;
    width: 180px;
    background: url(/static/betnew/img/ads1.jpg) no-repeat;
