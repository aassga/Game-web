...
.home-help {
    background: url(/static/betnew/img/bg-page.jpg) no-repeat center 0;
    background: #fff;
    padding-bottom: 15px;
    ...
    .container {
        ...
        .helpSlider {
            ...
            float: left;
            height: 268px;
            background: url(/static/betnew/img/aside.png) no-repeat center;
            ...
            .helpMenu {
                ...
                li:hover {
                    background: url(/static/betnew/img/aside-nav.png);
                }
