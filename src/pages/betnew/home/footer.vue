        ...
        <div class="first-footer-wrap">
            <div class="footer-top-wrap clearfix">
                <div class="footer-top-left">
                    ...
                    <div class="copyright">2001-2021 bet365。版权所有。</div>
...
.footers {
    ...
    .footer-bg {
        height: 2px;
        width: 100%;
        background: url(/static/betnew/img/home/footer_bg.png) repeat-x 0% 0%;
    }
    .footer-newbg {
        height: 2px;
        width: 960px;
        ...
        .footer-top-wrap {
            ...
            .footer-top-left {
                ...
                .gohome {
                    ...
                    font-size: 12px;
                    height: 29px;
                    background: url(/static/betnew/img/home/footer_common_btn.png) no-repeat 0% 0%;
                    text-align: center;
                    line-height: 29px;
                    font-size: 12px;
                    text-align: center;
            ...
            .footer-top-right {
                ...
                #bblogo {
                    ...
                    width: 113px;
                    height: 46px;
                    background: url(/static/betnew/img/home/bbinlogo.png);
                }
                #browser-logo {
                    display: inline-block;
                    margin-left: 33px;
