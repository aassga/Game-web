                    ...
                    <ul>
                      <li v-for="(childItem,childIndex) in navItem.list" :key="childIndex" @click.stop="$goPath('nav',childItem)">
                        <a href="javascript:void(0)">
                          <span>{{childItem.name =='188体育'?'365体育':childItem.name}}</span>
                        </a>
                      </li>
                    </ul>
                  </div>
...
export default {
  ...
  data() {
    return {
      ...
      showfresh:false,
      allUnReadCount:10,
       codeImg:"/static/betnew/img/new_games/lo.png",
       newmodal:{
          title:"来自bet365的消息",
          bgcolor:{
  ...
  methods: {
    ...
    goDownloadPage(){
      window.open('/static/betnew/html/download/index.html','_blank')
    },
    register() {
...
.header_box_inner{
  ...
  .header-top-wrap {
          ...
          .ele-acc-unit {
            ...
            #_bbsportBalance {
              ...
              .refresh{
                 ...
                 width: 15px; 
                 height: 15px;
                 background: url(/static/betnew/img/home/refresh.png);
                 position:relative;
                 top:2px
              }
              .newfresh{
                background: url(/static/betnew/img/home/newrefresh.png);
              }
            }
          }
        }
    ...
    .header-top-left-time{
        ...
        color: #85b9ab;
        padding-left: 30px;
        background: url(/static/betnew/img/zh.png) no-repeat left center;
        font-size: 14px;
    }
  }
  .clearfix {
...
.header_box_middle{
  ...
  .header-logo {
      ...
      margin-left:-20px;
        ...
        background-image: url(/static/betnew/img/home/homeLogo.png);
        background-size: 100%;
...
.header_box_bottom{
  ...
  .news-wrap {
    ...
    .top-link-wrap {
      ...
      .top-service-icon {
        padding-left:20px;
        background:url(/static/betnew/img/kf.png) no-repeat 10px center;
        background-size:18px 20px;
        color: #ffe618;
      }
      .linebg{
        padding-left:20px;
        background:url(/static/betnew/img/jc.png) no-repeat 10px center;
        background-size:18px 20px;
      }
      .downloadBg{
        padding-left:20px;
        background:url(/static/betnew/img/sj.png) no-repeat 10px center;
      }
    }
}
</style>