...
export default {
    ...
    data() {
        return {
            ...
            codeImg: '/static/betnew/img/new_games/log.png',
            tabIndex:1,
...
.register {
    ...
    height: 100%;
    margin: 0 auto;
    background: url(/static/betnew/img/register_bg.png) no-repeat center;
    ...
    .service{
        ...
        span{
            ...
            &:first-child{
                width: 102px;
                height: 102px;
                background: url('/static/betnew/img/ser.png');
    ...
    .content {
        ...
        background: url('/static/betnew/img/form_bg.png');
        background-repeat: no-repeat;
        background-size:100% 100% ;
        position: relative;
        .titleTab{
