...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/betnew/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/betnew/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/betnew/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/betnew/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/betnew/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/betnew/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/betnew/register')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/betnew/home/register1')), 'register1')
const help = r => require.ensure([], () => r(require('@/pages/betnew/home/help/index.vue')), 'help')
const question = r => require.ensure([], () => r(require('@/pages/betnew/home/help/question.vue')), 'question')
const vpQipai = r => require.ensure([], () => r(require('@/pages/betnew/home/qipai')), 'vpQipai')
const vpSport = r => require.ensure([], () => r(require('@/pages/betnew/home/sport')), 'vpSport')
//const register1 = r => require.ensure([], () => r(require('@/pages/betnew/home/register1')), 'register1')
//购彩大厅
