<template>
   <div class="mainboxs">
        ...
        <div class="box">
            <ul id="slider">
                <li v-for="(item,index) in winningInfo" :key="index" @click="loginGame(item.game_name)">
                    <div class="imgBox">
...
.mainboxs {
  ...
  .nav {
    ...
    &.prev {
      left: 0px;
      background:url('/static/public/image/casino/blue_image/left-s.png') center center no-repeat;
      background-size: 15px 25px;
    }
    &.next {
      right: 0px;
        background:url('/static/public/image/casino/blue_image/right-s.png') center center no-repeat;
      background-size: 15px 25px;
    }
    &.prev:hover {
        background:url('/static/public/image/casino/blue_image/left.png') center center no-repeat;
        background-size: 15px 25px;
    }
    &.next:hover {
        background:url('/static/public/image/casino/blue_image/right.png') center center no-repeat;
        background-size: 15px 25px;
    }
  }
}
