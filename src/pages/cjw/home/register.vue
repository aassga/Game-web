...
export default {
  ...
  data() {
    return {
      setInter:null,
      headerImg: '/static/cjw/img/reg/reg-top-bg.jpg',
      AGMoney: 41126438900,
      activeMemberCount:0,
      joinMemberCount:0,
      smsInputBox: {
      ...
      headBg: '/static/cjw/img/reg/reg-top-bg.jpg',
      bgColor:'#47080E'
    };
  },
  mounted() {},
...
.register-area {
  // width: 1920px;
  height: 800px;
  background: url(/static/cjw/img/reg/reg-bg.png) no-repeat center center;
  margin: 0 auto;
  ...
  .content {
    ...
    margin: 20px auto 0;
    position: relative;
    background: url("/static/cjw/img/reg/reg-content-bg.png") no-repeat;
    background-size: 100%;
    .header-img {
      position: absolute;
      top: 38px;
