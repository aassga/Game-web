...
const vpTiyu = r => require.ensure([], () => r(require('@/pages/cjw/home/tiyu')), 'vpTiyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/cjw/home/youhui/index')), 'vpYouhui')
...
// 帮助
const about = r => require.ensure([], () => r(require('@/pages/cjw/home/help/about')), 'about')
const issue = r => require.ensure([], () => r(require('@/pages/cjw/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/cjw/home/help/partner')), 'partner')
const agents = r => require.ensure([], () => r(require('@/pages/cjw/home/help/Agent/index')), 'agent')
// 动画
