  ...
  <div class="help">
    <div class="wrapper">
      ...
      <div :style="{display:$route.params.p_id==2 ? 'block':'none'}" class="page">
        ...
        <div class="article">
          ...
          <ol>
            ...
            <li align="left">彩票网保留权利审核会员帐号，若由最后一次入款起，有效下注金额需达到入款金额的100%，未达到而申请出款者，公司将收取入款金额的30%行政费用，以及$50出款手续费。</li>
          </ol>
      ...
      <div :style="{display:$route.params.p_id==3 ? 'block':'none'}" class="page">
        ...
        <div class="article">
          <ul class="mtab-menual">
            <li @click="tab=1">一般常见问题</li>
            <li @click="tab=2">游戏及投注问题</li>
            <li @click="tab=3">技术常见问题</li>
          </ul>
          <div v-show="tab==1">
            <p>
              Q1: 如何加入彩票网？</p>
            <p align="left">
              A1: 您可以直接点选 立即加入，确实填写资料后，可立即登记成为彩票网会员。<br>
              <br>
              Q2: 我可以直接在网络上存款吗？<br>
              A2: 可以，彩票网提供多种在线存款选择，详情请参照 存款须知。</p>
            <p align="left">
              Q3: 我在那里可以找到游戏的规则？<br>
      ...
      <div :style="{display:$route.params.p_id==4 ? 'block':'none'}" class="page">
        ...
        <div class="article">
          <p><span style="font-family: verdana, geneva, sans-serif">品牌信誉-首选彩票网，<strong><span style="color: #ffff00">最具公信力的博彩公司、更有高质量的游戏平台

                                </span></strong>，彩票网为菲律宾马尼拉注册之博彩公司之一。公司不仅拥有市场上最多元化的游戏投注平台，同时为客户提供实时、刺激、高信誉的服务保证、高质量的游戏平台

                            ，也是公司的首要宗旨。在日渐热络、成熟的网络博彩市场中，除了多元化的游戏外，网络安全最为客户注重，公司针对现阶段网络安全问题，成立了网络安全维护中心，彻底为客户的网络

                            安全解决了后顾之忧，诺顿分级评级审核"彩票网最低存款为$100人民币，最高存款无上限"为最安全网站之一，并获得GEOTRUST国际认证，确保网站公平公正性，所有会员数据均经过加密，保障玩家所有隐私。</span></p>
          <p><strong><span style="font-family: verdana, geneva, sans-serif">诚信为本：</span></strong></p>
          <p><span style="font-family: verdana, geneva, sans-serif">全网最高信誉，从彩票网开始！作为国际专业的网上博彩游戏运营商，我们承诺，为每一位客户提供最安全、最公平的
          ...
          <p><span style="font-family: verdana, geneva, sans-serif">在彩票网的用户都是大赢家，我们将不间断的推出更多优惠，以实际、简单的申请方式迎待各来宾！。</span>
          </p>
          <p><strong><span style="font-family: verdana, geneva, sans-serif">慈善公益</span></strong></p>
          <p><span style="font-family: verdana, geneva, sans-serif">彩票网更肩负起对社会、对慈善公益的责任，也将永不磨灭的针对社会的需要作出更多的贡献。</span>
          </p>
          <p><strong><span style="font-family: verdana, geneva, sans-serif">客户服务：</span></strong></p>
          <p><span style="font-family: verdana, geneva, sans-serif">在竞争激烈的博彩市场中，彩票网向来是众多玩家一致的明理选择，除了有多元化的娱乐产品使人流连忘返、更有高质
          ...
          <p><span style="font-family: verdana, geneva, sans-serif">彩票网提倡有节制的赌博。我们建议阁下遵守以下一些基本规则：</span></p>
          ...
          <p><span style="font-size: 14px"><strong><span style="font-family: verdana, geneva, sans-serif">彩票网更专注于玩家的利益、最给力的优惠活动时时回馈各新老会员用户。

                                    品牌信誉，首选彩票网！</span></strong></span></p><br>
        </div>
      </div>
      <div :style="{display:$route.params.p_id==5 ? 'block':'none'}" class="page">
        ...
        <div class="article">
          <ul class="mtab-menual">
            <li @click="alliance=1">联盟方案</li>
            <li @click="alliance=2">联盟协议</li>
          </ul>
          <div v-show="alliance==1">
            <p>
              彩票网，与AG进行技术合作，拥有菲律宾合法注册之博彩公司。拥有多元化的产品，使用最公平、公正、公开的系统，在市场上的众多博彩网站中，我们自豪的提供会员最优惠的回
              馈，给予合作伙伴最优势的营利回报! 无论您拥有的是网络资源，或是人脉资源，都欢迎您来加入彩票网合作伙伴的行列，无须负担任何费用，就可以开始无上限的收入。彩票网，绝对是您最聪明的选择!</p>
            <p>
              ?注册申请<br>
              ...
              更改银行帐号的,必须提前一个星期联系在线客服进行修改，否则本公司一律不负责。彩票网会评估审核联盟申请讯息，3日内由专员与您联系开通，并提供您的注册帐号、密码及推广链接。</p>
            ...
            <p>
              ...
              <span
                style="color: #ff0000;">●相应费用包括：会员各项优惠、存/取款相应手续费(请留意：彩票网会员重复出款￥手续费/未达100%投注出款的手续费由会员吸收，不纳入计算)。</span><br>
          ...
          <div v-show="alliance==2">
            <p>
              <strong>一、彩票网对代理联盟的权利与义务</strong></p>
            <ol>
              <li align="left">彩票网的客服部会登记联盟的会员并会观察他们的投注状况。联盟及会员必须同意并遵守彩票网的会员条例，政策及操作程序。彩票网保留拒绝或冻结联盟/会员帐号权利</li>
              <li align="left">代理联盟可随时登入接口观察旗下会员的下注状况及会员在网站的活动概况。 彩票网的客服部会根据代理联盟旗下的会员计算所得的佣金。</li>
              <li align="left">彩票网保留可以修改合约书上的任何条例，包括: 现有的佣金范围、佣金计划、付款程序、及参考计划条例的权力，彩票网会以电邮、网站公告等方法通知代理联盟。
                代理联盟对于所做的修改有异议，代理联盟可选择终止合约，或洽客服人员反映意见。 如修改后代理联盟无任何异议，便视作默认合约修改，代理联盟必须遵守更改后的相关规定。
              </li>
            </ol>
            <p align="left">
              <strong>二、代理联盟对彩票网的权力及义务</strong></p>
            <ol>
              <li align="left">
                代理联盟应尽其所能，广泛地宣传、销售及推广彩票网，使代理本身及彩票网的利润最大化。代理联盟可在不违反法律下，以正面形象宣传、销售及推广彩票网，并有责任义务告知旗下会员所有彩票网的相关优惠条件及产品。
              </li>
              <li align="left">代理联盟选择的彩票网推广手法若需付费，则代理应承担该费用。</li>
              <li align="left">任何彩票网相关信息包括: 标志、报表、游戏画面、图样、文案等，代理联盟不得私自复制、公开、分发有关材料，彩票网保留法律追诉权。
                如代理在做业务推广有相关需要，请随时洽彩票网。
              </li>
            </ol>
            <p align="left">
            ...
            <ol>
              <li align="left">
                各阶层代理联盟不可在未经彩票网许可情况下开设双/多个的代理帐号，也不可从彩票网人帐号或相关人士赚取佣金。请谨记任何阶层代理不能用代理帐号下注，彩票网有权终止并封存帐号及所有在游戏中赚取的佣金。
              </li>
              <li align="left">
                为确保所有彩票网会员帐号隐私与权益，彩票网不会提供任何会员密码，或会员个人资料。各阶层代理联盟亦不得以任何方式取得会员数据，或任意登入下层会员帐号，如发现代理联盟有侵害彩票网会员隐私行为，彩票网有权取消代理联盟红利，并取消代理联盟帐号。
              </li>
              <li align="left">
                代理联盟旗下的会员不得开设多于一个的帐号。彩票网有权要求会员提供有效的身份证明以验证会员的身份，并保留以IP判定是否重复会员的权利。如违反上述事项，彩票网有权终止玩家进行游戏并封存帐号及所有于游戏中赚取的佣金
              </li>
              <li align="left">代理联盟不可为自己或其他联盟下的有效投注会员,只能是公司直属下的有效投注会员,
                代理每月需有5个下线有效投注（有效投注为每周至少上线3次进行正常投注），如有违反联盟协议彩票网有权终止并封存帐号及所有在游戏中赚取的佣金。
              </li>
              <li align="left">
                如代理联盟旗下的会员因为违反条例而被禁止享用彩票网的游戏，或彩票网退回存款给会员，彩票网人将不会分配相应的佣金给代理联盟。如代理联盟旗下会员存款用的信用卡、银行资料须经审核，彩票网保留相关佣金直至审核完成。
              </li>
              <li align="left">合约内的条件会以彩票网通知接受代理联盟加入后开始执行。彩票网及代理联盟可随时终止此合约，在任何情况下，代理联盟如果想终止合约，都必须以书面/电邮方式提早于七日内通知彩票网。
                代理联盟的表现会3个月审核一次，如代理联盟已不是现有的合作成员则本合约书可以在任何时间终止。如合作伙伴违反合约条例，彩票网有权立即终止合约。
              </li>
              <li align="left">在没有彩票网许可下，代理联盟不能透露及授权彩票网相关密数据，包括代理联盟所获得的回馈、佣金报表、计算等;代理联盟有义务在合约终止后仍执行机密文件及数据的保密。</li>
              <li align="left">在合约终止后，代理联盟及彩票网将不须要履行双方的权利及义务。终止合约并不会解除代理联盟于终止合约前应履行的义务。</li>
            </ol>
          </div>
        </div>
      </div>
...
<style lang="less" scoped>
  .help {
    background: url(/static/wycp/img/bg_promotions.jpg) center top no-repeat;
    ...
    .wrapper {
      ...
      .page {
        ...
        border: 3px double rgb(162, 47, 40);
        min-height: 700px;
        padding: 40px 60px;
