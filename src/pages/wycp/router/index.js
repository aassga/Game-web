...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/wycp/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/wycp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/wycp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/wycp/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/wycp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/wycp/home/youhui')), 'vpYouhui')
const vpChess = r => require.ensure([], () => r(require('@/pages/wycp/home/qipai')), 'vpChess')
const vpSport = r => require.ensure([], () => r(require('@/pages/wycp/home/sport')), 'vpSport')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/wycp/home/register')), 'register')
const agent = r =>require.ensure([], () => r(require('@/pages/wycp/home/agent')), 'agent')
// 帮助
const vpHomeHelp = r => require.ensure([], () => r(require('@/pages/wycp/home/help')), 'vpHomeHelp')
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/wycp/home/home-contactUs')), 'vpHomeContactUs')
//购彩大厅
