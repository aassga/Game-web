    ...
    <div class="wrapper">
        ...
        <section class="banner-cpyx">
            <!-- <vp-header-pic :headerImg="headBg"></vp-header-pic> -->
             <banView :headerImg="headBg" :picBox='350' isScale='true'></banView>
        </section>
...
export default {
  ...
  data () {
    return {
      ...
      headBg: '/static/jsyl/img/money.jpg',
      lantern: '',
      bannerStyle: {},
      cssStyle: {
        padding: '20px 20px 20px',
        background: 'url(/static/jsyl/img/bg_activity.jpg)',
...
.wrapper {
    .notice {
        ...
        .w1000 {
            ...
            span {
                font-size: 12px;
                background: url(/static/jsyl/img/notice.png) left center no-repeat;
                padding-left: 30px;
                width: 128px;
                float: left;
                display: block;
