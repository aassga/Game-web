    ...
    <div>
        <ul id="TplFloatPic_0" class="TplFloatSet TplFloatPic_1" picfloat="left">
            <div id="adleft" style="display:block;" href="javascript:void(0)">
                <img src="/static/jsyl/img/left.png">
            </div>
            <div class="dz">
        ...
        <ul id="TplFloatPic_1" class="TplFloatSet TplFloatPic_1" picfloat="right">
            <div id="adright" style="display:block;" href="javascript:void(0)"><img src="/static/jsyl/img/right.png"></div>
            <a :href="url" target="_blank" class="kefu-btn"></a>
            <div @click="toService" class="transfer"></div>
            <div class="jiebei" @click="goView"></div>
            <div class="jiance" @click="goView2"></div>
            <!-- <a class="download" href="/static/jsyl/html/download/index.html" target="_blank"></a> -->
...
export default {
    ...
    methods: {
        ...
        goView2() {
           window.open('https://xianludh.github.io/xianluu/js3355/index.html')
        }
    },
    mounted() {
        this.getUrl()
