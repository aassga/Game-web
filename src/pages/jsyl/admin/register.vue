...
export default {
    ...
    data() {
        return {
            codeImg: '/static/jsyl/img/login/code_img.jpg',
            smsInputBox: {
                marginTop: '20px'
            },
            smsCodeWrapper: {
...
.registerContainer {
    ...
    .popup {
        ...
        .headline {
            height: 120px;
            background: url(/static/jsyl/img/login/bg_reg_title.png) no-repeat center;
            ...
            .title_tab {
                ...
                .close1 {
                    ...
                    a {
                        ...
                        width: 26px;
                        height: 26px;
                        background: url(/static/jsyl/img/login/ic_close.png) no-repeat center;
                        background-size: contain;
                    }
                }
            }
