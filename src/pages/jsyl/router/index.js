...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/jsyl/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/jsyl/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/jsyl/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/jsyl/home/games/index.vue')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/jsyl/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/jsyl/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/jsyl/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/jsyl/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')

const register = r => require.ensure([], () => r(require('@/pages/jsyl/home/help')), 'register') //帮助页面
const register1 = r => require.ensure([], () => r(require('@/pages/jsyl/register')), 'register1') //帮助页面
const registerContent = r => require.ensure([], () => r(require('@/pages/jsyl/home/help/register-content')), 'registerContent') //注册模块
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/jsyl/home/help/about-page')), 'vpAboutPage') //关于我们
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/jsyl/home/help/save-help')), 'vpSaveHelp') //存款帮助
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/jsyl/home/help/pull-help')), 'vpPullHelp') //取款帮助
const vpRelation = r => require.ensure([], () => r(require('@/pages/jsyl/home/help/relation')), 'vpRelation') //联系我们
...
const di_fucai3D = r => require.ensure([], () => r(require('@/pages/public/tradition/di-pin-cai/fu-cai-3D')), 'di_fucai3D')
    // 传统彩end
const long_dragon = r => require.ensure([], () => r(require('@/pages/public/tradition/long-dragon/index')), 'long_dragon')
//开奖走势
