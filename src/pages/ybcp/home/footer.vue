...
export default {
  ...
  methods: {
    goHelp(link) {
      this.$store.commit('ybcp/showBanner',{})
  ...
  .footer-top {
    ...
    .list_top {
      ...
      .list_top_contain {
        ...
        .hasimg {
          background-image: url(/static/ybcp/img/home/foot_2.4f06247.png);
          background-size: 100% 100%;
        }
        .hasimg2 {
          background-image: url(/static/ybcp/img/home/foot_2.4f06248.png);
          background-size: 100% 100%;
        }
        .es1 {
          // background-image: url(/static/ybcp/img/home/ewm.png);
          background-size: 100% 100%;
        }
        .foot_button {
          width: 110px;
      ...
      .f-middle-left {
        ...
        ul {
          ...
          li {
            ...
            background: url(/static/ybcp/img/home/footer.e97dc4b.png) no-repeat;
            display: block;
            width: 35px;
            height: 36px;
            a {
