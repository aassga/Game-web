            ...
            <div class="mencen-room">
              <div class="all-room">
                <div class="common-room">
                  <a target="_blank" @click="$goPath('main',item)">进入游戏</a>
                </div>
              </div>
            </div>
          </li>
...
export default {
  data() {
    return {
      imgburl: "/static/ybcp/img/home/lotter",
      gamelist: [
        {
          name: "炸金花",
          ico: "/static/ybcp/img/home/zjh.png",
          rulePath: "/rules/pk10",
        ...
        {
          name: "21点",
          ico: "/static/ybcp/img/home/21d.png",
          rulePath: "/rules/klsf",
        ...
        {
          name: "斗地主",
          ico: "/static/ybcp/img/home/ddz.png",
        ...
        {
          name: "德州扑克",
          ico: "/static/ybcp/img/home/dzpk.png",
        ...
        {
          name: "十三水",
          ico: "/static/ybcp/img/home/sss.png",
        ...
        {
          name: "抢庄牛牛",
          ico: "/static/ybcp/img/home/qznn.png",
        ...
        {
          name: "百家乐",
          ico: "/static/ybcp/img/home/bjl.png",
        ...
        {
          name: "百人牛牛",
          ico: "/static/ybcp/img/home/brdn.png",
      ...
      lotterList: [
        {
          name: "北京赛车PK10",
          text: "超高收益,超大福利",
          src: "/static/ybcp/img/home/lotter1.png",
          router: "#/plays/tradition/2"
        },
        {
          name: "快速赛车PK10",
          text: "轻轻松松,执掌财务",
          src: "/static/ybcp/img/home/lotter2.png",
          router: "#/plays/tradition/12"
        },
        {
          name: "快速快3",
          text: "百万礼券,返现爆款",
          src: "/static/ybcp/img/home/lotter3.png",
          router: "#/plays/tradition/27"
        },
        {
          name: "江苏快三",
          text: "免费筹码,一学就会",
          src: "/static/ybcp/img/home/lotter4.png",
          router: "#/plays/tradition/9"
        },
        {
          name: "快速时时彩",
          text: "惊喜不断,福利只为你",
          src: "/static/ybcp/img/home/lotter5.png",
          router: "#/plays/tradition/16"
        },
        {
          name: "快乐飞艇",
          text: "首创极速服务新体验",
          src: "/static/ybcp/img/home/lotter6.png",
          router: "#/plays/tradition/10045"
        },
        {
          name: "三分快三",
          text: "独家电子优惠券,豪礼送不停",
          src: "/static/ybcp/img/home/lotter7.png",
          router: "#/plays/tradition/3631"
        },
        {
          name: "香港六合彩",
          text: "亿万彩池,等你来挑战",
          src: "/static/ybcp/img/home/lotter8.png",
      ...
      guanfanglist: [
        {
          text: "BBIN电子",
          router: "/home/slot?navid=9&id=10016",
          name: "BBIN老虎机",
          ico: "/static/ybcp/img/home/bbin.png",
          rulePath: "/rules/ssc",
          id: 10016,
          type: {
            list: [
        ...
        {
          text: "AG电子",
          router: "/home/slot?navid=9&id=10015",
          name: "AG老虎机",
          ico: "/static/ybcp/img/home/ag.png",
          id: 10015,
          type: {
            list: [
              { name: "全选", tag: "" },
        ...
        {
          text: "DT电子",
          router: "/home/slot?navid=9&id=10019",
          name: "DT老虎机",
          ico: "/static/ybcp/img/home/dt.png",
          id: 10019,
          type: {
            list: [
              { name: "全选", tag: "" },
        ...
        {
          text: "MG电子",
          router: "/home/slot?navid=9&id=10022",
          name: "MG老虎机",
          ico: "/static/ybcp/img/home/mg.png",
          id: 10022,
          type: {
            list: [
              { name: "全选", tag: "" },
        ...
        {
          text: "PT电子",
          router: "/home/slot?navid=9&id=10024",
          name: "PT老虎机",
          ico: "/static/ybcp/img/home/pt.png",
          id: 10024,
          type: {
            list: [
              { name: "全选", tag: "" },
        ...
        {
          text: "CQ9电子",
          router: "/home/slot?navid=9&id=10018",
          name: "CQ9老虎机",
          ico: "/static/ybcp/img/home/cq9.png",
          id: 10018,
          type: {
            list: [
              { name: "全选", tag: "" },
  ...
  methods: {
    async fetchgames(item) {
      localStorage.hotgame = JSON.stringify(item);
          ...
          this.$store.dispatch('lottery/getStopLotteryCheck',id).then(res=>{
            if(res&&res.length >0 ){
                this.$store.commit('alert/showTipModel', {
                    bool: true,
                    title: "春节期间官方彩暂停销售，预计恢复销售时间2月1日，游戏快速彩击中高额奖池".replace(/，/g,'</br>'),
                    model: 'warn',
                    type:'closeMaret',
                });    
            }else{
              // var newitem=path.split("#")[1]
              //   this.$router.push({
              //   path: newitem
              // }) 
    ...
    goTo(item) {
      ...
      //   // this.dNotify("彩票暂无试玩,立即注册", "error")
      // }
      if (localStorage.Public_User == "v2" && item.router) {
      ...
      .game-type-ol {
        ...
        .list-ol {
          ...
          div:first-child {
            ...
            height: 73px; //71
            margin: 0 auto;
            // background-image: url('/static/ybcp/img/game-pic.3d0dea2.png');
        ...
        .list-ol-li {
          ...
          div:first-child {
            ...
            height: 73px;
            margin: 0 auto;
            // background-image: url('/static/ybcp/img/game-pic1.62dfd19.png');
            -webkit-transition: opacity 0.3s ease-in;
            transition: opacity 0.3s ease-in;
            img {
              width: 100%;
