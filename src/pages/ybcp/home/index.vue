<template>
  <div class="new-index ybcp-home">
    <div class="carouseWrapper">

            <div class="carouse">
                <Carousel autoplay loop style="height:520px;overflow:hidden">
...
import "@/assets/iconfont/ybcp/iconfont.css";
import vpMc from "./mc"
...
export default {
  data() {
    return {
      ...
      showimg: false,
      showPopout: false,
      imgsrc: "/static/ybcp/img/yunshanfu.png",
      imgdata: [
        "/static/ybcp/img/pcAlert1.png",
        "/static/ybcp/img/pcAlert2.png",
        "/static/ybcp/img/pcAlert3.png"
      ],
      popups: "",
      lantern: "",
      value3: 0,
...
.gameWrapper{
  width: 100%;
  background: url(/static/ybcp/img/BG.c87ce40.png) no-repeat;
  background-size: 100%;
}
.alert-img {
...
.new-index {
    ...
    .carouseWrapper{
      height:520px;
      width:100%;
      background: url(/static/ybcp/img/banner_bg.398ffcf.png) no-repeat;
    ...
    .newgong-content {
      ...
      .notice {
        ...
        i {
          ...
          top:9px;
          font-size: 23px;
          background:url(/static/ybcp/img/home/notice.png)no-repeat;
          background-size: 100% 100%;
          display: inline-block;
          width:24px;
          height: 18px;
  ...
  .downLoad-wrap {
    ...
    .jackpots {
      ...
      width: 850px;
      height: 150px;
      background: url("/static/ybcp/img/jackpot_in1.jpg") no-repeat center,
        url("/static/ybcp/img/jackpot_out1.jpg") no-repeat;
      position: relative;
      ...
      @-webkit-keyframes bg {
        ...
        100% {
          background: url("/static/ybcp/img/jackpot_in1.jpg") no-repeat center,
            url("/static/ybcp/img/jackpot_out2.jpg") no-repeat;
        }
      }
      @-moz-keyframes bg {
        0% {
  ...
  .kelake-bot-wrap {
    ...
    .game-list-right {
      ...
      .all {
        ...
        .arrow {
          ...
          .bg-arrow_left {
            ...
            background: url(/static/ybcp/img/arrow_sprites.png) -10px -10px;
          }
          ...
          .bg-arrow_right {
            ...
            -ms-transform: translateY(-50%);
            transform: translateY(-50%);
            background: url(/static/ybcp/img/arrow_sprites.png) -45px -10px;
          }
        }
      ...
      .slot_game {
        height: 200px;
        margin-bottom: 20px;
        background-image: url("/static/ybcp/img/game/slot_game.jpg");
      ...
      .live_game {
        ...
        .live {
          ...
          overflow: hidden;
          position: relative;
          background-image: url("/static/ybcp/img/game/live_casino.jpg");
          float: left;
          background-size: cover;
        }
        ...
        .gym {
          ...
          position: relative;
          float: left;
          background-image: url("/static/ybcp/img/game/sports_events.jpg");
          background-size: cover;
        }
      }
      ...
      .fish_game {
        height: 180px;
        margin-top: 10px;
        background-image: url("/static/ybcp/img/game/fishing_game.jpg");
        background-size: cover;
      ...
      .lottery_game {
        height: 180px;
        margin-top: 10px;
        background-image: url("/static/ybcp/img/game/lottery.jpg");
        background-size: cover;
      }
    }
  }
