...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/cpxpj/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/cpxpj/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/cpxpj/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/cpxpj/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/cpxpj/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/cpxpj/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/cpxpj/home/youhui/index')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
// const register = r => require.ensure([], () => r(require('@/pages/cpxpj/register.vue')), 'register')
// const register1 = r => require.ensure([], () => r(require('@/pages/cpxpj/home/register1.vue')), 'register1')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/cpxpj/home/help/About/index')), 'about')
const agent = r => require.ensure([], () => r(require('@/pages/cpxpj/home/help/Agent/index')), 'agent')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/cpxpj/home/tiyu/index')), 'tiyu')
// const vp_caipiao = r => require.ensure([], () => r(require('@/pages/cpxpj/home/caipiao/index')), 'caipiao')
