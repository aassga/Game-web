...
<script>
import loginLog from './login.vue'
...
export default {
  ...
  data() {
    return {
      lotHeadDatas: {
        logoUrl: "/static/cpxpj/img/gc-logo.png",
        downLoadurl: "/static/cpxpj/html/download/index.html"
      },
      dialogPar:{
          borderTop:"3px solid rgb(194,167,117)",
          headBg:'#fff',
          bandBorder:'1px solid #DFDFDF',
          active:'rgb(194,167,117)',
          titleColor:'#c2a775',
          ulBg:'#F2F2EA',
          ulBg2:'#f8f8f8',
          headColor:'rgb(194,167,117)',
          borderLeft:'3px solid rgb(194,167,117)',
          activeName:'cpxpjActive',
          hoverName:"hoverName7"
        },
      attPar:{
        btnColor:'rgb(194,167,117)',
        closeImg: "close_1", //弹窗关闭图片
        coverImgUrl:"../../../../static/cpxpj/img/attention.png",
      },
      nameSta:"cpxpj",
      poptype: "tc",
      showtype:{
