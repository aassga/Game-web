        ...
        <div class="newgong" v-if="$route.path==='/home'" :class="{youhuiActive:$route.path=='/home/youhui'}">
            <div class="newgong-content" @click="showTextModal()">
                ...
                <div class="demolist list">
                    <marquee v-if="lantern" align="middle" direction="left" loop="-1" scrollamount="4" onmouseout="this.start()" onmouseover="this.stop()"
                        style="color:#8f98b2; font-size:20px; line-height:40px; overflow:hidden; height:40px; width:1100px; margin-top:4px">
...
export default {
    data() {
        return {
            ...
            gameIndex: 0,
            carouselData: [
                // {img:"/static/cpxpj/img/banner-img.png"},
                // {img:"/static/cpxpj/img/b2.png"},
                // {img:"/static/cpxpj/img/b3.png"},
            ],
            bounceTrue: false,
            checked: 0,
            flag: 0,
