<template>
  <div id="footer-bg" class="clear">
    <div class="foo">
            <div>
              <img class="footer-brand" src="/static/cpxpj/img/foo.png" alt="">
            </div>
            <div>
              <ul>
                <li @click="$store.state.home.showLoginLog = true">
                  <span><img src="/static/cpxpj/img/kai.png" alt=""></span>
                  <span>真钱开户</span>
                  <span>开设账户申请即可获得首存礼金，并尊享网站的其他优惠及抽奖</span>
                </li>
                <li class="lines"></li>
                <li @click="goHelp(4)">
                  <span><img src="/static/cpxpj/img/he.png" alt=""></span>
                  <span>合作加盟</span>
                  <span>高返利，高收益的合作模式让您轻松赚取巨额佣金，与我们共同成长</span>
                </li>
                <li class="lines"></li>
                <li @click="$router.push('/home/youhui')">
                  <span><img src="/static/cpxpj/img/you.png" alt=""></span>
                  <span>优惠活动</span>
                  <span>优惠活动多样化,美女/大保健/机票/酒店/高额彩金等多重优惠，等您来拿！</span>
                </li>
                <li class="lines"></li>
                <li @click="service()">
                  <span><img src="/static/cpxpj/img/lian.png" alt=""></span>
                  <span>联系我们</span>
  ...
  export default {
    data () {
      return {
        ...
        footerBg:"/static/cpxpj/img/home/image_2019_02_14T08_56_54_932Z.png",
        footbgcolor:'',
        newmodal:{
          title:"来自澳门新葡京的消息",
          bgcolor:{
    ...
    watch:{
       colorbool(newbool,oldbool){
          if(newbool==true){
            this.footerBg ='/static/cpxpj/img/index-main-bg-n.jpg'
          }else{
            this.footerBg = "/static/cpxpj/img/home/image_2019_02_14T08_56_54_932Z.png"
          }
       },
       $route(to,from){
          this.initColor()
...
.foo{
          ...
          div{
            ...
            &:nth-child(2){
              ...
              margin: 0 auto;
              padding-top: 50px;
              border-top:1px solid #AE8E3C;
              border-bottom:1px solid #AE8E3C;
              ul{
                display: flex;
                .lines{
                  height: 155px;
  ...
  .clear{
      ...
      .night{
           background:url(/static/cpxpj/img/index-main-bg-n.jpg) no-repeat center top;
      }
  }
