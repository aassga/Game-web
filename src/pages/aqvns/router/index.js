...
// 默认空首页
const index = r => require.ensure([], () => r(require('@/pages/aqvns/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/aqvns/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/aqvns/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/aqvns/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/aqvns/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/aqvns/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/aqvns/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/aqvns/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')


const agent = r => require.ensure([], () => r(require('@/pages/aqvns/home/agent')), 'register') // 注册界面
const register = r => require.ensure([], () => r(require('@/pages/aqvns/home/register')), 'register') // 注册界面
const register2 = r => require.ensure([], () => r(require('@/pages/aqvns/home/help/register')), 'register2') // 注册界面
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/aqvns/home/help/about-page')), 'vpAboutPage') // 关于我们
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/aqvns/home/help/save-help')), 'vpSaveHelp') // 存款帮助
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/aqvns/home/help/pull-help')), 'vpPullHelp') // 取款帮助
const vpRelation = r => require.ensure([], () => r(require('@/pages/aqvns/home/help/relation')), 'vpRelation') // 联系我们
// 动画
