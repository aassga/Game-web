<template>
  <div class="wrapper">
    ...
    <pub-activity :banner-style="bannerStyle" show-nav-left :nav-style="navStyle" show-type="alert"
                  show-layout="column" :styles="cssStyle" :contentStyle="contentStyle" :class-obj="classObj" widths="1200"></pub-activity>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      headBg: "/static/aqvns/img/banner_activity.jpg",
      notice: "/static/aqvns/img/home/notice.png",
      bannerStyle: {
        width: '100%',
        height: '400px',
        background: 'url(/static/aqvns/img/banner_activity.jpg) no-repeat top',
        position: 'relative',
        margin: '0 auto',
