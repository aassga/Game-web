            ...
            <div class="footer index-footer">
                <div class="w1000">
                    ...
                    <div class="footer-link">
                        <a v-for="(branch,index)  in muneList" :key="index" href="javascript:void(0)"
                            @click="goView(branch.link)">{{ branch.name }}</a>
                    </div>
                    <div class="copyright">Copyright © 澳门威尼斯人 Reserved</div>
                </div>
            </div>
        </div>
...
.footer {
    ...
    .w1000 {
        .footer-img {
            background: url('/static/aqvns/img/home/v0601_img/footer-bg.png') no-repeat center;
...
.mobile_auto {
    ...
    width: 302px;
    height: 260px;
    background-image: url(/static/aqvns/img/APPxx.png);
