    ...
    <div class="aqvns-new-index">
        ...
        <div class="home-container">
          <section class="sub-nav">
            <div v-for="(item, index) in subNavList" :key="index" class="sub-nav-item">
              ...
              <div class="sub-nav-content">
                ...
                <div class="sub-nav-btn" @click="$router.push(item.url)">
                  <img src="/static/aqvns/img/home/v0601_img/enter-btn.png" alt="">
                </div>
              </div>

              <!-- <div class="sub-nav-item-top">
            ...
            <section id="slot-box" ng-controller="LobbiesCtrl" class="ng-scope">
                <div class="wrapper">
                  ...
                  <div class="game_info_box">
                    ...
                    <img class="winner-price-img" src="/static/aqvns/img/home/v0601_img/price-icon.png" alt="">

                    <div class="first_part">
                        <div class="part_middle">
                            <div class="super_award">
                              {{superAward.toLocaleString()}}.{{randomFloat.toLocaleString().padEnd(2,'0')}}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="events-section">
              <img class="events-title" src="/static/aqvns/img/home/v0601_img/title-hot-event.png" alt="">
              <div class="events-left-box">
                <div v-for="(item, index) in eventsLeftList" :key="index"  class="events-left-item" @mouseover="changGame(item.id)" @click="goMore(item.id)">
                  <img :src="item.img" alt="">
                  <span>{{item.name}}</span>
                  <img class="left-item-bg" src="/static/aqvns/img/home/v0601_img/outline-square.png" alt="">
                </div>
              </div>
              <div class="events-middle-box">
                <div v-for="(item, index) in eventsMiddleList" :key="index" class="events-middle-item">
                  <img :src="item.img" alt="">
                  <span>{{item.name}}</span>
                  <div class="events-middle-btn" @click="loginGame(item)">进入游戏</div>
                </div>
              </div>
              <!-- <img src="/static/aqvns/img/home/v0601_img/girl.png" alt="" class="events-right-img"> -->

              <div class="gameImg " v-show="gameIds == 'mg'"><img src="/static/aqvns/img/home/v0601_img/girl1.png" alt=""></div>
              <div class="gameImg" v-show="gameIds == 'mt'"><img src="/static/aqvns/img/home/v0601_img/girl2.png" alt=""></div>
              <div class="gameImg" v-show="gameIds == 'ag'"><img src="/static/aqvns/img/home/v0601_img/girl3.png" alt=""></div>
              <div class="gameImg" v-show="gameIds == 'bb'"><img src="/static/aqvns/img/home/v0601_img/girl4.png" alt=""></div>
              <div class="gameImg" v-show="gameIds == 'more'"><img src="/static/aqvns/img/home/v0601_img/girl5.png" alt=""></div>
            ...
            <section class="download-section">
              <div class="download-left-box">
                ...
                <span>扫码APP下载</span>
                <span>www.0706.com</span>
                <span>支持 iOS & Android 全方位功能</span>
                <!-- <img class="download-QRcode" src="/static/aqvns/img/home/v0601_img/QR-y5022.png" alt=""> -->
                <div class="title3" ref="qr-code"></div>

                <img class="download-btn" src="/static/aqvns/img/home/v0601_img/app-store-btn.png" alt="">
                <img class="download-btn" src="/static/aqvns/img/home/v0601_img/google-play-btn.png" alt="">
              </div>
              <img src="/static/aqvns/img/home/v0601_img/mobile-screen-shot.png" alt="" class="download-middle-img">
              <div class="downlaod-right-box">
                <span class="download-right-title">随时随地赢钱利器</span>
                <div class="downlaod-content-box">
                  <img src="/static/aqvns/img/home/v0601_img/html5-icon.png" alt="">
            ...
            <section>
              <img class="service-tite" src="/static/aqvns/img/home/v0601_img/title-service.png" alt="">
              <img class="service-img" src="/static/aqvns/img/home/v0601_img/service-img.png" alt="">
            </section>

            <section class="product-box">
              <img class="product-title" src="/static/aqvns/img/home/v0601_img/title-product.png" alt="">
...
export default {
    ...
    data() {
        return {
            ...
            subNavList: [
              {
                name: "真人娱乐",
                text: "casino",
                img: "/static/aqvns/img/home/v0601_img/casino-link.png",
                url:"/home/live",
              },
              {
                name: "电子游艺",
                text: "Electronic game",
                img: "/static/aqvns/img/home/v0601_img/elec-link.png",
                url:"/home/slot?navid=9&id=0",
              },
              {
                name: "彩票游戏",
                text: "Lottery games",
                img: "/static/aqvns/img/home/v0601_img/lottery-link.png",
                url:"/plays/hall"
              },
              {
                name: "体育赛事",
                text: "Sports events",
                img: "/static/aqvns/img/home/v0601_img/sport-link.png",
                url:"/home/tiyu",
              },
              {
                name: "棋牌游戏",
                text: "Sports events",
                img: "/static/aqvns/img/home/v0601_img/board-game-link.png",
                url:"/home/chess?navid=9&id=0"
              }
            ],
            eventsLeftList: [
              {
                img: '/static/aqvns/img/home/v0601_img/mg-elec.png',
                name: 'MG电子',
                url: '/home/slot?navid=9&id=10022',
                id: 'mg',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/mw-fish.png',
                name: 'MT捕鱼',
                url: '/home/slot?navid=9&id=11320',
                id: 'mt',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/ag-elec.png',
                name: 'AG电子',
                url: '/home/slot?navid=9&id=10015',
                id: 'ag',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/bb-elec.png',
                name: 'BB电子',
            ...
            mgList: [
              {
                img: '/static/aqvns/img/home/v0601_img/mg1.png',
                name: '108好汉',
                id: '1881',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/mg2.png',
                name: '侠盗猎车手',
                id: '1867',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/mg3.png',
                name: '冒险丛林(HD)',
                id: '1913',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/mg4.png',
                name: '大航海时代',
                id: '1877',
              },
            ],
            mtList: [
              {
                img: '/static/aqvns/img/home/v0601_img/mt1.png',
                name: '李逵劈鱼',
                id: '12037',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/mt2.png',
                name: '金蟾捕鱼',
                id: '12038',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/mt3.png',
                name: '3D捕鱼',
                id: '12040',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/mt4.png',
                name: '疯狂捕鱼',
                id: '12041',
              },
            ],
            agList: [
              {
                img: '/static/aqvns/img/home/v0601_img/ag1.png',
                name: '包租婆',
                id: '12243',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/ag2.png',
                name: '疯狂弹球',
                id: '12242',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/ag3.png',
                name: '美人鱼',
                id: '12241',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/ag4.png',
                name: '财气冲天',
                id: '12240',
              },
            ],
            bbList: [
              {
                img: '/static/aqvns/img/home/v0601_img/bb1.png',
                name: '惑星战记',
                id: '3461',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/bb2.png',
                name: '外星战记',
                id: '3466',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/bb3.png',
                name: '外星争霸',
                id: '3467',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/bb4.png',
                name: '传统',
                id: '3468',
              },
            ],
            moreList: [
              {
                img: '/static/aqvns/img/home/v0601_img/jdb-elec.png',
                name: 'JDB电子',
                url: '/home/slot?navid=9&id=10021',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/pg-elec.png',
                name: 'PG电子',
                url: '/home/slot?navid=9&id=11320',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/cq9-elec.png',
                name: 'CQ9电子',
                url: '/home/slot?navid=9&id=10018',
              },
              {
                img: '/static/aqvns/img/home/v0601_img/pt-elec.png',
                name: 'PT电子',
                url: '/home/slot?navid=9&id=0',
              },
            ],
...
.aqvns-new-index {
    ...
    .just-bg {
        width: 90%;
        height: 500px;
        background: url('/static/aqvns/img/cbg2.jpg');
        position: absolute;
        top: 0px;
        z-index: -10;
    }
    ...
    .home-container {
        ...
        .events-section {
          ...
          .events-left-box {
            background: url('/static/aqvns/img/home/v0601_img/outline-arrow.png') no-repeat center;
        ...
        #slot-box {
            ...
            .wrapper {
                ...
                display: flex;
                .winner-list-bg {
                  background: url('/static/aqvns/img/home/v0601_img/winner-title.png') no-repeat center;
                  background-size: contain;
                  width: 60px;
                  height: 100px;
                  .winner-list-title {
                    ...
                    font-weight: bold;
                    line-height: 20px;
                    background: linear-gradient(120deg, #FCF990 0%, #F7C64F 40.1611328125%, #FCFD97 72.607421875%, #FFE17E 100%);
                        ...
                        .game_nav {
                            ...
                            .arrow {
                                ...
                                &.prev {
                                    z-index: 999;
                                    left: 20px;
                                    background: url(/static/aqvns/img/home/caijin/arrow-left.png) no-repeat center center;
                                    &:hover {
                                        background: url(/static/aqvns/img/home/caijin/arrow-left-hover.png) no-repeat center center;
                                    }
                                }
                                &.next {
                                    right: 20px;
                                    background: url(/static/aqvns/img/home/caijin/arrow-right.png) no-repeat center center;
                                    &:hover {
                                        background: url(/static/aqvns/img/home/caijin/arrow-right-hover.png) no-repeat center center;
                                    }
                                }
                            }
                            .main-cell {
                                ...
                                .tempWarp {
                                    ...
                                    #game-list {
                                        ...
                                        li {
                                            background: url(/static/aqvns/img/xian.png) right center no-repeat;
                                            cursor: pointer;
                                            width: 104px;
                                            float: left;
                                            height: 102px;
                                            ...
                                            &.ae:before {
                                                background: url(/static/aqvns/img/home/caijin/ae.png) no-repeat center center;
                                                background-size: contain;
                                                height: 30px;
                                            }
                                            &.ag:before {
                                                background: url(/static/aqvns/img/home/caijin/ag.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.bbin:before {
                                                background: url(/static/aqvns/img/home/caijin/bbin.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.cq9:before {
                                                background: url(/static/aqvns/img/home/caijin/cq9.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.dt:before {
                                                background: url(/static/aqvns/img/home/caijin/dt.png) no-repeat center center;
                                                background-size: contain;
                                                height: 34px;
                                            }
                                            &.fg:before {
                                                background: url(/static/aqvns/img/home/caijin/fg.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.jdb:before {
                                                background: url(/static/aqvns/img/home/caijin/jdb.png) no-repeat center center;
                                                background-size: contain;
                                                height: 30px;
                                            }
                                            &.mg:before {
                                                background: url(/static/aqvns/img/home/caijin/mg.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.mw:before {
                                                background: url(/static/aqvns/img/home/caijin/mw.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.pt:before {
                                                background: url(/static/aqvns/img/home/caijin/pt.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.ky:before {
                                                background: url(/static/aqvns/img/home/caijin/ky.png) no-repeat center center;
                                                background-size: contain;
                                                height: 32px;
                                            }
                                            &.vg:before {
                                                background: url(/static/aqvns/img/home/caijin/vg.png) no-repeat center center;
                                                background-size: contain;
                                                height: 26px;
                                            }
                                            &.ly:before {
                                                background: url(/static/aqvns/img/home/caijin/ly.png) no-repeat center center;
                                                background-size: contain;
                                                height: 32px;
                                            }
                                            &.pg:before {
                                                background: url(/static/aqvns/img/home/caijin/pg.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.ttg:before {
                                                background: url(/static/aqvns/img/home/caijin/ttg.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                        ...
                                        .game-item {
                                            ...
                                            .star_num {
                                                ...
                                                &:after {
                                                    ...
                                                    height: 10px;
                                                    width: 55px;
                                                    background: url(/static/aqvns/img/home/star.png) repeat-x 0;
                                                }
                                            }
    ...
    .bg2{
        width: 100%;
        background: url('/static/aqvns/img/bg_3.png')no-repeat;
    ...
    .gameContainer2 {
        ...
        .title {
            ...
            font-size: 10px;
            line-height: 12px;
            // background: url(/static/aqvns/img/bg6.png) 50% no-repeat;
            }
        }
        .index_layer3{
            display: flex;
                        ...
                        .text_Top {
                            ...
                            a{
                                ...
                                &.playBtn {
                                    ...
                                    font-size: 20px;
                                    color:#FFD053;
                                    background: url(/static/aqvns/img/play.png) 100px no-repeat;
                                    text-indent: 40px;
                                    font-weight: 700;
    ...
    .notice span {
        font-size: 12px;
        background: url(/static/aqvns/img/notice.png) left center no-repeat;
        padding-left: 30px;
        width: 100px;
        float: left;
        display: block;
    ...
    .notice span {
        font-size: 12px;
        background: url(/static/aqvns/img/home/v0601_img/speaker.png) left center no-repeat;
        background-size: 20%;
        padding-left: 30px;
        width: 100px;
        float: left;
