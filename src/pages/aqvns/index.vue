<template>
    <div>
<!--          <hongbaoyu :theme="'theme2'" v-show="$route.path=='/home'"></hongbaoyu>-->
        <div class="vp-aqvns-style" :class="{'tcgBlur':$store.state.personal.isPersonal}">
            <!-- 传统彩票 -->
            ...
            <!-- 主页 -->
            <div v-else class="aqvns-cont-wrap">
        ...
        <!-- <jumpnewuser :theme="'dark'" :isNewUser='true'></jumpnewuser> -->

        <kaiJiang></kaiJiang>
        <qiandao></qiandao>
        <vpRegister></vpRegister>
...
import jumpnewuser from '../public/jump-newuser/index';
...
export default {
    ...
    data() {
        return {
            lotHeadDatas: {
                logoUrl: '/static/aqvns/img/home_logo.png',
                downLoadurl: '/static/aqvns/html/download/index.html'
            },
            dialogPar:{
            ...
            showtype:{
                ...
                textColor:'#3B4062',//弹窗按钮颜色
            },
            attPar:{
                btnColor:'#2D2B2B',
                closeImg: "close_1", //弹窗关闭图片
                coverImgUrl:"../../../../static/aqvns/img/tc.png",
            },
        };
    },
    methods: {},
...
body {
    ...
    .aqvns-cont-wrap {
      background: url('/static/aqvns/img/home/v0601_img/homePage-bg.png') no-repeat center top;
    }
    .vp-lottery-style {
        overflow-x: auto;
    }
