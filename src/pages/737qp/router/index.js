...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/737qp/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/737qp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/737qp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/737qp/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/737qp/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/737qp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/737qp/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/737qp/register.vue')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/737qp/home/register1.vue')), 'register1')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/737qp/home/help/About')), 'about')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/737qp/home/tiyu')), 'tiyu')
// const vp_caipiao = r => require.ensure([], () => r(require('@/pages/737qp/home/caipiao/index')), 'caipiao')
