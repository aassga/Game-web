    ...
    <div class="top_nav">
            ...
            <div class="nav_box">
                <ul class="nav-bar fl">
                    <li :class="['tpT',item.name == 'logo' ? 'logoClass':'']" v-for="(item,i) in classifyList" :key="i" >
                        <img src="/static/737qp/img/thirdparty/hot.gif" class="x-dh-i" alt v-if="item.hotShow && item.name != 'logo'">
        ...
        <div class="newgong" v-if="$route.path==='/home'" :class="{youhuiActive:$route.path=='/home/youhui'}">
            <div class="newgong-content" @click="showTextModal()">
                <div class="notice">
                    <i class="iconfont"><img src="/static/737qp/img/speaker.png" alt=""></i>
                    新葡京棋牌公告
                </div>
                <div class="demolist list">
                    <marquee v-if="lantern" align="middle" direction="left" loop="-1" scrollamount="3" onmouseout="this.start()" onmouseover="this.stop()"
                        style="color:#fff; font-size:14px; line-height: 40px;overflow: hidden;height: 40px;">
                        <span v-html="lantern"></span>
                    </marquee>
                </div>
                <div class="kf" @click="goService">
                    <img src="/static/737qp/img/index_13.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    data() {
        return {
            ...
            classifyList: [
                ...
                {
                    name: "logo",
                    logoUrl:'/static/737qp/img/logo_4.png',
                    type:"logo",
                },
                {
                    name: "电子游艺",
