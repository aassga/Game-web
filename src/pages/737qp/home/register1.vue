    ...
    <div class="register">
          ...
          <div class="list-box">
            <div class="text-context">
              <div class="input-cont">
                <div class="iconfont">
                  <img
                    src="/static/737qp/img/register/pel.png"
                    alt=""
                  />
                </div>
                <input
            ...
            <div class="text-context">
              <div class="input-cont">
                <div class="iconfont">
                  <img
                    src="/static/737qp/img/register/key.png"
                    alt=""
                  />
                </div>
                <input
      ...
      <div class="register-right">
        <div class="iconR">
          ...
          <!-- <span><img src="../../../../static/737qp/img/register/erm.png"  alt=""/></span> -->
        </div>
        <div class="testR">
          <p style="color: #fff;">扫码下载 新葡京棋牌 APP</p>
          <span>（ iOS / Android 通用 ）</span>
        </div>
        <div class="phoneR">
          <img
            src="../../../../static/737qp/img/register/regPhone.png"
            alt=""
          />
...
export default {
  ...
  data() {
    return {
      hasSendMsg:false,
      countDownTime:60,
      codeImg: "/static/737qp/img/new_games/lo.png",
      tabIndex: 1,
...
.banner{
    ...
    height: 300px;
    margin: 0 auto;
    background: url('/static/737qp/img/banner/headImg.png') top/cover no-repeat;
}
.registerBox {
  width: 100%;
  padding: 20px 0;
