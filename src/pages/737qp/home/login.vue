           ...
           <div class="logBottom">
                ...
                <div class="logMember">
                    <div class="logMemberL">
                        <img src="../../../../static/737qp/login/yuan.png" alt="">
                        <span>记住密码</span>
                    </div>
...
.login{
    ...
    background-image: url(/static/737qp/login/login-bg.png);
    ...
    background-image: url(/static/737qp/logo/logos.png),url(/static/737qp/login/bg-close.png);
    background-repeat: no-repeat;
