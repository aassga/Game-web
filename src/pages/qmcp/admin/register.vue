                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <input autocomplete="off" type="text" minlength="6" maxlength="10" v-model="userName" @blur="getCode"
                            @keydown="pulicError=''" v-on:keyup.enter="registerTest" placeholder="账号">
                    ...
                    <div class="row">
                        ...
                        <input autocomplete="off" type="password" @keyup="clearNull" minlength="8" maxlength="20" v-model="password" @keydown="pulicError=''"
                            v-on:keyup.enter="registerTest" placeholder="密码">
                        <div class="remark">密码：8-20位数字或字母，支持纯数字，纯字母，及数字与字母的组合</div>
                    </div>
                    <div class="row">
                        <label><span class="star">* </span>确认密码:</label>
                        <input autocomplete="off" type="password" maxlength="20" @keyup="clearNull"  v-model="password_confirmation" @keydown="pulicError=''"
                            v-on:keyup.enter="registerTest" placeholder="确认密码">
                    </div>
                    <div class="row" v-if="!isShowSms&&!isShowTnCode">
                        ...
                        <input autocomplete="off" type="text" v-model="code" @keydown="pulicError=''" v-on:keyup.enter="registerTest"
                            placeholder="验证码" minlength="4" maxlength="4">
                        <img class="checkLoginCodeImage" :src="codeImg" @click="getCode">
                    </div>
                    <div class="row" v-if='iscode'>
                        <label><span class="star">* </span>邀请码:</label>
                        <!-- <input type="text" v-model="intacode" @keydown="pulicError=''" v-on:keyup.enter="registerTest"> -->
