...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/qmcp/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/qmcp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/qmcp/home/home-live')), 'vpHomeLive')
const vpHelp = r => require.ensure([], () => r(require('@/pages/qmcp/home/help')), 'vpHelp')
const vpGames = r => require.ensure([], () => r(require('@/pages/qmcp/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/qmcp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/qmcp/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/qmcp/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/qmcp/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const vpRegister = r => require.ensure([], () => r(require('@/pages/qmcp/admin/register')), 'register')
