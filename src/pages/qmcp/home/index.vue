<template>
  ...
  <div class="qmcp-new-index">
    <div class="banner-wrap">
      <div class="carouse">
        <Carousel autoplay loop style="height:498px;overflow:hidden">
              ...
              <div class="game_kind clearfix">
                <div class="kind_bg">
                  <div class="game_kind_in kind_bg_c">
                    ...
                    <a href="javascript:void(0);" class="credits" @click="go('#/plays/tradition/2')"></a>
                  </div>
                </div>
                <div class="kind_bg kind_bg_ml">
                  <div class="game_kind_in kind_bg_o">
                    <a href="javascript:void(0);" class="credit_a"></a>
                    <a href="javascript:void(0);" class="credits" @click="go('#/plays/tradition/4')"></a>
                  </div>
                </div>
                <div class="kind_bg kind_bg_ml">
                  <div class="game_kind_in kind_bg_s">
                    <a href="javascript:void(0);" class="credit_a"></a>
                    <a href="javascript:void(0);" class="credits" @click="go('#/plays/tradition/9')"></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="problem">
                ...
                <div class="common">
                  <ul class="clearfix">
                    ...
                    <li @click="openKefu"><a href="#">联系客服</a></li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      return {
        ...
        lotteryList: [
          ...
          },
          {
            ...
            ico: '/static/qmcp/img/lottery/newGDKLSF.png',
            id: 5
          },
          {
            name: '欢乐生肖',
          ...
          },
          {
            ...
            ico: '/static/qmcp/img/lottery/ksks.png',
            id: 27
          },
          {
            name: '六合彩',
          ...
          },
          {
            ...
            ico: '/static/qmcp/img/lottery/sfssc.png',
            id: 17
          },
          {
            name: '3分快3',
          ...
          },
          {
            ...
            ico: '/static/qmcp/img/lottery/GD11X5.png',
            id: 3632
          }
        ],
        // 轮播设置
