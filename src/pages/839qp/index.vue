<template>
  <div>
    <!-- <hongbaoyu :theme="'theme2'" v-show="$route.path=='/home'"></hongbaoyu> 2021-07-15 移除紅包雨 -->
...
import bindbank from "../public/home/bindbankcar.vue";
  export default {
    ...
    data () {
      return {
        lotHeadDatas: {
          logoUrl: '/static/839qp/img/logo.png',
          downLoadurl: '/static/839qp/html/download/index.html'
        },
        dialogPar:{
        ...
        attPar:{
          btnColor:'#1F1F1F',
          closeImg: "close_1", //弹窗关闭图片
          coverImgUrl:"../../../../static/839qp/img/tc.png",
        },
      }
    },
    methods: {},
