                ...
                <div class="gameList">
                    <ul>
                        <li v-for="(item,index) in gameArr" :key="index">
                            <span><img :src="'/static/839qp/img/homeGame/'+item.icon"></span>
                            <span>{{item.name}}</span>
...
export default {
    ...
    data() {
        return {
            ...
            gameList1: [
                ...
                name: "电子游艺",
                text: "SLOT GAMES",
                bgImg: "/static/839qp/img/gameBg4.png",
                img: "/static/839qp/img/game4.png",
                link:"/home/slot?navid=9&id=0",
                content:
                    "全网最全电子游艺，汇聚世界顶级电子游艺平台，画质高清，玩法多样，亿元累计彩池，大奖一触即发！",
                games: [
                    { icon: "/static/839qp/img/LG_MGWBDZ.png", name: "MG电子", link: "/home/slot?navid=9&id=10022" },
                    { icon: "/static/839qp/img/LG_CQ.png", name: "CQ9电子", link: "/home/slot?navid=9&id=10018" },
                    {
                    icon: "/static/839qp/img/LG_JDB_DZ_LHJ.png",
                    name: "JDB电子",
                    link: "/home/slot?navid=9&id=10021",
                    },
                    { icon: "/static/839qp/img/LG_FGDZ.png", name: "FG电子", link: "/home/slot?navid=9&id=10020" },
                    { icon: "/static/839qp/img/LG_AGDZ.png", name: "AG电子", link: "/home/slot?navid=9&id=10015" },
                    {
                    icon: "/static/839qp/img/LG_BBINDZ.png",
                    name: "BBIN电子",
                    link: "/home/slot?navid=9&id=10016",
                    },
                    { icon: "/static/839qp/img/a15.png", name: "MORE", link: "/home/slot?navid=9&id=0" }
                ]
                },
                {
                name: "棋牌游戏",
                text: "CHESS GAMES",
                bgImg: "/static/839qp/img/gameBg5.png",
                img: "/static/839qp/img/game5.png",
                link:"/home/chess?navid=9&id=0",
                content:
                    "全网最全棋牌游戏，汇聚世界顶级棋牌游戏平台，画质高清，玩法多样，亿元累计彩池，大奖一触即发！",
                games: [
                    { icon: "/static/839qp/img/LG_KYQP.png", name: "开元棋牌", link: "/home/chess?navid=9&id=10042" },
                    {
                    icon: "/static/839qp/img/LG_SSOCHESS.png",
                    name: "乐游棋牌",
                    link: "/home/chess?navid=9&id=10612"
                    },
                    {
                    icon: "/static/839qp/img/10694.png",
                    name: "天游棋牌",
                    link: "/home/chess?navid=9&id=10694"
                    },
                    { icon: "/static/839qp/img/LG_FGQP.png", name: "FG棋牌", link: "/home/chess?navid=9&id=10732" },
                    { icon: "/static/839qp/img/LG_VG.png", name: "VG棋牌", link: "/home/chess?navid=9&id=10041" },
                    {
                    icon: "/static/839qp/img/LG_ZILLIONAIRE.png",
                    name: "大富翁棋牌",
                    link: "/home/chess?navid=9&id=11759"
                    },
                    { icon: "/static/839qp/img/a15.png", name: "MORE", link: "/home/chess?navid=9&id=0" }
                ]
                }
            ],
            gameList2:[
                ...
                name: "捕鱼游戏",
                text: "FISHNG",
                bgImg: "/static/839qp/img/bg5.png",
                img: "/static/839qp/img/pic11.png",
                link:"/home/fish?navid=9&id=0",
                },
                {
                name: "体育赛事",
                text: "SPORTS",
                bgImg: "/static/839qp/img/bg3.png",
                img: "/static/839qp/img/pic9.png",
                link:"/home/live",
                },
                {
                name: "彩票游戏",
                text: "LOTTERY",
                bgImg: "/static/839qp/img/bg4.png",
                img: "/static/839qp/img/pic10.png",
                link:"#/plays/hall"
                }
            ],
            rollList: [
                {
                    ...
                    id: '10042',
                    class: 'ky',
                    img: '/static/839qp/img/gamelist/navicon/ky.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10694',
                    class: 'ly',
                    img: '/static/839qp/img/gamelist/navicon/ly.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '11320',
                    class: 'pg',
                    img: '/static/839qp/img/gamelist/navicon/pg.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10015',
                    class: 'ag',
                    img: '/static/839qp/img/gamelist/navicon/ag.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10016',
                    class: 'bbin',
                    img: '/static/839qp/img/gamelist/navicon/bbin.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10018',
                    class: 'cq9',
                    img: '/static/839qp/img/gamelist/navicon/cq9.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10019',
                    class: 'dt',
                    img: '/static/839qp/img/gamelist/navicon/dt.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10020',
                    class: 'fg',
                    img: '/static/839qp/img/gamelist/navicon/fg.png',
                    list: [
                ...
                
                {
                    ...
                    id: '10021',
                    class: 'jdb',
                    img: '/static/839qp/img/gamelist/navicon/jdb.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10022',
                    class: 'mg',
                    img: '/static/839qp/img/gamelist/navicon/mg.png',
                    list: [
                ...
                
                {
                    ...
                    id: '10023',
                    class: 'mw',
                    img: '/static/839qp/img/gamelist/navicon/mw.png',
                    list: [
                ...
                },
                {
                    ...
                    id: '10024',
                    class: 'pt',
                    img: '/static/839qp/img/gamelist/navicon/pt.png',
                    list: [
            ...
            caipiaoList:[
                {img:"/static/839qp/img/27.png",name:"快速快3",id:27},
                {img:"/static/839qp/img/10045.png",name:"快乐飞艇",id:10045},
                {img:"/static/839qp/img/18.png",name:"快速六合彩",id:18},
                {img:"/static/839qp/img/16.png",name:"快速时时彩",id:16},
                {img:"/static/839qp/img/12.png",name:"快速赛车",id:12},
                {img:"/static/839qp/img/3630.png",name:"幸运赛车",id:3630},
                {img:"/static/839qp/img/3631.png",name:"3分快3",id:3631},
                {img:"/static/839qp/img/17.png",name:"3分时时彩",id:17},
                {img:"/static/839qp/img/10044.png",name:"香港赛马",id:10044},
                {img:"/static/839qp/img/7.png",name:"广东11选5",id:7},
                {img:"/static/839qp/img/9.png",name:"江苏快3",id:9},
                {img:"/static/839qp/img/13.png",name:"快乐赛车",id:13},
            ],
            setting: {
                autoplay: true,
                loop: true,
            ...
            // 轮播名单
            carouselData: [
                // {img:"/static/839qp/img/home/banner7.jpg"},
                // {img:"/static/839qp/img/home/banner8.jpg"},
                // {img:"/static/839qp/img/home/banner3.jpg"},
                // {img:"/static/839qp/img/home/banner4.jpg"},
                // {img:"/static/839qp/img/home/banner5.jpg"},
                // {img:"/static/839qp/img/home/banner6.jpg"},
            ],
    ...
    methods: {
        ...
        godown(){
            window.open('/static/839qp/html/download/index.html')
        },
        loginGame(item){
...
.hty-new-index {
    ...
    min-width: 1200px;
    margin: 0 auto;
    background: url('/static/839qp/img/bg.jpg') center top no-repeat;
    ...
    .notice {
        ...
        // background: url(/static/839qp/img/noticebg.png) repeat-x;
    }
    .notice span {
        font-size: 12px;
        padding-left: 30px;
        ...
        i{
            ...
            background: url('/static/839qp/img/jingling.png') no-repeat;
            width: 25px;
            height: 24px;
    ...
    .wp {
        ...
        .first_part{
                ...
                .super_award {
                    ...
                    .award_num {
                        ...
                        li {
                            ...
                            background: url('/static/839qp/img/num_bg.webp') no-repeat center center;
            ...
            .part_right{
                span{
                    ...
                    &:nth-child(2){
                        background: url('/static/839qp/img/zhifubao.webp') no-repeat;
                        background-position: 9px 6px;
                        margin-left: 20px;
                    }
                    &:nth-child(3){
                        background: url('/static/839qp/img/weixin.webp') no-repeat;
                        background-position: 9px 6px;
                    }
                    &:nth-child(4){
                        background: url('/static/839qp/img/yinlian.webp') no-repeat;
                        background-position: 9px 6px;
                    }
                    &:nth-child(5){
                        background: url('/static/839qp/img/kuaisu.webp') no-repeat;
                        background-position: 9px 6px;
                    }
                }
            }
        ...
        .game_nav {
            ...
            .arrow {
                ...
                &.prev {
                    z-index: 999;
                    left: 0;
                    // background-image: url(/static/839qp/img/prev.png);
                    // &:hover {
                ...
                &.next {
                    right: 0;
                    // background: url(/static/839qp/img/next.png);
                    // &:hover {
                    //     background-position: center bottom;
                    //     background: url(/static/839qp/img/next.png);
                    // }
                ...
                .tempWarp {
                    ...
                    #game_list {
                        ...
                        li {
                            ...
                            &.ae:before {
                                background: url(/static/839qp/img/ae.png) no-repeat center center;
                                background-size: contain;
                                height: 30px;
                            }
                            &.ag:before {
                                background: url(/static/839qp/img/ag.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.bbin:before {
                                background: url(/static/839qp/img/bbin.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.cq9:before {
                                background: url(/static/839qp/img/cq9.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.dt:before {
                                background: url(/static/839qp/img/dt.png) no-repeat center center;
                                background-size: contain;
                                height: 34px;
                            }
                            &.fg:before {
                                background: url(/static/839qp/img/fg.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.jdb:before {
                                background: url(/static/839qp/img/jdb.png) no-repeat center center;
                                background-size: contain;
                                height: 30px;
                            }
                            &.mg:before {
                                background: url(/static/839qp/img/mg.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.mw:before {
                                background: url(/static/839qp/img/mw.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.pt:before {
                                background: url(/static/839qp/img/pt.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.ky:before {
                                background: url(/static/839qp/img/ky.png) no-repeat center center;
                                background-size: contain;
                                height: 32px;
                            }
                            &.vg:before {
                                background: url(/static/839qp/img/vg.png) no-repeat center center;
                                background-size: contain;
                                height: 26px;
                            }
                            &.ly:before {
                                background: url(/static/839qp/img/ly.png) no-repeat center center;
                                background-size: contain;
                                height: 32px;
                            }
                            &.pg:before {
                                background: url(/static/839qp/img/pg.png) no-repeat center center;
                                background-size: contain;
                                height: 22px;
                            }
                            &.ttg:before {
                                background: url(/static/839qp/img/ttg.png) no-repeat center center;
                                background-size: contain;
                            }
                            &.ttg:before {
                                background: url(/static/839qp/img/ttg.png) no-repeat center center;
        ...
        .third_part{
            ...
            .bg2{
                width: 100%;
                background: url('/static/839qp/img/bg_3.png')no-repeat;
            ...
            .gameContainer2 {
                ...
                .title {
                    ...
                    font-size: 10px;
                    line-height: 12px;
                    // background: url(/static/839qp/img/bg6.png) 50% no-repeat;
                    }
                }
                .index_layer3{
                    display: flex;
                                ...
                                .text_Top {
                                    ...
                                    a{
                                        ...
                                        &.playBtn {
                                            ...
                                            font-size: 20px;
                                            color:#FFD053;
                                            background: url(/static/839qp/img/play.png) 100px no-repeat;
                                            text-indent: 40px;
                                            font-weight: 700;
