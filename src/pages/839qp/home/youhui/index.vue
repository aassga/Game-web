...
export default {
    ...
    data() {
        return {
            headBg: '/static/839qp/img/new_games/banner/yh.jpg',
            notice: "/static/839qp/img/home/notice.png",
            lantern: '',
            bannerStyle: {},
            cssStyle: {
                padding: '20px 20px 20px',
                background: 'url(/static/839qp/img/bg_activity.jpg)',
...
.wrapper {
    .notice {
        ...
        .w1000 {
            ...
            span {
                font-size: 12px;
                background: url(/static/839qp/img/notice.png) left center no-repeat;
                padding-left: 30px;
                width: 128px;
                float: left;
                display: block;
