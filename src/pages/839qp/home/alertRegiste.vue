                ...
                <div class="title_tab">
                    ...
                    <div class="close1" @click="close">
                        <a href="javascript:void(0)">
                            ...
                            <img src="/static/839qp/img/xx.png" alt="">
                        </a>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            codeImg:'/static/839qp/img/new_games/re.png',
            pwdInp: 'password',
            smsInputBox: {
                marginTop: '20px'
            },
            ...
            list: [
                {img:"/static/839qp/img/sl1.png"},
                {img:"/static/839qp/img/sl2.png"},
                {img:"/static/839qp/img/sl3.png"},
                {img:"/static/839qp/img/sl4.png"},
            ],
...
.register {
    ...
    .popup {
        ...
        .headline {
            ...
            background: url('/static/839qp/img/reheader.png') no-repeat;
        ...
        .logAside{
            ...
            ul{
                li{
                    ...
                    &:first-child{
                        background: url('/static/839qp/img/tan2.png') no-repeat;
                        background-size: 100% 100%;
                        span{
                            &:last-child{
                                font-size: 14px;
                    ...
                    &:nth-child(2){
                        background: url('/static/839qp/img/tan1.png') no-repeat;
                        background-size: 100% 100%; 
                    }
                    &:nth-child(3){
                        background: url('/static/839qp/img/tan3.png') no-repeat;
                        background-size: 100% 100%; 
                    }
                    &:last-child{
                        background: url('/static/839qp/img/tan4.png') no-repeat;
                        background-size: 100% 100%; 
                    }
                }
            }
