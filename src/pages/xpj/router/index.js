...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/xpj/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/xpj/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/xpj/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/xpj/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/xpj/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/xpj/home/youhui/index.vue')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/xpj/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () =>r(require('@/pages/xpj/home/tiyu')),'vpTiyu')


const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/xpj/home/register')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/xpj/register')), 'register1')


// 帮助
const about = r => require.ensure([], () => r(require('@/pages/xpj/home/help/About/index')), 'about')
// const contact = r => require.ensure([], () => r(require('@/pages/xpj/home/help/contact')), 'contact')
// const savings = r => require.ensure([], () => r(require('@/pages/xpj/home/help/Savings/index')), 'savings')
// const issue = r => require.ensure([], () => r(require('@/pages/xpj/home/help/issue')), 'issue')
// const partner = r => require.ensure([], () => r(require('@/pages/xpj/home/help/partner')), 'partner')
// const help_withdrawals = r => require.ensure([], () => r(require('@/pages/xpj/home/help/help-Withdrawals')), 'help_withdrawals')
