...
// 默认空首页
const index = r => require.ensure([], () => r(require('@/pages/js85/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/js85/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/js85/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/js85/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/js85/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/js85/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/js85/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/js85/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')


const agent = r => require.ensure([], () => r(require('@/pages/js85/home/agent')), 'register') // 注册界面
const register = r => require.ensure([], () => r(require('@/pages/js85/home/register')), 'register') // 注册界面
const register2 = r => require.ensure([], () => r(require('@/pages/js85/home/help/register')), 'register2') // 注册界面
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/js85/home/help/about-page')), 'vpAboutPage') // 关于我们
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/js85/home/help/save-help')), 'vpSaveHelp') // 存款帮助
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/js85/home/help/pull-help')), 'vpPullHelp') // 取款帮助
const vpRelation = r => require.ensure([], () => r(require('@/pages/js85/home/help/relation')), 'vpRelation') // 联系我们
// 动画
