    ...
    <div class="register">
        <div class="content">
            ...
            <div class="content clearfloat">
                <div class="left fl">
                    <img class="phone-img1 animated fadeInLeft" src="/static/k78qp/img/thirdparty/pone-bg.png" alt="">
...
export default {
    ...
    data() {
        return {
            codeImg: '/static/k78qp/img/new_games/re.png',
            smsInputBox: {
                marginTop: '15px'
            },
            paddingBottom2:"20px",
...
.register {
    ...
    .content {
        ...
        .register-logo {
            ...
            font-size: 36px;
            color: #5caaea;
            background: url(/static/k78qp/img/thirdparty/regbanner.jpg) no-repeat center;
        }
        .reg_step {
            text-align: center;
            margin: 0 auto 50px;
            ...
            ul {
                ...
                .active {
                    background: url(/static/k78qp/img/thirdparty/hover.png) no-repeat center;
                    .tip-num {
                        background: #5caaea;
                    }
                }
        ...
        .content {
            .left {
                ...
                width: 461px;
                height: 486px;
                background: url(/static/k78qp/img/thirdparty/left_banner.png) no-repeat center;
                ...
                .qy-code-down1 {
                    ...
                    width: 213px;
                    height: 249px;
                    background: url('/static/k78qp/img/thirdparty/qy-code-down.png') no-repeat;
                    .qr-code {
                        margin-top: 80px;
                        margin-left: 45px;
                    }
            ...
            .list-box {
                .text-context {
                    ...
                    .input-cont {
                        ...
                        .yonghu {
                            background: url('/static/k78qp/img/zhuce/username.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .mima {
                            background: url('/static/k78qp/img/zhuce/mimaask.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .yanzhengma {
                            background: url('/static/k78qp/img/zhuce/yanzhengma.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .shoujihao {
                            background: url('/static/k78qp/img/zhuce/shoujihao.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .yaoqingma {
                            background: url('/static/k78qp/img/zhuce/yaoqingma.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .youxiang {
                            background: url('/static/k78qp/img/zhuce/youxiang.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .weixin {
                            background: url('/static/k78qp/img/zhuce/weixin.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        .zhifumima {
                            background: url('/static/k78qp/img/zhuce/zhifumima.png') no-repeat;
                            background-size: 100% 100%;
                        }
                        input {
                            position: relative;
