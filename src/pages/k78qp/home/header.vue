<template>
  <div class="new-header">
    ...
    <!-- <div class="header-top" :class="{night:colorbool}" :style="{backgroundColor:headerbgColor}"> -->
      ...
      <div class="login">
        <div class="sj">
            <img src="/static/k78qp/img/china.png" alt="" style="vertical-align: middle;margin-right:10px;">
  ...
  export default {
    ...
    data () {
      return {
        ...
        showmodle:false,
        codeImg: '/static/k78qp/img/new_games/lo.png',
        left: 5,
        top: -193,
        showReload: false,
    ...
    methods: {
      goHeader(typeNum){
        if(typeNum==0){
          ...
          // 金管家
          window.open("/static/k78qp/html/active/sxjgj/index.html","_blank");
        }
      },
            //获取时间
      ee(num) {
