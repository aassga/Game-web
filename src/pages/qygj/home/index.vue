  ...
  export default {
    data () {
      return {
        ...
        advanDatas:[
          {
            icon:"/static/qygj/img/tip-demo-5.png",
            name:"免息借呗",
          ...
          .game-lists-container{
            ...
            &>ul:first-child{
              ...
              li:first-child{
                ...
                position:relative;
                left:-2000px;
                background:url(/static/qygj/img/shouye/newlivebg.png) no-repeat center;
                .rtop{
                  position:absolute;
                  top:60px;
                  right:12px;
              ...
              li:nth-child(2){
                ...
                margin-top:39px;
                margin-left:24.5px;
                background:url(/static/qygj/img/shouye/lotteryBg.png) no-repeat center;
                position:relative;
                top:2000px;
                .lotteryTopbox{
                  height:58px;
              ...
              li:last-child{
                ...
                margin-top:12px;
                margin-right:0;
                background:url(/static/qygj/img/shouye/prizeBg.png) no-repeat center;
                position:relative;
                right:2000px;
                .prizeTop{
                  height:34px;
                  ...
                  .ranklistbox{
                    ...
                    .rankwrapper,.ranktouzhu{
                      ...
                      .listdiv:first-child>.rankIcon{
                          ...
                          height: 20px;
                          line-height: 28px;
                          background: url(/static/qygj/img/55.png) no-repeat center;
                      ...
                      .listdiv:nth-child(2)>.rankIcon{
                        ...
                        height: 20px;
                        line-height: 28px;
                        background:url(/static/qygj/img/66.png) no-repeat center;
                        background-size:contain;
                        position: relative;
                        top: 50%;
                        transform: translateY(-50%);
                      ...
                      .listdiv:nth-child(3)>.rankIcon{
                        ...
                        height:20px;
                        line-height:28px;
                        background:url(/static/qygj/img/77.png) no-repeat center;
                        background-size:contain;
                        position: relative;
                        top: 50%;
                        transform: translateY(-50%);
              ...
              li.active{
                background:url(/static/qygj/img/shouye/prizeBg1.png) no-repeat center;
              }
            }
            ...
            &>ul:nth-child(2){
              ...
              li:first-child{
                height:298px;
                width:590px;
                background:url(/static/qygj/img/shouye/qiapibg.png) no-repeat center;
                margin-left:-27px;
                left:-2000px;
                div{
                  position:absolute;
              ...
              li:last-child{
                ...
                margin-right:-35px;
                right:2000px;
                background:url(/static/qygj/img/shouye/lotterylistbg.png) no-repeat center;
                div{
                  position:absolute;
                  left:25px;
                  bottom:35px;
            ...
            &>ul:nth-child(3){
              ...
              li:first-child{
                width:434px;
                height:230px;
                background:url(/static/qygj/img/shouye/slotbg.png) no-repeat center;
                margin-left: -66px;
                left:2000px;
              }
              li:nth-child(2){
                ...
                height:230px;
                margin-left: 11px;
                background:url(/static/qygj/img/shouye/buyubg.png) no-repeat center;
                top:2000px;
              }
              li:last-child{
                width:367px;
                height:230px;
                background:url(/static/qygj/img/shouye/tiyubg.png) no-repeat center;
                right:2000px;
              }
            }
