...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/qygj/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/qygj/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/qygj/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/qygj/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/qygj/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/qygj/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/qygj/home/youhui/index')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/qygj/register.vue')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/qygj/home/register1.vue')), 'register1')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/qygj/home/help/About/index')), 'about')
const contact = r => require.ensure([], () => r(require('@/pages/qygj/home/help/contact')), 'contact')
const savings = r => require.ensure([], () => r(require('@/pages/qygj/home/help/Savings/index')), 'savings')
const issue = r => require.ensure([], () => r(require('@/pages/qygj/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/qygj/home/help/partner')), 'partner')
const help_withdrawals = r => require.ensure([], () => r(require('@/pages/qygj/home/help/help-Withdrawals')), 'help_withdrawals')

const agent = r => require.ensure([], () => r(require('@/pages/qygj/home/help/Agent/index')), 'agent')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/qygj/home/tiyu/index')), 'tiyu')
// const vp_caipiao = r => require.ensure([], () => r(require('@/pages/qygj/home/caipiao/index')), 'caipiao')
