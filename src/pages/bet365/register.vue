...
export default {
    ...
    data() {
        return {
            ...
            codeImg: '/static/bet365/img/new_games/re.png',
            smsInputBox: {
                marginTop: 15/23 +'vw'
            },
            codeImg: '/static/bet365/img/new_games/log.png',
            tabIndex:1,
...
.checkedBox{
    span{
        border: 2px solid #007B5B!important;
    }
    i{
        background: #007B5B!important;
    }
...
.register {
    ...
    height: 100%;
    margin: 0 auto;
    background: url(/static/bet365/img/register_bg.png) no-repeat center;
    ...
    .service{
        ...
        span{
            ...
            &:first-child{
                width: 102px;
                height: 102px;
                background: url('/static/bet365/img/ser.png');
    ...
    .content {
        ...
        background: url('/static/bet365/img/form_bg.png');
        background-repeat: no-repeat;
        background-size:100% 100% ;
        position: relative;
        .titleTab{
            ...
            .clicked{
                ...
                border-bottom: 2px solid #007B5B;
                i{
                    display: inline-block;
                    width: 100%;
                    text-align: center;
