...
export default {
  ...
  data() {
    return {
      ...
      showfresh:false,
      allUnReadCount:10,
       codeImg:"/static/bet365/img/new_games/lo.png",
       newmodal:{
          title:"来自bet365的消息",
          bgcolor:{
  ...
  methods: {
    ...
    getNativeDatas() {
        if (localStorage.gameSortV4_chess){
            this.navList[1].list = this.$gameClassV4("chess");
        }
        if (localStorage.gameSortV4_sport){
            this.navList[6].list = this.$gameClassV4("sport");
        }
    },
    async getLantern () {
    ...
    goDownloadPage(){
      window.open('/static/bet365/html/download/index.html','_blank')
    },
    register() {
...
.header_box_inner{
  ...
  .header-top-wrap {
          ...
          .ele-acc-unit {
            ...
            #_bbsportBalance {
              ...
              .refresh{
                 ...
                 width: 15px; 
                 height: 15px;
                 background: url(/static/bet365/img/home/refresh.png);
                 position:relative;
                 top:2px
              }
              .newfresh{
                background: url(/static/bet365/img/home/newrefresh.png);
              }
            }
          }
        }
    ...
    .header-top-left-time{
        ...
        color: #85b9ab;
        padding-left: 30px;
        background: url(/static/bet365/img/zh.png) no-repeat left center;
        font-size: 14px;
    }
  }
  .clearfix {
...
.header_box_middle{
  ...
  .header-logo {
      ...
      margin-left:-20px;
        ...
        width: 163px;
        height: 69px;
        background-image: url(/static/bet365/img/home/homeLogo.png);
...
.header_box_bottom{
  ...
  .news-wrap {
    ...
    .top-link-wrap {
      ...
      .top-service-icon {
        padding-left:20px;
        background:url(/static/bet365/img/kf.png) no-repeat 10px center;
        background-size:18px 20px;
        color: #ffe618;
      }
      .linebg{
        padding-left:20px;
        background:url(/static/bet365/img/jc.png) no-repeat 10px center;
        background-size:18px 20px;
      }
      .downloadBg{
        padding-left:20px;
        background:url(/static/bet365/img/sj.png) no-repeat 10px center;
      }
    }
}
</style>