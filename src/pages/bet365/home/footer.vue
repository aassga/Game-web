...
.footers {
    ...
    .footer-bg {
        height: 2px;
        width: 100%;
        background: url(/static/bet365/img/home/footer_bg.png) repeat-x 0% 0%;
    }
    .footer-newbg {
        height: 2px;
        width: 960px;
        ...
        .footer-top-wrap {
            ...
            .footer-top-left {
                ...
                .article-menu {
                    ...
                    a:hover {
                        border-bottom: 1px solid #697571;
                    }
                ...
                .gohome {
                    ...
                    font-size: 12px;
                    height: 29px;
                    background: url(/static/bet365/img/home/footer_common_btn.png) no-repeat 0% 0%;
                    text-align: center;
                    line-height: 29px;
                    font-size: 12px;
                    text-align: center;
