...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/bet365/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/bet365/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/bet365/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/bet365/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/bet365/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/bet365/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/bet365/register')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/bet365/home/register1')), 'register1')
const help = r => require.ensure([], () => r(require('@/pages/bet365/home/help/index.vue')), 'help')
const question = r => require.ensure([], () => r(require('@/pages/bet365/home/help/question.vue')), 'question')
const vpQipai = r => require.ensure([], () => r(require('@/pages/bet365/home/qipai')), 'vpQipai')
const vpSport = r => require.ensure([], () => r(require('@/pages/bet365/home/sport')), 'vpSport')
//const register1 = r => require.ensure([], () => r(require('@/pages/bet365/home/register1')), 'register1')
//购彩大厅
