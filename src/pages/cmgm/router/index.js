...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/cmgm/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/cmgm/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/cmgm/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/cmgm/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/cmgm/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/cmgm/home/youhui/index1')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/cmgm/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () =>r(require('@/pages/cmgm/home/tiyu')),'vpTiyu')

// const TotalMosaic = r => require.ensure([], () => r(require('@/pages/cmgm/home/youhui/totalmosaic.vue')), 'TotalMosaic')

const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/cmgm/home/register')), 'register')
const agent = r => require.ensure([], () => r(require('@/pages/cmgm/home/agent')), 'agent')

// 帮助
const help = r => require.ensure([], () => r(require('@/pages/cmgm/home/help/index')), 'help')
