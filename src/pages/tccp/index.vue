<template>
  <div class="content_bg"  >
    ...
    <!-- <jumpnewuser :theme="'light'" :isNewUser='true'></jumpnewuser> -->
...
import jing from "../public/home/moneyManage.vue";
import usdtActive from "../public/activity/usdt1.vue";
  ...
  data() {
    ...
    //    count:0,
        liParams: [],
            ...
            duration: 10000 ,// 定义时间
      lotHeadDatas: {
        logoUrl: "/static/tccp/logo/logo.png",
        downLoadurl: "/static/tccp/html/download/index.html"
      },
      dialogPar:{
      ...
      attPar:{
        btnColor:'rgba(46,166,238,1)',
        closeImg: "close_1", //弹窗关闭图片
        coverImgUrl:"../../../../static/tccp/img/attention.png",
      },
      nameSta:"478qp",
      poptype: "tc",
      showtype: {
