...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/tccp/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/tccp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/tccp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/tccp/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/tccp/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/tccp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/tccp/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/tccp/register.vue')), 'register')
const register1 = r => require.ensure([], () => r(require('@/pages/tccp/home/register1.vue')), 'register1')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/tccp/home/help/About')), 'about')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/tccp/home/tiyu')), 'tiyu')
// const vp_caipiao = r => require.ensure([], () => r(require('@/pages/tccp/home/caipiao/index')), 'caipiao')
