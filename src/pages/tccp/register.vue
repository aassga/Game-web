        ...
        <div class="content" >
            <div :class="['clearfloat',showForm == 2 ?'clearfloat1':code_show ==false?'clearfloat2': '']" >
                ...
                <!-- <div class="reg-img fl">
                    <img src="/static/tccp/img/register_img.png" alt="">
                </div> -->
...
export default {
    ...
    data() {
        return {
            ...
            defaultPwd:"",
            defaultPwd2:"",
            formBg:"../../../static/tccp/img/form_bg.png",
            showEye1:false,
            showEye2:false,
            showEye3:false,
            showForm:1,
            ...
            codeImg: '/static/tccp/img/new_games/re.png',
            // smsInputBox: {
            //     marginTop: '15px'
            // },
            codeImg: '/static/tccp/img/new_games/log.png',
            tabIndex:1,
...
.register {
    ...
    overflow: hidden;
    padding: 0!important;
    background: url(/static/tccp/img/register_bg.png) no-repeat;
    background-size: cover;
    .clearfloat1{
        position: relative;
        top: 195px!important;
        ...
        .login{
            ...
            .text-context{
                ...
                .iconfont1 {
                  width: 20px;
                  height: 22px;
                  background: url("/static/tccp/img/acc.png");
                ...
                .iconfont2 {
                  width: 20px;
                  height: 24px;
                  background: url("/static/tccp/img/pwd.png");
                  background-repeat: no-repeat;
                  background-size: 100% 100%;
                  position: absolute;
                  left: 15px;
                ...
                .iconfont3 {
                  width: 22px;
                  height: 24px;
                  background: url('/static/tccp/img/yanzhengma.png') no-repeat;
                  background-size: 100% 100%;
                  position: absolute;
                  left: 14px;
                  top: 5px;
    ...
    .service{
        ...
        span{
            ...
            //     width: 114px;
            //     height: 114px;
            //     background: url('../../../static/tccp/img/ser.png');
            //     background-repeat: no-repeat;
            //     background-size: cover;
            // }
        }
    ...
    .content {
        ...
        background: #fff;
        border-radius: 30px;
        background: url('/static/tccp/img/register_img.png');
        background-repeat: no-repeat;
        background-size:100% 100% ;
        // margin-top: 41px;
        .reg-img{
            ...
            .list-box {
                .text-context {
                    ...
                    .openEyes{
                      ...
                      height: 13px;
                      display: inline-block;
                      background: url('/static/tccp/img/eye1.png') no-repeat;
                      background-size: 100% 100%;
                      position: absolute;
                      top: 9px;
                      right: 15px;
                    ...
                    .closeEyes{
                      ...
                      height: 13px;
                      display: inline-block;
                      background: url('/static/tccp/img/eye2.png') no-repeat;
                      background-size: 100% 100%;
                      position: absolute;
                      top: 9px;
                      right: 15px;
