           ...
           <div class="logBottom">
                ...
                <div class="logMember">
                    <div class="logMemberL">
                        <img src="../../../../static/tccp/login/yuan.png" alt="">
                        <span>记住密码</span>
                    </div>
...
.login{
    ...
    background-image: url(/static/tccp/login/login-bg.png);
    ...
    background-image: url(/static/tccp/logo/logos.png),url(/static/tccp/login/bg-close.png);
    background-repeat: no-repeat;
