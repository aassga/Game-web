...
export default {
  ...
  data() {
    return {
        checkSrc:"/static/fhcp/img/reg/checked.png",
        setInter:null,
        AGMoney: 41126438900,
        activeMemberCount:0,
        joinMemberCount:0,
      ...
      headBg: '/static/fhcp/img/reg/reg-top-bg.png',
      bgColor:'#47080E'
    };
  },
  mounted() {},
...
.register-area {
  // width: 1920px;
  height: 815px;
  background: url(/static/fhcp/img/reg/reg-content-bg.png) no-repeat center center;
  margin: 0 auto;
  ...
  .content {
    ...
    margin: 20px auto 0;
    position: relative;
    background: url("/static/fhcp/img/reg/reg-bg.png") no-repeat;
    background-size: 100%;
    .nav_title{
        height: 130px;
        width: 100%;
        background: url("/static/fhcp/img/reg/nav_title.png") 42px 42px no-repeat;
    }
    .header-img {
      position: absolute;
      top: 38px;
