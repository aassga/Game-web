                                    ...
                                    <div class="content">
                                        <ul>
                                            <li class="game-item" :key="index" v-for="(item,index) in gameData" @click="$loginGame(item)">
                                                <div class="game-pic">
                                                    <img :src="'/static/fhcp/img/gamelist/gameicon/'+ item.icon" 
...
.fhcp-new-index {
    ...
    .just-bg {
        width: 90%;
        height: 500px;
        background: url('/static/fhcp/img/cbg2.jpg');
        position: absolute;
        top: 0px;
        z-index: -10;
    }
    ...
    .home-container {
        ...
        #slot-box {
            ...
            font-size: 0;
            margin: 0 auto;
            background: url(/static/fhcp/img/home/caijin/bg.jpg) no-repeat center top;
            background-size:cover;
            .wrapper {
                position: relative;
                width: 1200px;
                ...
                .super_award {
                    ...
                    align-items: center;
                    background: url(/static/fhcp/img/home/caijin/money_bg.gif) no-repeat center center;
                    ...
                    .txt_icon {
                        ...
                        height: 45px;
                        margin: 0 30px 0 0;
                        background: url(/static/fhcp/img/home/caijin/super_bonus.png) no-repeat center center;
                    }
                    .award_num {
                        flex: 1;
                        height: 61px;
                        ...
                        li {
                            ...
                            background: url(/static/fhcp/img/home/caijin/num_box.png) no-repeat center center;
                ...
                .game_info_box {
                        ...
                        .game_nav {
                            ...
                            .arrow {
                                ...
                                &.prev {
                                    z-index: 999;
                                    left: 20px;
                                    background: url(/static/fhcp/img/home/caijin/arrow-left.png) no-repeat center center;
                                    &:hover {
                                        background: url(/static/fhcp/img/home/caijin/arrow-left-hover.png) no-repeat center center;
                                    }
                                }
                                &.next {
                                    right: 20px;
                                    background: url(/static/fhcp/img/home/caijin/arrow-right.png) no-repeat center center;
                                    &:hover {
                                        background: url(/static/fhcp/img/home/caijin/arrow-right-hover.png) no-repeat center center;
                                    }
                                }
                            }
                            .main-cell {
                                ...
                                .tempWarp {
                                    ...
                                    #game-list {
                                        ...
                                        li {
                                            background: url(/static/fhcp/img/xian.png) right center no-repeat;
                                            cursor: pointer;
                                            width: 104px;
                                            float: left;
                                            height: 102px;
                                            ...
                                            &.ae:before {
                                                background: url(/static/fhcp/img/home/caijin/ae.png) no-repeat center center;
                                                background-size: contain;
                                                height: 30px;
                                            }
                                            &.ag:before {
                                                background: url(/static/fhcp/img/home/caijin/ag.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.bbin:before {
                                                background: url(/static/fhcp/img/home/caijin/bbin.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.cq9:before {
                                                background: url(/static/fhcp/img/home/caijin/cq9.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.dt:before {
                                                background: url(/static/fhcp/img/home/caijin/dt.png) no-repeat center center;
                                                background-size: contain;
                                                height: 34px;
                                            }
                                            &.fg:before {
                                                background: url(/static/fhcp/img/home/caijin/fg.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.jdb:before {
                                                background: url(/static/fhcp/img/home/caijin/jdb.png) no-repeat center center;
                                                background-size: contain;
                                                height: 30px;
                                            }
                                            &.mg:before {
                                                background: url(/static/fhcp/img/home/caijin/mg.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.mw:before {
                                                background: url(/static/fhcp/img/home/caijin/mw.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.pt:before {
                                                background: url(/static/fhcp/img/home/caijin/pt.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.pg:before {
                                                background: url(/static/fhcp/img/home/caijin/pg.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                            &.ky:before {
                                                background: url(/static/fhcp/img/home/caijin/ky.png) no-repeat center center;
                                                background-size: contain;
                                                height: 32px;
                                            }
                                            &.vg:before {
                                                background: url(/static/fhcp/img/home/caijin/vg.png) no-repeat center center;
                                                background-size: contain;
                                                height: 26px;
                                            }
                                            &.ly:before {
                                                background: url(/static/fhcp/img/home/caijin/ly.png) no-repeat center center;
                                                background-size: contain;
                                                height: 32px;
                                            }
                                            &.ttg:before {
                                                background: url(/static/fhcp/img/home/caijin/ttg.png) no-repeat center center;
                                                background-size: contain;
                                            }
                                        ...
                                        .game-item {
                                            ...
                                            .star_num {
                                                ...
                                                &:after {
                                                    ...
                                                    height: 10px;
                                                    width: 55px;
                                                    background: url(/static/fhcp/img/home/star.png) repeat-x 0;
                                                }
                                            }
                    ...
                    .winner_list {
                        ...
                        vertical-align: top;
                        overflow: hidden;
                        background: url(/static/fhcp/img/home/caijin/winner_list.png) no-repeat 50%;
    ...
    .cont {
        height: 618px;
        position: relative;
        background: url('/static/fhcp/img/home/bottom_nav/bottom_bg.jpg');
            ...
            .game {
                &.top {
                    ...
                    .ga {
                        ...
                        &.chess {
                            background: url(/static/fhcp/img/home/bottom_nav/chess.png) no-repeat 0 0/100%;
                            background-size: cover;
                        }
                        &.casino {
                            background: url(/static/fhcp/img/home/bottom_nav/casino.png) no-repeat 0 0/100%;
                            background-size: cover;
                        }
                        ...
                        &:hover {
                            ...
                            .enterzh {
                                ...
                                i {
                                    ...
                                    width: 95%;
                                    height: 100%;
                                    background: url(/static/fhcp/img/home/bottom_nav/entry_btn.png) no-repeat left center;
                                }
                            }
                        }
                    }
                ...
                &.bottom {
                    ...
                    .ga {
                        ...
                        transition: all 0.5s ease-in-out;
                        &.lottery {
                            background: url(/static/fhcp/img/home/bottom_nav/lottery.png) no-repeat 0 0/100%;
                            background-size: cover;
                        }
                        &.fishing {
                            background: url(/static/fhcp/img/home/bottom_nav/fishing.png) no-repeat 0 0/100%;
                            background-size: cover;
                            margin: 0 20px;
                        }
                        &.sport {
                            background: url(/static/fhcp/img/home/bottom_nav/sport.png) no-repeat 0 0/100%;
                            background-size: cover;
                        }
                        &:hover {
                            transform: scale(1.05);
    ...
    .notice span {
        font-size: 12px;
        background: url(/static/fhcp/img/notice.png) left center no-repeat;
        padding-left: 30px;
        width: 100px;
        float: left;
        display: block;
    ...
    //     width: 166px;
    //     height: 51px;
    //     background: url(/static/fhcp/img/ico.png) no-repeat;
    ...
    //     background: url(/static/fhcp/img/tabon.png) bottom center no-repeat;
    // }
    ...
    //     background: url(/static/fhcp/img/slots/b2.jpg) no-repeat center;
    //     width: 1000px;
    //     height: 338px;
    //     position: relative;
    // }
    ...
    // .index-platform {
    //     background: url(/static/fhcp/img/indexplatform.png) top center no-repeat;
    //     height: 275px;
    // }
    // .index-platformcon {
    //     position: relative;
    ...
    // }
    // .people1 {
    //     background: url(/static/fhcp/img/people1.png) no-repeat;
    //     width: 290px;
    //     height: 304px;
    //     position: absolute;
    //     left: -300px;
    ...
    // }
    // .people2 {
    //     background: url(/static/fhcp/img/people2.png) no-repeat;
    //     width: 293px;
    //     height: 284px;
    //     position: absolute;
    //     right: -223px;
    ...
    // .index-itemtab .bd {
    //     height: 330px;
    //     background: url(/static/fhcp/img/itembg.png) no-repeat;
    // }
    ...
    //     left: 51px;
    //     top: 93px;
    //     background: url(/static/fhcp/img/ewm.png) no-repeat;
    //     display: block;
    //     width: 116px;
    //     height: 116px;
    // }
    ...
    //     height: 34px;
    //     float: left;
    //     background: url(/static/fhcp/img/itemtabico.png) no-repeat;
    //     margin-right: 10px;
    //     margin-top: 4px;
    // }
