...
<!--    <hongbaoyu :theme="'theme2'" v-show="$route.path=='/home'"></hongbaoyu>-->
    <div class="vp-fhcp-style" :class="{'tcgBlur':$store.state.personal.isPersonal}">
      <!-- 传统彩票 -->
      ...
      <!-- 主页 -->
      <div v-else class="fhcp-cont-wrap">
    ...
    <!-- <jumpnewuser :theme="'purple'" :isNewUser='true'></jumpnewuser> -->
...
export default {
  ...
  data () {
    return {
      lotHeadDatas: {
        logoUrl: '/static/fhcp/img/logo_fhcp.png',
      ...
      attPar: {
        btnColor: '#1F1F1F',
        closeImg: 'close_1', //弹窗关闭图片
        coverImgUrl: '../../../../static/fhcp/img/tc.png',
      },
    }
  },
  methods: {},
