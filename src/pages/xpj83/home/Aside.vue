    ...
    <div>
        <ul id="TplFloatPic_0" class="TplFloatSet TplFloatPic_1" picfloat="left">
            <div id="adleft" style="display:block;" href="javascript:void(0)">
                <img src="/static/xpj83/img/left.png" style="width:160px">
            </div>
            <!-- <div class="dz">
            ...
            <div @click="hide1" id="close-left" class="close-btn"><img src="/static/xpj83/img/close.png" alt=""></div>
        </ul>
        <ul id="TplFloatPic_1" class="TplFloatSet TplFloatPic_1" picfloat="right">
            <div id="adright" style="display:block;" href="javascript:void(0)"><img src="/static/xpj83/img/right.png" style="width:160px"></div>
            ...
            <div id="close-right" @click="hide2" class="close-btn"><img src="/static/xpj83/img/close.png" alt=""></div>
        </ul>
    </div>
</template>
