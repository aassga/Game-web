    ...
    <div class="header index-header">
        ...
        <div class="header-top">
            <div class="w1000">
                <div class="toplink">
                    <div class="lisence">
                        <img src="/static/xpj83/img/pz.png">
                    </div>
                    <a class="time">
                        美东时间：
                        ...
                        <li v-for="(item,index) in classListData" :class="item.text" :key="index" @click="$goPath('one',item)">
                            <a href="javascript:void(0)"  @click="$goPath('one',item)" class="nav_item">
                                ...
                                <span class="ch">{{item.name}}</span>
                                 <img v-if="item.hot == true" src="/static/xpj83/img/hot.gif" alt="hot">
                            </a>
                            <div class="subnav" v-if="item.list&&item.list.length>0">
                                ...
                                <div class="con">
                                    <a v-for="(v,i) in item.list" :key="i" href="javascript:void(0)" style="position:relative;" @click.stop="$goPath('nav',v)">
                                        {{v.name}}
                                        <img src="/static/xpj83/img/hot.gif" style=" position: absolute; z-index: 99; right: 5px;" v-if="[173,11421,11729,10022,10018,10021,11320,243,10613,10695].includes(v.id)">
                                    </a>
                                </div>
                            </div>
                        </li>
        ...
        <div class="header-login" v-if="$store.state.mainState.loginOrout">
            <div class="w1000">
                <div class="img" style="margin-left:8px"><img src="/static/xpj83/img/new_games/head_log.png" alt=""></div>
                <div class="left">
                    <span class="account">
...
export default {
    ...
    methods: {
        ...
        goHeader(typeNum) {
            if (typeNum == 0) {
                // 线路检测
                window.open('https://448.com', '_blank');
            } else if (typeNum == 1) {
                // 借呗
...
.index-header {
    ...
    .header-float {
        ...
        .navbg {
            ...
            .nav {
                ...
                .logo {
                    background: url(/static/xpj83/img/home_logo.png) no-repeat;
                    ...
                    li {
                        ...
                        a {
                            ...
                            .ico {
                                ...
                                margin-bottom: 10px;
                                &.home {
                                    background: url(/static/xpj83/img/homeico.png) no-repeat center center;
                                }
                                &.elec {
                                    background: url(/static/xpj83/img/elecico.png) no-repeat center center;
                                }
                                &.chess {
                                    background: url(/static/xpj83/img/chess_icon.png) no-repeat center center;
                                }
                                &.casino {
                                    background: url(/static/xpj83/img/casinoico.png) no-repeat center center;
                                }
                                &.lottery {
                                    background: url(/static/xpj83/img/lotteryico.png) no-repeat center center;
                                }
                                &.fishing {
                                    background: url(/static/xpj83/img/fishingico.png) no-repeat center center;
                                }
                                &.esport {
                                    background: url(/static/xpj83/img/esportico.png) no-repeat center center;
                                }
                                &.promo {
                                    background: url(/static/xpj83/img/promoico.png) no-repeat center center;
                                }
                                &.service {
                                    background: url(/static/xpj83/img/serviceico.png) no-repeat center center;
                                }
                            }
                            img{
                                position: absolute;
        ...
        .index-bannercon {
            #loginForms {
                ...
                .index-login {
                    ...
                    padding-top: 28px;
                    &.withCode {
                        background: url(/static/xpj83/img/login/with_code.png) no-repeat;
                        .subbtn {
                            bottom: 10px;
                        }
                    }
                    &.noCode {
                        background: url(/static/xpj83/img/login/no_code.png) no-repeat;
                        .subbtn {
                            bottom: 64px;
                        }
                    }
                    ...
                    .title {
                        ...
                        height: 24px;
                        margin-bottom: 12px;
                        background: url(/static/xpj83/img/login/title.png) center center no-repeat;
                    }
                    p {
                        width: 82%;
                        height: 42px;
                        ...
                        &.username_box {
                            margin-bottom: 10px;
                            background: url(/static/xpj83/img/login/user_input.png) no-repeat center center;
                        }
                        &.pwd_box {
                            background: url(/static/xpj83/img/login/pwd_input.png) no-repeat center center;
                        }
                        &.code_box0 {
                            height: 48px;
                            line-height: 48px;
                    ...
                    .button {
                        ...
                        a {
                            ...
                            &.login_btn {
                                text-decoration: none;
                                background: url(/static/xpj83/img/login/login_btn.png) no-repeat center center;
                                background-size: contain;
                            ...
                            &.forget {
                                background: url(/static/xpj83/img/login/forget_pwd.png) no-repeat center center;
                                background-size: contain;
                            }
                        }
                        .subbtn {
                    ...
                    .register_btn {
                        display: block;
                        background: url(/static/xpj83/img/login/register_btn.png) no-repeat center center;
                        width: 83%;
                        height: 42px;
                        &.show_code {
                            margin: 0 auto;
    ...
    .header-login {
        ...
        #loginForm {
            ...
            // padding-left: 360px;
            .header-logincon {
                background: url(/static/xpj83/img/headerlogin.png) left center no-repeat;
                height: 100%;
                width: 1200px;
                margin: 0 auto;
                display: flex;
                ...
                .forget {
                    background: url(/static/xpj83/img/forget.png) no-repeat;
                    width: 60px;
                    height: 32px;
                    display: block;
                    float: left;
                ...
                .subbtn {
                    background: url(/static/xpj83/img/subbtn.png) no-repeat;
                    width: 130px;
                    height: 34px;
                    border: none;
                    padding: 0;
                ...
                .regbtn {
                    background: url(/static/xpj83/img/regbtn.png) top center no-repeat;
                    width: 130px;
                    height: 34px;
                    display: block;
                    float: left;
                ...
                span {
                    ...
                    &.refresh_balance {
                        .refresh {
                            ...
                            width: 22px;
                            height: 20px;
                            background: url('/static/xpj83/img/refresh.png') center center no-repeat;
                            // transform: scale(1.2);
                            margin-top: 17px;
                        }
                        .newfresh{
                            background:url('/static/xpj83/img/newfresh.png') no-repeat center;
                        }
                        .fres{
                             -webkit-animation: spin 1s linear;
                             animation: spin 1s linear;
                ...
                span {
                    a {
                        ...
                        &.logOut {
                            ...
                            text-align: center;
                            color: #000;
                            background: url(/static/xpj83/img/log_out.png) center center no-repeat;
                            background-size: contain;
                        }
                    }
                }
...
.header .nav .subnav .jt {
    background: url(/static/xpj83/img/menujt.png) no-repeat;
    height: 5px;
    width: 9px;
    display: block;
    margin: 0 auto;
