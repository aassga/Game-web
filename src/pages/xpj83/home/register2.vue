<template>
  <div>
    <section class="banner-cpyx">
      <banView :headerImg="headBg" :BGC='bgColor'></banView>
    </section>
...
export default {
  ...
  data() {
    return {
        checkSrc:"/static/xpj83/img/reg/checked.png",
        setInter:null,
        AGMoney: 41126438900,
        activeMemberCount:0,
        joinMemberCount:0,
      ...
      headBg: '/static/xpj83/img/reg/reg-top-bg.png',
      bgColor:'#47080E'
    };
  },
  mounted() {},
...
.register-area {
  // width: 1920px;
  height: 815px;
  background: url(/static/xpj83/img/reg/reg-content-bg.png) no-repeat center center;
  margin: 0 auto;
  ...
  .content {
    ...
    margin: 20px auto 0;
    position: relative;
    background: url("/static/xpj83/img/reg/reg-bg.png") no-repeat;
    background-size: 100%;
    .nav_title{
        height: 130px;
        width: 100%;
        background: url("/static/xpj83/img/reg/nav_title.png") 42px 42px no-repeat;
    }
    .header-img {
      position: absolute;
      top: 38px;
