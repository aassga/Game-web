...
export default {
    ...
    mounted(){
        ...
        if(tab){
            this.showForm = tab;
            if(tab == 2){
                this.formBg = '../../../static/xpj83/img/c.png';
                this.theWidth = 192;
                this.theHeight = 55;
            }else{
                this.formBg = '../../../static/xpj83/img/w.png';
                this.theWidth = 285;
                this.theHeight = 54;
            }
        }
...
.register {
    ...
    height: 100%;
    margin: 0 auto;
    background: url('/static/xpj83/img/register_bg.png') no-repeat center;
        ...
        .login{
            ...
            .text-context{
                ...
                .iconfont1 {
                  width: 20px;
                  height: 22px;
                  background: url("/static/xpj83/img/acc.png");
                ...
                .iconfont2 {
                  width: 20px;
                  height: 24px;
                  background: url("/static/xpj83/img/pwd.png");
                  background-repeat: no-repeat;
                  background-size: 100% 100%;
                  position: absolute;
                  left: 13px;
                ...
                .iconfont3 {
                  width:22px;
                  height: 22px;
                  background: url('/static/xpj83/img/yanzhengma.png') no-repeat;
                  background-size: 100% 100%;
                  position: absolute;
                  left: 11px;
                  top: 15px;
    ...
    .service{
        ...
        span{
            ...
            &:first-child{
                width: 130px;
                height: 100px;
                background: url('../../../static/xpj83/img/ser.png');
                background-repeat: no-repeat;
                background-size: cover;
            }
        }
            ...
            .list-box {
                .text-context {
                    ...
                    .openEyes{
                      ...
                      height: 13px;
                      display: inline-block;
                      background: url('/static/xpj83/img/eye1.png') no-repeat;
                      background-size: 100% 100%;
                      position: absolute;
                      top: 17px;
                      right: 15px;
                    ...
                    .closeEyes{
                      ...
                      height: 13px;
                      display: inline-block;
                      background: url('/static/xpj83/img/eye2.png') no-repeat;
                      background-size: 100% 100%;
                      position: absolute;
                      top: 17px;
                      right: 15px;
