    ...
    <div>
        <ul id="TplFloatPic_0" class="TplFloatSet TplFloatPic_1" picfloat="left">
            <div id="adleft" style="display:block;" href="javascript:void(0)">
                <img src="/static/amjs/img/left.png">
            </div>
            <div class="dz">
        ...
        <ul id="TplFloatPic_1" class="TplFloatSet TplFloatPic_1" picfloat="right">
            <div id="adright" style="display:block;" href="javascript:void(0)"><img src="/static/amjs/img/right.png"></div>
...
export default {
    ...
    methods: {
        ...
        goView2() {
           window.open('https://xianludh.github.io/xianluu/vns4447/index.html')
        },
        getUrl(){
