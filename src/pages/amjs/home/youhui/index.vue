...
export default {
  ...
  data () {
    return {
      notice: "/static/amjs/img/home/notice.png",
      headBg: '/static/amjs/img/money.jpg',
      lantern: '',
      bannerStyle: {},
      cssStyle: {
        padding: '20px 20px 20px',
        background: 'url(/static/amjs/img/bg_activity.jpg)',
...
.wrapper {
   .banner-cpyx{
    ...
    .notice {
        ...
        width: 100%;
        margin-top: 0px;
        background: url(/static/amjs/img/noticebg.png) repeat-x;
        ...
        .w1000 {
            ...
            span {
                font-size: 12px;
                background: url(/static/amjs/img/notice.png) left center no-repeat;
                padding-left: 30px;
                width: 128px;
                float: left;
                display: block;
