...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/amjs/index.vue')), 'index')
    // 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/amjs/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/amjs/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/amjs/home/games/index.vue')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/amjs/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/amjs/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/amjs/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/amjs/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')

const register = r => require.ensure([], () => r(require('@/pages/amjs/admin/tregister')), 'register') //帮助页面
const register1 = r => require.ensure([], () => r(require('@/pages/amjs/register')), 'register1') //帮助页面
const registerContent = r => require.ensure([], () => r(require('@/pages/amjs/home/help/register-content')), 'registerContent') //注册模块
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/amjs/home/help/about-page')), 'vpAboutPage') //关于我们
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/amjs/home/help/save-help')), 'vpSaveHelp') //存款帮助
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/amjs/home/help/pull-help')), 'vpPullHelp') //取款帮助
const vpRelation = r => require.ensure([], () => r(require('@/pages/amjs/home/help/relation')), 'vpRelation') //联系我们
// 帮助
const about = r => require.ensure([], () => r(require('@/pages/amjs/home/help/index')), 'about')
//购彩大厅
import vpHall from '@/pages/public/tradition/vp-hall'
//动画
const hall_Animate = r => require.ensure([], () => r(require('@/pages/public/tradition/animate')), 'hall_Animate')
    // 传统彩空页面
const traditioIndex = r => require.ensure([], () => r(require('@/pages/public/tradition')), 'traditioIndex')
    // 时时彩
const sh_chongqing = r => require.ensure([], () => r(require('@/pages/public/tradition/shi-shi-cai/chong-qing')), 'sh_chongqing')
    // 六合彩
const liu_xianggang = r => require.ensure([], () => r(require('@/pages/public/tradition/liu-he-cai/xiang-gang')), 'liu_xianggang')
    // 快三
const ks_jiangsu = r => require.ensure([], () => r(require('@/pages/public/tradition/kuai-san/jiangsu')), 'ks_jiangsu')
    // pc蛋蛋
const pc_dandan = r => require.ensure([], () => r(require('@/pages/public/tradition/pc-dan-dan/pc-dan-dan')), 'pc_dandan')
    // pk10
const pk_beijing = r => require.ensure([], () => r(require('@/pages/public/tradition/pk10/bei-jing')), 'pk_beijing')
    // const pk_feiding= r => require.ensure([], () => r(require('@/pages/pk10/xy-fei-ding/index')), 'pk_feiding'); 
    //快乐十分
const kl_guangdong = r => require.ensure([], () => r(require('@/pages/public/tradition/kuai-le-shi-fen/guang-dong')), 'kl_guangdong')
    //十一选5
const ele_guangdong = r => require.ensure([], () => r(require('@/pages/public/tradition/eleven-selection-five/guang-dong')), 'ele_guangdong')
    //低频彩
const di_fucai3D = r => require.ensure([], () => r(require('@/pages/public/tradition/di-pin-cai/fu-cai-3D')), 'di_fucai3D')
    // 传统彩end
const long_dragon = r => require.ensure([], () => r(require('@/pages/public/tradition/long-dragon')), 'long_dragon')
//开奖走势
