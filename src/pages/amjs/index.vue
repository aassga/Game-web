...
import adviceModal from "../public/personals/message/advice.vue"
...
export default {
  ...
  data() {
    return {
      lotHeadDatas: {
        logoUrl: "/static/amjs/img/logocp.png",
        downLoadurl: "/static/amjs/html/download/index.html"
      },
      dialogPar:{
      ...
      showtype: {
        ...
        textColor: "#A99046" //弹窗按钮颜色
      },
      attPar:{
        btnColor:'#101010',
        closeImg: "close_1", //弹窗关闭图片
        coverImgUrl:"../../../../static/amjs/img/tc.png",
      },
    };
  },
  methods: {},
