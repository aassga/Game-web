...
let entryJS = glob.sync('./src/pages/' + config.build.buildDir + '/*.js').reduce(function (prev, curr) {
...
module.exports = {
  ...
  plugins: [
    new ExtractTextPlugin('static-' + config.build.buildDir + '/style.css'),
